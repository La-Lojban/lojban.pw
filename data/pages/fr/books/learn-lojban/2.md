...
Les dictionnaires peuvent présenter des définitions de mots de relation avec des symboles tels que x<sub>1</sub>, x<sub>2</sub> etc. :

prami
: x<sub>1</sub> aime x<sub>2</sub>

karce
: x<sub>1</sub> est une voiture …

citka
: x<sub>1</sub> mange x<sub>2</sub> …

klama
: x<sub>1</sub> vient à x<sub>2</sub> …

Ces x<sub>1</sub>, x<sub>2</sub>, et ainsi de suite sont la notation explicite pour ce qu'on appelle les _emplacements_ (autres noms : _places_, _rôles de relation_, **terbricmi** en lojban). Les emplacements sont remplis par des termes d'argument (**sumti**) dans la phrase.
...
- x<sub>1</sub> dénote _celui qui aime_, et
- x<sub>2</sub> dénote _celui qui est aimé par_.

En d'autres termes, chaque relation a un ou plusieurs emplacements, et ces emplacements sont spécifiés et étiquetés comme x<sub>1</sub>, x<sub>2</sub>, et ainsi de suite. Nous plaçons des arguments comme **mi**, **do**, **le tavla** etc. dans l'ordre, remplissant ainsi ces emplacements et donnant un sens concret à la relation, formant ainsi une phrase.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… est une montagne"></pixra>
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> vient à x<sub>2</sub> depuis x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> aime x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> est une voiture</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>x<sub>1</sub> mange x<sub>2</sub></td>
</tr></tbody></table>
...
pinxe
: x<sub>1</sub> boit x<sub>2</sub> depuis x<sub>3</sub>
...
plicru
: x<sub>1</sub> donne, offre à x<sub>2</sub> un objet x<sub>3</sub> ; x<sub>1</sub> permet à quelqu'un x<sub>2</sub> d'utiliser x<sub>3</sub>

#### Exercice

zgana
: x<sub>1</sub> observe/remarque x<sub>2</sub> en utilisant les sens x<sub>3</sub>
...
<tr>
<td><i>Je donne la pomme à l'enfant.</i></td>
...
- **le nicte** comme x<sub>1</sub> de la relation,
...
- **mi** - x<sub>1</sub> de la relation interne,
- **viska** - la relation interne,
- **le lunra** - x<sub>2</sub> de la relation interne.
...
- **mi** comme x<sub>1</sub>, le premier emplacement de la relation,
...
- **mi** comme x<sub>1</sub>, le premier emplacement de la relation à l'intérieur du terme
...
tavla
: x<sub>1</sub> parle à x<sub>2</sub> …

melbi
: x<sub>1</sub> est beau, joli pour x<sub>2</sub> …
...
nandu
: x<sub>1</sub> est difficile pour x<sub>2</sub>

tilju
: x<sub>1</sub> est lourd
...
klama
: x<sub>1</sub> vient à x<sub>2</sub> depuis x<sub>3</sub>
...
<td>Utilise des arguments centraux (x<sub>2</sub> et x<sub>3</sub> de klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Utilise un argument central (x<sub>2</sub> = le zarci) et un terme modal (ca le nu do pinxe)</td>
</tr>
<tr>
...
2. L'objet d'une action est généralement juste après le premier emplacement :
   ...
   **punji** = _x<sub>1</sub> met x<sub>2</sub> sur x<sub>3</sub>_,
...
4. Les emplacements de destination (_vers_) viennent presque toujours avant les emplacements d'origine (_depuis_) :
   ...
   **klama** = _x<sub>1</sub> va à x<sub>2</sub> depuis x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="La personne sort du magasin."></pixra>
...
dunda
: x<sub>1</sub> donne x<sub>2</sub> à x<sub>3</sub>

benji
: x<sub>1</sub> transfère x<sub>2</sub> à x<sub>3</sub> depuis x<sub>4</sub>

lebna
: x<sub>1</sub> prend x<sub>2</sub> de x<sub>3</sub>
...
troci
: x<sub>1</sub> essaie de faire ou d'être x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> marche

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="L'enfant essaie de marcher."></pixra>
...
cinmo
: x<sub>1</sub> ressent x<sub>2</sub> (ka)

Cela signifie que l'infinitif dans le deuxième emplacement (x<sub>2</sub>) est appliqué à un autre emplacement (très probablement, le premier emplacement, x<sub>1</sub>). Les cas où l'infinitif est appliqué à des emplacements autres que x<sub>2</sub> sont rares et sont expliqués dans les dictionnaires pour les relations correspondantes ou dans le cas de mots de relation inventés non officiellement, peuvent être déduits du bon sens par analogie avec d'autres mots de relation similaires.

Un autre exemple :

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Il/elle aide l'ami à porter les sacs."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Il/elle aide l'ami à porter les sacs._

sidju
: x<sub>1</sub> aide x<sub>2</sub> à faire x<sub>3</sub> (ka)

Le mot de relation **sidju** nécessite que son troisième emplacement soit rempli par un infinitif.

bevri
: x<sub>1</sub> porte x<sub>2</sub>
...
> _J'ai l'impression que quelqu'un me déteste._
> _Je me sens détesté._

#### Exercice

zgana
: x<sub>1</sub> observe x<sub>2</sub>

kakne
: x<sub>1</sub> est capable de faire x<sub>2</sub> (propriété)
...
djica
: x<sub>1</sub> veut x<sub>2</sub> (événement)
...
zekri
: x<sub>1</sub> est un événement criminel, x<sub>1</sub> (événement) un crime

cumki
: x<sub>1</sub> (événement) est possible
...
stidi
: x<sub>1</sub> suggère l'action x<sub>2</sub> (propriété) à x<sub>3</sub>
...
> _Je veux la nourriture sucrée._
...
<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="La personne veut la nourriture sucrée."></pixra>
...
Cependant, le mot de relation lojban **stidi** nécessite une propriété dans son emplacement x<sub>2</sub>. De même, **djica** nécessite un événement dans son emplacement x<sub>2</sub>.
...
> _Le chocolat m'est agréable (probablement en raison de son goût)._
> `Quelque chose à propos du chocolat m'est agréable`

cakla
: x<sub>1</sub> est du chocolat
...
stidi
: x<sub>1</sub> suggère x<sub>2</sub> (propriété) à x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="l'ami / les amis"></pixra>
...
Par défaut, il attache le deuxième emplacement (x<sub>2</sub>). Nous pouvons attacher plus d'emplacements en les séparant avec **bei** :

> **mi plicru do le plise**
> _Je te donne la pomme._

<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="La personne donne à l'ami l'ustensile."></pixra>
...
> _Le donneur de la pomme à moi est mon ami._
...
ctuca
: x<sub>1</sub> enseigne à quelqu'un x<sub>2</sub> le sujet x<sub>3</sub>

cmene
: x<sub>1</sub> est un nom de x<sub>2</sub> utilisé par x<sub>3</sub>
...
speni
: x<sub>1</sub> est marié à x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="Le chien que je vois habituellement dans le parc."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="L'arbre est grand."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="J'aime ceux dont les sourires me plaisent."></pixra>
...
pluka
: x<sub>1</sub> est agréable à x<sub>2</sub>

zutse
: x<sub>1</sub> est assis, est assis sur x<sub>2</sub>
...
birka
: x<sub>1</sub> est un bras de x<sub>2</sub>
...
> _L'ami à toi qui est lié à Paris est intelligent._
> <span>(<b>pe la .paris.</b> est attaché à tout l'argument <b>le pa pendo be do be'o</b>)</span></span>

<!-- -->

> **le pu plicru be do bei le pa plise be'o pe la .paris. cu stati**
> _Qui t'a donné la pomme (et qui est lié à Paris) est intelligent._
> <span>(<b>pe la .paris.</b> est attaché à tout l'argument <b>le pu plicru be do bei le pa plise be'o</b>)</span></span>
...
<td><i>Le téléphone qui est beau pour moi est grand.</i></td>
</tr>
<tr>
<td><b>le fonxa pe mi cu melbi</b></td>
<td><i>Le téléphone qui est à moi est beau.</i></td>
</tr>
<tr>
<td><b>le pendo be do cu tavla</b></td>
<td><i>L'ami à toi parle.</i></td>
</tr>
<tr>
...
<td><i>Le téléphone beau pour moi de l'ami à moi est grand.</i></td>
</tr></tbody></table>

Cachez la partie droite du tableau. Traduisez les phrases à gauche vers le lojban.

tuple
: x<sub>1</sub> est une jambe de x<sub>2</sub>

clani
: x<sub>1</sub> est long, allongé

cinri
: x<sub>1</sub> (événement) est intéressant pour quelqu'un x<sub>2</sub>
...
<table style="table-layout: fixed;">
<tbody><tr>
<td><i>Tes jambes sont longues.</i></td>
<td><b>le tuple be do cu clani</b></td>
</tr>
<tr>
<td><i>Le livre qui est à moi est intéressant.</i></td>
<td><b>le cukta pe mi cu cinri</b></td>
</tr>
<tr>
<td><i>La personne liée à toi est intelligente.</i></td>
<td><b>le prenu pe do cu stati</b></td>
</tr>
<tr>
<td><i>L'ami à toi qui est lié à Paris est intelligent.</i></td>
<td><b>le pendo be do be'o pe la .paris. cu stati</b></td>
</tr>
<tr>
<td><i>Le téléphone beau pour moi de mon ami est grand.</i></td>
<td><b>le pa melbi be mi fonxa pe le pa pendo be mi cu barda</b></td>
</tr></tbody></table>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="J'enseigne / Je suis professeur."></pixra>
...
tunba
: x<sub>1</sub> est un frère ou une sœur de x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="Tu es mon frère/ma sœur."></pixra>

#### Exercice

gerku
: x<sub>1</sub> est un chien

badna
: x<sub>1</sub> est une banane

pendo
: x<sub>1</sub> est un ami de x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="Ce qui était un désert est maintenant un jardin."></pixra>

> **le pu kunti tumla ca purdi**
> _Ce qui était un désert est maintenant un jardin._

kunti
: x<sub>1</sub> est vide

tumla
: x<sub>1</sub> est une parcelle de terre
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="Le désert était un jardin."></pixra>
...
melbi
: x<sub>1</sub> est beau

sutra
: x<sub>1</sub> est rapide
...
<td>Le "ca" s'applique à "mi melbi" - mon fait d'être beau maintenant est rapide</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> donne à x<sub>2</sub> quelque chose x<sub>3</sub> pour usage
...
vecnu
: x<sub>1</sub> vend x<sub>2</sub> à x<sub>3</sub> pour le prix x<sub>4</sub>

ciska
: x<sub>1</sub> écrit x<sub>2</sub> sur la surface x<sub>3</sub> avec l'outil x<sub>4</sub>
...
zbasu
: x<sub>1</sub> construit, fait x<sub>2</sub> à partir de x<sub>3</sub>
...
klama
: x<sub>1</sub> va à x<sub>2</sub> depuis x<sub>3</sub> via x<sub>4</sub> par moyen x<sub>5</sub>
...
mrilu
: x<sub>1</sub> envoie par courrier objet x<sub>2</sub> à adresse de destinataire x<sub>3</sub> depuis boîte aux lettres x<sub>4</sub> par réseau de transporteur x<sub>5</sub>

pagbu
: x<sub>1</sub> est une partie de x<sub>2</sub>
...
- **fa** marque l'argument qui remplit le premier emplacement d'une relation (x<sub>1</sub>)
- **fe** marque l'argument qui remplit le deuxième emplacement (x<sub>2</sub>)
- **fi** marque l'argument qui remplit le troisième emplacement (x<sub>3</sub>)
- **fo** marque l'argument qui remplit le quatrième emplacement (x<sub>4</sub>)
- **fu** marque l'argument qui remplit le cinquième emplacement (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="La personne boit dans le verre."></pixra>
...
tugni
: x<sub>1</sub> est d'accord avec quelqu'un x<sub>2</sub> à propos de x<sub>3</sub> (proposition)
...
xamgu
: x<sub>1</sub> est bon pour x<sub>2</sub> en termes de x<sub>3</sub>

cuxna
: x<sub>1</sub> choisit x<sub>2</sub> parmi x<sub>3</sub>

zgike
: x<sub>1</sub> est de la musique
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (Je donne la pomme à toi)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> non spécifié, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (quelque chose est bon pour moi en termes de musique)</td>
</tr></tbody></table>
...
> _Je souhaite qu'il y ait au moins quelque chose de savoureux pour que je le mange._
> _Je souhaite que quelque chose soit tel que je le mange._
...
> _Il y a au moins quelque chose de savoureux : je souhaite le manger, je veux le manger._
...
tavla
: x<sub>1</sub> parle à quelqu'un x<sub>2</sub> à propos du sujet x<sub>3</sub>
...
djuno
: x<sub>1</sub> sait x<sub>2</sub> (fait) à propos de x<sub>3</sub>
...
<td>Il existe quelqu'un de savant (<b>da</b>) tel que je veux l'événement qu'il m'aide ; <b>da</b> est la même personne dans le prénexe et à l'intérieur de <b>le nu</b></td>
</tr></tbody></table>
...
Lorsqu'une phrase a besoin d'une deuxième ou troisième variable distincte, le lojban utilise **de** et **di** après **da** (voir aussi [« Regroupement des quantificateurs » dans la CLL](/en/books/cll/16/#section-quantifier-grouping)) :

da
: pronom : première variable (comme le _X_ logique).

de
: pronom : deuxième variable (comme le _Y_ logique).

di
: pronom : troisième variable (comme le _Z_ logique).

> **da de zo'u mi djica le nu da tavla de**
> _Il y a quelqu'un et quelqu'un d'autre tel que je désire que le premier ait parlé au second (**da** et **de** font référence à ces deux personnes dans le prénexe et à l'intérieur de **le nu**)._
...
zmadu
: x<sub>1</sub> dépasse x<sub>2</sub> dans la propriété x<sub>3</sub>

mlatu
: x<sub>1</sub> est un chat
...
<td>Premièrement : deux personnes (auxquelles nous faisons référence avec des variables) dépassent chacune une personne ; la personne dépassée peut différer pour chacune des deux, ou être la même. Deuxièmement : chacune des deux <b>le prenu</b> dépasse une <b>le prenu</b> ; chaque <b>le prenu</b> peut choisir un nouveau référent, donc les paires n'ont pas besoin de correspondre (comparer avec <a href="#scope">Portée</a>)</td>
</tr>
<tr>
...
panzi
: x<sub>1</sub> est un enfant, descendant de x<sub>2</sub>
...
ralte
: x<sub>1</sub> garde x<sub>2</sub> en sa possession
...
ponse
: x<sub>1</sub> possède x<sub>2</sub>

#### Exercice

mamta
: x<sub>1</sub> est une mère de x<sub>2</sub>
...
ponse
: x<sub>1</sub> possède légalement x<sub>2</sub>
...
<tr>
<td><i>Mon ami(e) a deux enfants</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Trois personnes parlent chacune à deux enfants."></pixra>
...
Pour rendre la portée égale, nous utilisons une conjonction spéciale **ce'e** reliant deux termes. Les termes reliés par **ce'e** sont compris comme ayant une *portée égale* : ils agissent en tant que *pairs* pour ce qui suit.
...
mo'u
: terme : achèvement naturel — l'événement a atteint sa fin naturelle

Maintenant comparez :

> **mi mo'u co'a speni**
> _Je suis jeune marié._
> `J'ai fini de devenir une personne mariée.`

> **mi co'a mo'u speni**
> _Je deviens veuf/veuve._
...
**mo'u** signifie qu'un événement a atteint sa fin naturelle (achèvement naturel). Quel événement ? L'événement **co'a speni** — devenir marié. Donc, **mi mo'u co'a speni** signifie _Je termine le processus de devenir marié_, c'est-à-dire, _Je suis jeune marié._
...
> _C'est arrivé avant que je n'aille à la montagne._
> `Je au passé : au futur : vais à la montagne.`

> **mi ba pu klama le cmana**
> _Cela arrivera après que je sois allé à la montagne._
...
> _Je suis allé et irai à la montagne._
...
tavla
: x<sub>1</sub> parle à x<sub>2</sub> à propos de x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Ici, tout est étrange."></pixra>
...
stati
: x<sub>1</sub> est intelligent/malin

jundi
: x<sub>1</sub> est attentif à x<sub>2</sub>

zvati
: x<sub>1</sub> est présent à x<sub>2</sub>
...
danlu
: x<sub>1</sub> est un mammifère

morsi
: x<sub>1</sub> est mort
...
mupli
: x<sub>1</sub> est un exemple de x<sub>2</sub> (propriété) parmi x<sub>3</sub> (ensemble)
...
mupli
: x<sub>1</sub> est un exemple de x<sub>2</sub> parmi x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="Les gens ont entouré la table."></pixra>
...
smaji
: x<sub>1</sub> est silencieux

> **le since cu sruri le garna**
> _Les serpents ont entouré le bâton._
> _Chacun des serpents a entouré le bâton._
...
> _Les serpents ont entouré le bâton._
> _Les serpents ensemble en tant que masse ont entouré le bâton._
...
<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="Le serpent a entouré la personne."></pixra>
...
gunma
: x<sub>1</sub> est une masse formée de composants x<sub>2</sub>
...
grake
: x<sub>1</sub> pèse x<sub>2</sub> (nombre) grammes
