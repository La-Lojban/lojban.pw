...
uantida
: un mot de relation non officiel : x<sub>1</sub> joue au jeu x<sub>2</sub>, participe au jeu x<sub>2</sub>
...
zgipli
: x<sub>1</sub> joue d'un instrument de musique x<sub>2</sub>
