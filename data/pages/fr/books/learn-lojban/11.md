...
vitke
: x<sub>1</sub> (invité) rend visite à x<sub>2</sub> (quelqu'un) à x<sub>3</sub>
...
jibri
: x<sub>1</sub> est un travail de x<sub>2</sub>
...
merko
: x<sub>1</sub> est américain (sens des États-Unis)
...
simxu
: les membres de l'ensemble x<sub>1</sub> font réciproquement x<sub>2</sub>

La relation **simxu** prend chaque paire possible de l'ensemble spécifié en place x<sub>1</sub> et affirme la relation spécifiée dans x<sub>2</sub>.
...
cmima
: x<sub>1</sub> est un membre de l'ensemble x<sub>2</sub>
