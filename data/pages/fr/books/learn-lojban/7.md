...
melbi
: x<sub>1</sub> est beau / joli / séduisant pour quelqu'un x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> est une chambre pour la raison x<sub>2</sub> (proposition)
...
Ici, **le se go'i** se réfère à la deuxième place (x<sub>2</sub>) de la relation précédente, qui est **le nanmu**.
...
tcika
: x<sub>1</sub> (heures, minutes, secondes) est l'heure de l'évènement x<sub>2</sub>
...
detri
: x<sub>1</sub> (année, mois, jour) est la date/heure de l'évènement x<sub>2</sub>
...
nanca
: x<sub>1</sub> a une durée de x<sub>2</sub> (nombre) années
...
masti
: x<sub>1</sub> a une durée de x<sub>2</sub> mois

> **le nu carvi cu djedi li ci**
> _Il pleut depuis trois jours._

djedi
: x<sub>1</sub> (évènement) a une durée de x<sub>2</sub> jours complets
...
glare = x<sub>1</sub> est chaud/tiède
...
nabmi
: x<sub>1</sub> est un problème pour x<sub>2</sub>

se nabmi
: x<sub>1</sub> a un problème x<sub>2</sub>

laldo
: x<sub>1</sub> est vieux …

certu
: x<sub>1</sub> est un expert, professionnel en propriété x<sub>2</sub>
