...
melbi
: x<sub>1</sub> ist schön / hübsch / gutaussehend für jemanden x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> ist ein Raum für den Zweck x<sub>2</sub> (Proposition)
...
lumci
: x<sub>1</sub> wäscht x<sub>2</sub>
...
Hier verweist **le se go'i** auf den zweiten Platz (x<sub>2</sub>) der vorangehenden Relation, der **le nanmu** ist.
...
tcika
: x<sub>1</sub> (Stunden, Minuten, Sekunden) ist die Zeit des Ereignisses x<sub>2</sub>
...
detri
: x<sub>1</sub> (Jahr, Monat, Tag) ist das Datum/die Zeit des Ereignisses x<sub>2</sub>
...
nanca
: x<sub>1</sub> ist von der Dauer von x<sub>2</sub> (Zahl) Jahren
...
masti
: x<sub>1</sub> ist x<sub>2</sub> Monate lang

> **le nu carvi cu djedi li ci**
> _Es regnet seit drei Tagen._

djedi
: x<sub>1</sub> (Ereignis) ist x<sub>2</sub> (Zahl) volle Tage lang
...
glare = x<sub>1</sub> ist heiß/warm
...
nabmi
: x<sub>1</sub> ist ein Problem für x<sub>2</sub>

se nabmi
: x<sub>1</sub> hat ein Problem x<sub>2</sub>

laldo
: x<sub>1</sub> ist alt …

certu
: x<sub>1</sub> ist ein Experte, Profi in Eigenschaft x<sub>2</sub>
