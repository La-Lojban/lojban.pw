...
Wörterbücher können Definitionen von Relationswörtern mit Symbolen wie $x_1$, $x_2$ usw. darstellen:
...
Diese $x_1$, $x_2$ usw. sind die explizite Notation für die sogenannten _Stellen_ (andere Bezeichnungen sind: _Plätze_, _Rollen der Relation_, **terbricmi** auf Lojban). Stellen werden durch Argumentterme (**sumti**) im Satz gefüllt.
...
Mit anderen Worten, jede Relation hat eine oder mehrere Stellen, und diese Stellen sind spezifiziert und als $x_1$, $x_2$ usw. beschriftet. Wir setzen Argumente wie **mi**, **do**, **le tavla** usw. der Reihe nach ein und füllen so diese Stellen und geben der Relation eine konkrete Bedeutung, wodurch wir einen Satz bilden.
...
<tbody><tr>
<td><b>klama</b></td>
<td>$x_1$ kommt zu $x_2$ von $x_3$</td>
</tr>
<tr>
<td><b>prami</b></td>
<td>$x_1$ liebt $x_2$</td>
...
plicru
: $x_1$ gibt, spendet jemandem $x_2$ ein Objekt $x_3$; $x_1$ erlaubt jemandem $x_2$, $x_3$ zu verwenden

#### Aufgabe

zgana
: $x_1$ beobachtet/bemerkt $x_2$ mit den Sinnen $x_3$
...
- **mi** als $x_1$, die erste Stelle der Relation innerhalb des Terms
...
<td>Verwendet Kernargumente ($x_2$ und $x_3$ von klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Verwendet Kernargument ($x_2$ = le zarci) und Modalterm (ca le nu do pinxe)</td>
</tr>
<tr>
...
4. Ziel (_zu_) Stellen kommen fast immer vor Herkunft (_von_) Stellen:
    ...
    **klama** = _$x_1$ geht zu $x_2$ von $x_3$_
    ...
    <pixra url="/assets/pixra/cilre/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="Die Person geht aus dem Laden heraus."></pixra>
...
: $x_1$ gibt $x_2$ an $x_3$
benji
: $x_1$ überträgt $x_2$ an $x_3$ von $x_4$
lebna
: $x_1$ nimmt $x_2$ von $x_3$
...
<pixra url="/assets/pixra/cilre/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="Das Kind versucht zu gehen."></pixra>
...
Das bedeutet, dass der Infinitiv in der zweiten Stelle ($x_2$) auf eine andere Stelle angewendet wird (höchstwahrscheinlich die erste Stelle, $x_1$). Fälle, in denen der Infinitiv auf andere Stellen als $x_2$ angewendet wird, sind selten und werden in Wörterbüchern für entsprechende Relationen erklärt oder können bei inoffiziell erfundenen Relationswörtern aus dem gesunden Menschenverstand durch Analogie mit anderen ähnlichen Relationswörtern abgeleitet werden.
...
: $x_1$ beobachtet $x_2$
kakne
: $x_1$ ist fähig, $x_2$ zu tun (Eigenschaft)
nelci
: $x_1$ mag $x_2$
...
> `Dass etwas kriminell ist, ist möglich.`
...
stidi
: $x_1$ schlägt Handlung $x_2$ (Eigenschaft) jemandem $x_3$ vor
...
<pixra url="/assets/pixra/cilre/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="Die Person will die Süßigkeit."></pixra>
...
Das Lojban-Relationswort **stidi** erfordert jedoch eine Eigenschaft in seiner $x_2$-Stelle. Ebenso erfordert **djica** ein Ereignis in seiner $x_2$-Stelle.
...
stidi
: $x_1$ schlägt $x_2$ (Eigenschaft) jemandem $x_3$ vor
...
Standardmäßig wird die zweite Stelle ($x_2$) angehängt. Wir können mehr Stellen anhängen, indem wir sie mit **bei** trennen:
...
ctuca
: $x_1$ unterrichtet $x_2$ (Fach) jemandem $x_3$
cmene
: $x_1$ ist ein Name von $x_2$, verwendet von $x_3$
...
ctuca
: $x_1$ unterrichtet $x_2$ jemandem $x_3$
...
<pixra url="/assets/pixra/cilre/ctuca.webp" caption="mi ctuca" definition="Ich unterrichte / Ich bin ein Lehrer."></pixra>
...
plicru
: $x_1$ gibt $x_2$ etwas $x_3$ zur Verwendung
...
vecnu
: $x_1$ verkauft $x_2$ an $x_3$ zum Preis $x_4$
ciska
: $x_1$ schreibt $x_2$ auf Oberfläche $x_3$ mit Werkzeug $x_4$
...
klama
: $x_1$ geht zu $x_2$ von $x_3$ via $x_4$ mit Mitteln $x_5$
...
mrilu
: $x_1$ schickt $x_2$ per Post an $x_3$ von $x_4$ mit Träger $x_5$
pagbu
: $x_1$ ist ein Teil von $x_2$
...
- **fa** markiert das Argument, das die erste Stelle einer Relation füllt ($x_1$)
- **fe** markiert das Argument, das die zweite Stelle füllt ($x_2$)
- **fi** markiert das Argument, das die dritte Stelle füllt ($x_3$)
- **fo** markiert das Argument, das die vierte Stelle füllt ($x_4$)
- **fu** markiert das Argument, das die fünfte Stelle füllt ($x_5$)
...
tugni
: $x_1$ stimmt mit jemandem $x_2$ überein über $x_3$ (Proposition)
...
<td>$x_1$ = mi, $x_2$ = le plise, $x_3$ = do (Ich gebe dir den Apfel)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike xamgu</b></td>
<td>$x_1$ nicht angegeben, $x_2$ = mi, $x_3$ = le zgike (etwas ist gut für mich bezüglich Musik)</td>
</tr>
<tr>
<td><b>fi le prenu fe le melbi fo le xunre fa mi cuxna</b></td>
<td>$x_1$ = mi, $x_2$ = le melbi, $x_3$ = le prenu, $x_4$ = le xunre (Ich wähle die schöne aus unter den Leuten aus den roten)</td>
</tr></tbody></table>
...
tavla
: $x_1$ spricht mit jemandem $x_2$ über Thema $x_3$
...
: $x_1$ mag $x_2$
zmadu
: $x_1$ übertrifft $x_2$ in Eigenschaft $x_3$
mlatu
: $x_1$ ist eine Katze
...
mamta
: $x_1$ ist eine Mutter von $x_2$
patfu
: $x_1$ ist ein Vater von $x_2$
ralte
: $x_1$ behält $x_2$ in seinem Besitz
ponse
: $x_1$ besitzt rechtmäßig $x_2$
...
stati
: $x_1$ ist klug/intelligent
jundi
: $x_1$ ist aufmerksam auf $x_2$
zvati
: $x_1$ ist anwesend bei $x_2$
...
: $x_1$ mag $x_2$
mupli
: $x_1$ ist ein Beispiel für $x_2$ unter $x_3$
le'e
...
<pixra url="/assets/pixra/cilre/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="Die Schlange umringte die Person."></pixra>
...
gunma
: $x_1$ ist eine Masse gebildet aus Komponenten $x_2$
barda
: $x_1$ ist groß/large
zvati
: $x_1$ ist anwesend bei $x_2$
