...
Wörterbücher können Definitionen von Relationswörtern mit Symbolen wie x<sub>1</sub>, x<sub>2</sub> usw. darstellen:

prami
: x<sub>1</sub> liebt x<sub>2</sub>

karce
: x<sub>1</sub> ist ein Auto …

citka
: x<sub>1</sub> isst x<sub>2</sub> …

klama
: x<sub>1</sub> kommt zu x<sub>2</sub> …

Diese x<sub>1</sub>, x<sub>2</sub> usw. sind die explizite Notation für die sogenannten _Stellen_ (andere Bezeichnungen sind: _Plätze_, _Rollen der Relation_, **terbricmi** auf Lojban). Stellen werden durch Argumentterme (**sumti**) im Satz gefüllt.
...
- x<sub>1</sub> _denjenigen bezeichnet, der liebt_, und
- x<sub>2</sub> _denjenigen bezeichnet, der geliebt wird_.

Mit anderen Worten, jede Relation hat eine oder mehrere Stellen, und diese Stellen sind spezifiziert und als x<sub>1</sub>, x<sub>2</sub> usw. beschriftet. Wir setzen Argumente wie **mi**, **do**, **le tavla** usw. der Reihe nach ein und füllen so diese Stellen und geben der Relation eine konkrete Bedeutung, wodurch wir einen Satz bilden.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… ist ein Berg"></pixra>
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> kommt zu x<sub>2</sub> von x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> liebt x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> ist ein Auto</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>x<sub>1</sub> isst x<sub>2</sub></td>
</tr></tbody></table>
...
pinxe
: x<sub>1</sub> trinkt x<sub>2</sub> aus x<sub>3</sub>
...
plicru
: x<sub>1</sub> gibt, spendet jemandem x<sub>2</sub> ein Objekt x<sub>3</sub>; x<sub>1</sub> erlaubt jemandem x<sub>2</sub>, x<sub>3</sub> zu verwenden

#### Aufgabe

zgana
: x<sub>1</sub> beobachtet/bemerkt x<sub>2</sub> mit den Sinnen x<sub>3</sub>
...
<tr>
<td><i>Ich gebe dem Kind den Apfel.</i></td>
...
- **mi** als x<sub>1</sub>, die erste Stelle der Relation,
...
- **mi** als x<sub>1</sub>, die erste Stelle der Relation innerhalb des Terms
...
tavla
: x<sub>1</sub> spricht mit x<sub>2</sub> …

melbi
: x<sub>1</sub> ist schön, hübsch für x<sub>2</sub> …
...
nandu
: x<sub>1</sub> ist schwer für x<sub>2</sub>

tilju
: x<sub>1</sub> ist schwer (Gewicht)
...
klama
: x<sub>1</sub> kommt zu x<sub>2</sub> von x<sub>3</sub>
...
<td>Verwendet Kernargumente (x<sub>2</sub> und x<sub>3</sub> von klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Verwendet Kernargument (x<sub>2</sub> = le zarci) und Modalterm (ca le nu do pinxe)</td>
</tr>
<tr>
...
1. Die erste Stelle ist oft die Person oder das Ding, das etwas tut oder etwas ist:
   ...
   **klama** = _x<sub>1</sub> geht …_

2. Das Objekt einer Handlung steht normalerweise direkt nach der ersten Stelle:

   **punji** = _x<sub>1</sub> legt x<sub>2</sub> auf x<sub>3</sub>_,
...
4. Ziel (_zu_) Stellen kommen fast immer vor Herkunft (_von_) Stellen:
   ...
   **klama** = _x<sub>1</sub> geht zu x<sub>2</sub> von x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="Die Person geht aus dem Laden heraus."></pixra>
...
dunda
: x<sub>1</sub> gibt x<sub>2</sub> an x<sub>3</sub>

benji
: x<sub>1</sub> überträgt x<sub>2</sub> an x<sub>3</sub> von x<sub>4</sub>

lebna
: x<sub>1</sub> nimmt x<sub>2</sub> von x<sub>3</sub>
...
troci
: x<sub>1</sub> versucht zu tun oder zu sein x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> geht

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="Das Kind versucht zu gehen."></pixra>
...
cinmo
: x<sub>1</sub> fühlt x<sub>2</sub> (ka)

Das bedeutet, dass der Infinitiv in der zweiten Stelle (x<sub>2</sub>) auf eine andere Stelle angewendet wird (höchstwahrscheinlich die erste Stelle, x<sub>1</sub>). Fälle, in denen der Infinitiv auf andere Stellen als x<sub>2</sub> angewendet wird, sind selten und werden in Wörterbüchern für entsprechende Relationen erklärt oder können bei inoffiziell erfundenen Relationswörtern aus dem gesunden Menschenverstand durch Analogie mit anderen ähnlichen Relationswörtern abgeleitet werden.

Ein weiteres Beispiel:

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Er/sie hilft dem Freund, die Taschen zu tragen."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Er/sie hilft dem Freund, die Taschen zu tragen._

sidju
: x<sub>1</sub> hilft x<sub>2</sub>, x<sub>3</sub> zu tun (ka)

Das Relationswort **sidju** erfordert, dass seine dritte Stelle mit einem Infinitiv gefüllt wird.

bevri
: x<sub>1</sub> trägt x<sub>2</sub>
...
zgana
: x<sub>1</sub> beobachtet x<sub>2</sub>

kakne
: x<sub>1</sub> ist fähig, x<sub>2</sub> zu tun (Eigenschaft)
...
djica
: x<sub>1</sub> will x<sub>2</sub> (Ereignis)
...
zekri
: x<sub>1</sub> ist ein kriminelles Ereignis, x<sub>1</sub> (Ereignis) ein Verbrechen

cumki
: x<sub>1</sub> (Ereignis) ist möglich
...
stidi
: x<sub>1</sub> schlägt Handlung x<sub>2</sub> (Eigenschaft) jemandem x<sub>3</sub> vor
...
<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="Die Person will das süße Essen."></pixra>
...
Das Lojban-Relationswort **stidi** erfordert jedoch eine Eigenschaft in seiner x<sub>2</sub>-Stelle. Ebenso erfordert **djica** ein Ereignis in seiner x<sub>2</sub>-Stelle.
...
cakla
: x<sub>1</sub> ist etwas Schokolade
...
stidi
: x<sub>1</sub> schlägt x<sub>2</sub> (Eigenschaft) jemandem x<sub>3</sub> vor
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="der Freund / die Freunde"></pixra>
...
Standardmäßig wird die zweite Stelle (x<sub>2</sub>) angehängt. Wir können mehr Stellen anhängen, indem wir sie mit **bei** trennen:

> **mi plicru do le plise**
> _Ich gebe dir den Apfel._

<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="Die Person gibt dem Freund das Utensil."></pixra>
...
ctuca
: x<sub>1</sub> unterrichtet jemandem x<sub>2</sub> das Fach x<sub>3</sub>

cmene
: x<sub>1</sub> ist ein Name von x<sub>2</sub>, verwendet von x<sub>3</sub>
...
speni
: x<sub>1</sub> ist verheiratet mit x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="Der Hund, den ich gewöhnlich im Park sehe."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="Der Baum ist groß."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Ich mag diese, deren Lächeln mir gefällt."></pixra>
...
pluka
: x<sub>1</sub> ist angenehm für x<sub>2</sub>

zutse
: x<sub>1</sub> sitzt, sitzt auf x<sub>2</sub>
...
birka
: x<sub>1</sub> ist ein Arm von x<sub>2</sub>
...
<td><i>Das Telefon, das für mich schön ist, ist groß.</i></td>
</tr>
<tr>
<td><b>le fonxa pe mi cu melbi</b></td>
<td><i>Das Telefon, das meins ist, ist schön.</i></td>
</tr>
<tr>
<td><b>le pendo be do cu tavla</b></td>
<td><i>Der Freund von dir spricht.</i></td>
</tr>
<tr>
...
<td><i>Das für mich schöne Telefon des Freundes von mir ist groß.</i></td>
</tr></tbody></table>

Decken Sie den rechten Teil der Tabelle ab. Übersetzen Sie die Sätze links ins Lojban.

tuple
: x<sub>1</sub> ist ein Bein von x<sub>2</sub>

clani
: x<sub>1</sub> ist lang, langgestreckt

cinri
: x<sub>1</sub> (Ereignis) ist interessant für jemanden x<sub>2</sub>
...
<table style="table-layout: fixed;">
<tbody><tr>
<td><i>Deine Beine sind lang.</i></td>
<td><b>le tuple be do cu clani</b></td>
</tr>
<tr>
<td><i>Das Buch, das meins ist, ist interessant.</i></td>
<td><b>le cukta pe mi cu cinri</b></td>
</tr>
<tr>
<td><i>Die Person, die mit dir in Beziehung steht, ist klug.</i></td>
<td><b>le prenu pe do cu stati</b></td>
</tr>
<tr>
<td><i>Der Freund von dir, der mit Paris in Beziehung steht, ist klug.</i></td>
<td><b>le pendo be do be'o pe la .paris. cu stati</b></td>
</tr>
<tr>
<td><i>Das für mich schöne Telefon meines Freundes ist groß.</i></td>
<td><b>le pa melbi be mi fonxa pe le pa pendo be mi cu barda</b></td>
</tr></tbody></table>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="Ich unterrichte / Ich bin ein Lehrer."></pixra>
...
tunba
: x<sub>1</sub> ist ein Geschwister von x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="Du bist mein Geschwister."></pixra>

#### Aufgabe

gerku
: x<sub>1</sub> ist ein Hund

badna
: x<sub>1</sub> ist eine Banane

pendo
: x<sub>1</sub> ist ein Freund von x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="Was eine Wüste war, ist jetzt ein Garten."></pixra>

> **le pu kunti tumla ca purdi**
> _Was eine Wüste war, ist jetzt ein Garten._

kunti
: x<sub>1</sub> ist leer

tumla
: x<sub>1</sub> ist ein Stück Land
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="Die Wüste war ein Garten."></pixra>
...
melbi
: x<sub>1</sub> ist schön

sutra
: x<sub>1</sub> ist schnell
...
<td>Das "ca" gilt für "mi melbi" - mein Schönsein jetzt ist schnell</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> gibt x<sub>2</sub> etwas x<sub>3</sub> zur Verwendung
...
vecnu
: x<sub>1</sub> verkauft x<sub>2</sub> an x<sub>3</sub> zum Preis x<sub>4</sub>

ciska
: x<sub>1</sub> schreibt x<sub>2</sub> auf Oberfläche x<sub>3</sub> mit Werkzeug x<sub>4</sub>
...
zbasu
: x<sub>1</sub> baut, macht x<sub>2</sub> aus x<sub>3</sub>
...
klama
: x<sub>1</sub> geht zu x<sub>2</sub> von x<sub>3</sub> via x<sub>4</sub> mit Mitteln x<sub>5</sub>
...
mrilu
: x<sub>1</sub> schickt Objekt x<sub>2</sub> per Post an Empfängeradresse x<sub>3</sub> von Briefkasten x<sub>4</sub> mit Trägernetzwerk x<sub>5</sub>

pagbu
: x<sub>1</sub> ist ein Teil von x<sub>2</sub>
...
- **fa** markiert das Argument, das die erste Stelle einer Relation füllt (x<sub>1</sub>)
- **fe** markiert das Argument, das die zweite Stelle füllt (x<sub>2</sub>)
- **fi** markiert das Argument, das die dritte Stelle füllt (x<sub>3</sub>)
- **fo** markiert das Argument, das die vierte Stelle füllt (x<sub>4</sub>)
- **fu** markiert das Argument, das die fünfte Stelle füllt (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="Die Person trinkt aus dem Glas."></pixra>
...
tugni
: x<sub>1</sub> stimmt mit jemandem x<sub>2</sub> überein über x<sub>3</sub> (Proposition)
...
xamgu
: x<sub>1</sub> ist gut für x<sub>2</sub> in Bezug auf x<sub>3</sub>

cuxna
: x<sub>1</sub> wählt x<sub>2</sub> aus unter x<sub>3</sub>

zgike
: x<sub>1</sub> ist Musik
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (Ich gebe dir den Apfel)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> nicht angegeben, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (etwas ist gut für mich bezüglich Musik)</td>
</tr></tbody></table>
...
tavla
: x<sub>1</sub> spricht mit jemandem x<sub>2</sub> über Thema x<sub>3</sub>
...
djuno
: x<sub>1</sub> weiß x<sub>2</sub> (Fakt) über x<sub>3</sub>
...
<td>Es gibt jemanden, der Kenntnisse besitzt (<b>da</b>), so dass ich das Ereignis will, dass er mir hilft; <b>da</b> ist dieselbe Person im Prenex und innerhalb von <b>le nu</b></td>
</tr></tbody></table>
...
Wenn ein Satz eine zweite oder dritte separate Variable benötigt, verwendet Lojban **de** und **di** nach **da** (siehe auch [„Gruppierung von Quantoren" im CLL](/en/books/cll/16/#section-quantifier-grouping)):

da
: Pronomen: erste Variable (wie logisches _X_).

de
: Pronomen: zweite Variable (wie logisches _Y_).

di
: Pronomen: dritte Variable (wie logisches _Z_).

> **da de zo'u mi djica le nu da tavla de**
> _Es gibt jemanden und jemand anderen, so dass ich wünschte, der erste hätte mit dem zweiten gesprochen (**da** und **de** beziehen sich auf diese beiden Personen im Prenex und innerhalb von **le nu**)._
...
zmadu
: x<sub>1</sub> übertrifft x<sub>2</sub> in Eigenschaft x<sub>3</sub>

mlatu
: x<sub>1</sub> ist eine Katze
...
<td>Ersteres: Zwei Personen (auf die wir mit Variablen verweisen) übersteigen jeweils eine Person; die überstiegene Person kann für jede der beiden unterschiedlich sein oder dieselbe. Letzteres: Jede der beiden <b>le prenu</b> übertrifft eine <b>le prenu</b>; jede <b>le prenu</b> kann einen neuen Referenten wählen, sodass die Paare nicht übereinstimmen müssen (vgl. <a href="#scope">Skopus</a>)</td>
</tr>
<tr>
...
ralte
: x<sub>1</sub> behält x<sub>2</sub> in seinem Besitz
...
ponse
: x<sub>1</sub> besitzt x<sub>2</sub>

#### Aufgabe

mamta
: x<sub>1</sub> ist eine Mutter von x<sub>2</sub>
...
ponse
: x<sub>1</sub> besitzt rechtmäßig x<sub>2</sub>
...
<tr>
<td><i>Mein Freund/meine Freundin hat zwei Kinder</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Drei Menschen sprechen jeweils mit zwei Kindern."></pixra>
...
Um den Skopus gleich zu machen, verwenden wir eine spezielle Konjunktion **ce'e**, die zwei Terme verbindet. Terme, die durch **ce'e** verbunden sind, werden als *gleichem Skopus* verstanden: Sie agieren als *Gleichrangige* für das Folgende.
...
mo'u
: Term: natürliche Vollendung — das Ereignis hat sein natürliches Ende erreicht
...
**mo'u** bedeutet, dass ein Ereignis sein natürliches Ende erreicht hat (natürliche Vollendung). Welches Ereignis? Das Ereignis **co'a speni** — verheiratet zu werden. Daher bedeutet **mi mo'u co'a speni** _Ich beende den Prozess des Verheiratens_, d.h. _Ich bin frisch verheiratet._
...
tavla
: x<sub>1</sub> spricht mit x<sub>2</sub> über x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Hier ist alles seltsam."></pixra>
...
stati
: x<sub>1</sub> ist klug/intelligent

jundi
: x<sub>1</sub> ist aufmerksam auf x<sub>2</sub>

zvati
: x<sub>1</sub> ist anwesend bei x<sub>2</sub>
...
mupli
: x<sub>1</sub> ist ein Beispiel für x<sub>2</sub> (Eigenschaft) unter x<sub>3</sub> (Menge)
...
mupli
: x<sub>1</sub> ist ein Beispiel für x<sub>2</sub> unter x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="Die Leute umringten den Tisch."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="Die Schlange umringte die Person."></pixra>
...
gunma
: x<sub>1</sub> ist eine Masse gebildet aus Komponenten x<sub>2</sub>
...
grake
: x<sub>1</sub> wiegt x<sub>2</sub> (Zahl) Gramm
