...
<pixra url="/assets/pixra/books/learn-lojban/le_vehi_ja_vehu_cmana.webp" caption="le ve'i cmana cu jibni le ve'u cmana" definition="Der Hügel ist nahe beim Berg."></pixra>
...
ba'o
: Modalbegriff: Nachwirkung — die Zeit nach dem Ende des Ereignisses
...
<pixra url="/assets/pixra/books/learn-lojban/puho_nenri.webp" caption="le prenu pu'o zvati le nenri" definition="Die Person ist im Begriff, drinnen zu sein."></pixra>
...
> (Wir sind in der Nachwirkung des Sprechens — **pu** setzt das in die Vergangenheit.)

<pixra url="/assets/pixra/books/learn-lojban/baho_carvi.webp" caption="ba'o carvi" definition="Nach dem Regen. Der Regen hat aufgehört."></pixra>

<!-- -->

> **le verba ba'o cadzu le bisli**
> _Das Kind geht nicht mehr auf dem Eis._
> (Wir sind in der Nachwirkung des Gehens.)
...
In Verbindung mit **pu**, **ca** oder **ba** übersetzt **ba'o** oft Vergangenheits-, Präsens- oder Zukunftsperfekt, wenn „in der Nachwirkung zu jenem Zeitpunkt“ gemeint ist; **ba'o** selbst bedeutet „in der Nachwirkung“, nicht „Perfect-Tempus“.
...
vasxu
: x<sub>1</sub> atmet x<sub>2</sub>

> **mi pu mo'u citka le plise**
> _Ich habe den Apfel aufgegessen._
> (Natürliche Vollendung: das Essen hat sein natürliches Ende erreicht.)

<!-- -->

> **la .maks. pu mo'u zbasu ti voi dinju**
> _Max hat dieses Haus fertiggebaut._
> (Natürliche Vollendung: der Bau hat sein natürliches Ende erreicht; er baut jetzt nicht.)

Gegenüber **co'u** (aufgehört, gestoppt — vielleicht vor dem natürlichen Ende) steht **mo'u** (beendet — natürliches Ende erreicht): _Ich hörte auf zu essen_ (**mi pu co'u citka**) kann heißen, du hast etwas übriggelassen; _Ich habe den Apfel aufgegessen_ (**mi pu mo'u citka le plise**) heißt, du hast das natürliche Ende erreicht.
...
<pixra url="/assets/pixra/books/learn-lojban/deha_vasxu.webp" caption="mi de'a vasxu" definition="Ich pausiere beim Atmen. Ich halte den Atem an."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/diha_vasxu.webp" caption="mi di'a vasxu" definition="Ich atme wieder."></pixra>
...
co'u
: Modalbegriff: das Ereignis hört auf (Beendigung; möglicherweise vor dem natürlichen Ende)

mo'u
: Modalbegriff: natürliche Vollendung — das Ereignis hat seinen natürlichen Endpunkt erreicht
...
jundi
: x<sub>1</sub> achtet auf x<sub>2</sub>
...
In der Grafik erscheint **ba'o** (Nachwirkung) zweimal: einmal nach **mo'u** (natürliche Vollendung) und einmal nach **co'u** (Beendigung) — die Nachwirkung kann auf beides folgen. **co'i** ist Perfektiv (Ereignis als einheitliches Ganzes); **mo'u** ist natürliche Vollendung; **ba'o** ist die Zeit nach dem Ende des Ereignisses.
...
<pixra url="/assets/pixra/books/learn-lojban/pritu_le_tricu.webp" caption="le prenu cu pritu le tricu le zgana" definition="Die Person ist rechts vom Baum aus der Sicht des Beobachters."></pixra>
...
zunle
: x<sub>1</sub> ist links von x<sub>2</sub>, wie von x<sub>3</sub> aus gesehen

pritu
: x<sub>1</sub> ist rechts von x<sub>2</sub>, wie von x<sub>3</sub> aus gesehen

crane
: x<sub>1</sub> ist vor x<sub>2</sub> (x<sub>1</sub> ist zwischen x<sub>2</sub> und demjenigen, der beobachtet), wie von x<sub>3</sub> aus gesehen

trixe
: x<sub>1</sub> ist hinter x<sub>2</sub>, wie von x<sub>3</sub> aus gesehen

sanli
: x<sub>1</sub> steht auf x<sub>2</sub>

zutse
: x<sub>1</sub> sitzt auf x<sub>2</sub>

vreta
: x<sub>1</sub> liegt auf x<sub>2</sub>
...
marce
: x<sub>1</sub> ist ein Fahrzeug, das x<sub>2</sub> trägt

se marce
: x<sub>1</sub> ist ein Passagier von x<sub>2</sub>

<!-- jai zu'e se marce
: x<sub>1</sub> takes a vehicle x<sub>2</sub> as a passenger -->

karce
: x<sub>1</sub> ist ein Auto, das x<sub>2</sub> trägt

bloti
: x<sub>1</sub> ist ein Boot, das x<sub>2</sub> trägt

vinji
: x<sub>1</sub> ist ein Flugzeug, das x<sub>2</sub> trägt

trene
: x<sub>1</sub> ist ein Zug aus Wagen x<sub>2</sub>
...
pixra
: x<sub>1</sub> ist ein Bild von x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viha_pixra.webp" caption="vi'a pixra" definition="2D-Bild, 2D-Zeichnung."></pixra>

<pixra url="/assets/pixra/books/learn-lojban/vihu_pixra.webp" caption="vi'u pixra" definition="3D-Bild, Skulptur."></pixra>
