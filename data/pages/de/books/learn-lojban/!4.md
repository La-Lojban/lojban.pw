...
tirna
: $x_1$ hört $x_2$ (Objekt oder Geräusch)
...
ganse
: $x_1$ nimmt Reiz $x_2$ (Objekt, Ereignis) durch Mittel $x_3$ wahr
...
zgana
: $x_1$ bemerkt, beobachtet, beobachtet $x_2$. Nicht auf Sehen beschränkt
...
cortu
: $x_1$ hat Schmerzen in Organ $x_2$, das ein Teil von $x_1$s Körper ist
...
gusni
: $x_1$ ist Licht, das $x_2$ von der Lichtquelle $x_3$ beleuchtet
...
ganse
: Beobachter $x_1$ nimmt wahr, bemerkt einen Reiz (Ereignis) durch Mittel $x_3$

sanji
: $x_1$ ist bewusst, sich bewusst von $x_2$ (Ereignis)

**ganse** impliziert keine mentale Verarbeitung; es beschreibt nur Wahrnehmung, Erkennung, Erkennung eines Reizes über sensorische Kanäle (spezifiziert in $x_3$).
...
surla
: $x_1$ entspannt sich, indem er $x_2$ tut (Eigenschaft von $x_1$)
...
bilma
: $x_1$ ist krank oder erkrankt mit Symptomen $x_2$ von Krankheit $x_3$
...
speni
: $x_1$ ist ein Ehemann/eine Ehefrau von $x_2$
...
lanzu
: $x_1$ ist eine Familie, die $x_2$ einschließt
...
mamta
: $x_1$ ist eine Mutter von $x_2$, $x_1$ verhält sich mütterlich

patfu
: $x_1$ ist ein Vater von $x_2$

rirni
: $x_1$ ist ein Elternteil von $x_2$, $x_1$ zieht $x_2$ auf
...
pleji
: $x_1$ bezahlt $x_2$ an $x_3$ für $x_4$
...
sledi'u
: $x_1$ ist ein Zimmer, ein Teil eines Gebäudes $x_2$

vimstu
: $x_1$ ist eine Toilette, ein Ort zum Ausscheiden

lumstu
: $x_1$ ist ein Badezimmer, ein Ort zum Waschen von etwas
...
tcadu
: $x_1$ ist eine Stadt oder Stadt

jarbu
: $x_1$ ist ein Vorortgebiet der Stadt/Stadt $x_2$

nurma
: $x_1$ ist ein ländlicher Bereich, $x_1$ ist auf dem Land
