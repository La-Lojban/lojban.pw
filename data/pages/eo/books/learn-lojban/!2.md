...
Vortaroj povas prezenti difinojn de rilat-vortoj kun simboloj kiel $x_1$, $x_2$ ktp.:
...
Ĉi tiuj $x_1$, $x_2$, kaj tiel plu estas la eksplicita notacio por la tiel nomataj _lokoj_ (aliaj nomoj estas: _pozicioj_, _roloj de rilato_, **terbricmi** en Loĵbano). Lokoj estas plenigataj per argument-termoj (**sumti**) en la frazo.
...
- $x_1$ indikas _tiun kiu amas_, kaj
- $x_2$ indikas _tiun kiu estas amata de_.

Alivorte, ĉiu rilato havas unu aŭ pli da lokoj, kaj tiuj lokoj estas specifitaj kaj etikeditaj kiel $x_1$, $x_2$, kaj tiel plu. Ni metas argumentojn kiel **mi**, **do**, **le tavla** ktp. laŭ ordo, tiel plenigante tiujn lokojn kaj donante konkretan signifon al la rilato, tiel formante frazon.
...
<tr>
<td><b>karce</b></td>
<td>$x_1$ estas aŭto</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>$x_1$ manĝas $x_2$</td>
</tr></tbody></table>
...
plicru
: $x_1$ donas, donacas al $x_2$ objekton $x_3$; $x_1$ permesas al iu $x_2$ uzi $x_3$

#### Tasko

zgana
: $x_1$ observas/rimarkas $x_2$ uzante sensojn $x_3$
...
- **mi** kiel $x_1$, la unua loko de la rilato,
...
- **mi** kiel $x_1$, la unua loko de la rilato ene de la termo
...
<td>Uzas kernajn argumentojn ($x_2$ kaj $x_3$ de klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Uzas kernan argumenton ($x_2$ = le zarci) kaj modalan termon (ca le nu do pinxe)</td>
</tr>
<tr>
...
4. Celo (_al_) lokoj preskaŭ ĉiam venas antaŭ deveno (_el_) lokoj:
    ...
    **klama** = _$x_1$ iras al $x_2$ el $x_3$_

    <pixra url="/assets/pixra/cilre/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="La persono eliras el la vendejo."></pixra>
...
dunda
: $x_1$ donas $x_2$ al $x_3$
benji
: $x_1$ transdonas $x_2$ al $x_3$ el $x_4$
lebna
: $x_1$ prenas $x_2$ el $x_3$
...
<pixra url="/assets/pixra/cilre/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="La infano provas marŝi."></pixra>
...
Ĉi tio signifas ke la infinitivo en la dua loko ($x_2$) estas aplikata al iu alia loko (plej verŝajne, la unua loko, $x_1$). Kazoj kie la infinitivo estas aplikata al lokoj aliaj ol $x_2$ estas maloftaj kaj estas klarigitaj en vortaroj por respondaj rilatoj aŭ en la kazo de rilat-vortoj elpensite neoficiale, povas esti deduktitaj el komuna senco per analogio kun aliaj similaj rilat-vortoj.
...
zekri
: $x_1$ estas krimaga evento, $x_1$ (evento) krimo
...
> `Ke estas krimaga estas ebla.`
> _Estas eble ke io estas krimo._
...
Tamen, la Loĵbana rilat-vorto **stidi** postulas econ en sia $x_2$ loko. Simile, **djica** postulas eventon en sia $x_2$ loko.
...
Defaŭlte, ĝi alkroĉas la duan lokon ($x_2$). Ni povas alkroĉi pli da lokoj apartigante ilin per **bei**:

> **mi plicru do le plise**
> _Mi donas al vi la pomon._

<pixra url="/assets/pixra/cilre/plicru.webp" caption="le prenu cu plicru le pendo le plise" definition="La persono donas al la amiko la pomon."></pixra>
<!-- -->
...
ctuca
: $x_1$ instruas $x_2$ (temo) al $x_3$
cmene
: $x_1$ estas nomo de $x_2$ uzata de $x_3$
...
<pixra url="/assets/pixra/cilre/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="La arbo estas granda."></pixra>
...
<pixra url="/assets/pixra/cilre/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Mi ŝatas ĉi tiujn kies ridetoj plaĉas al mi."></pixra>
...
pluka
: $x_1$ estas agrabla al $x_2$

zutse
: $x_1$ sidas, estas sidanta sur $x_2$
...
<pixra url="/assets/pixra/cilre/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="Kio estis dezerto estas nun ĝardeno."></pixra>
...
plicru
: $x_1$ donas al $x_2$ ion $x_3$ por uzo
...
vecnu
: $x_1$ vendas $x_2$ al $x_3$ por prezo $x_4$
ciska
: $x_1$ skribas $x_2$ sur surfaco $x_3$ per ilo $x_4$
...
klama
: $x_1$ iras al $x_2$ el $x_3$ tra $x_4$ per rimedo $x_5$
...
mrilu
: $x_1$ poŝtas $x_2$ al $x_3$ el $x_4$ per transportanto $x_5$
pagbu
: $x_1$ estas parto de $x_2$
...
tugni
: $x_1$ konsentas kun iu $x_2$ pri $x_3$ (propozicio)
...
: $x_1$ donas $x_2$ al $x_3$
xamgu
: $x_1$ estas bona por $x_2$
cuxna
: $x_1$ elektas $x_2$ el inter $x_3$
...
<td>$x_1$ = mi, $x_2$ = le plise, $x_3$ = do (Mi donas la pomon al vi)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike xamgu</b></td>
<td>$x_1$ ne specifita, $x_2$ = mi, $x_3$ = le zgike (io estas bona por mi laŭ muziko)</td>
</tr>
<tr>
<td><b>fi le prenu fe le melbi fo le xunre fa mi cuxna</b></td>
<td>$x_1$ = mi, $x_2$ = le melbi, $x_3$ = le prenu, $x_4$ = le xunre (Mi elektas la belan el inter personoj el la ruĝaj)</td>
</tr></tbody></table>
...
mamta
: $x_1$ estas patrino de $x_2$
patfu
: $x_1$ estas patro de $x_2$
ralte
: $x_1$ tenas $x_2$ en sia posedo
ponse
: $x_1$ laŭleĝe posedas $x_2$
...
stati
: $x_1$ estas saĝa/lerta
jundi
: $x_1$ estas atenta al $x_2$
zvati
: $x_1$ ĉeestas ĉe $x_2$
...
: $x_1$ ŝatas $x_2$
mupli
: $x_1$ estas ekzemplo de $x_2$ inter $x_3$
le'e
...
<pixra url="/assets/pixra/cilre/sruri.webp" caption="lei prenu cu sruri le jubme" definition="La personoj ĉirkaŭis la tablon."></pixra>
...
gunma
: $x_1$ estas maso formita el komponantoj $x_2$
barda
: $x_1$ estas granda/ampleksa
zvati
: $x_1$ ĉeestas ĉe $x_2$
