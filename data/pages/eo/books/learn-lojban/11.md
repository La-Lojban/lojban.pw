...
vitke
: x<sub>1</sub> (gasto) vizitas x<sub>2</sub> (iun) ĉe x<sub>3</sub>
...
jibri
: x<sub>1</sub> estas laboro de x<sub>2</sub>
...
merko
: x<sub>1</sub> estas usona (la Usono-senco)
...
> _Li estas la unua inter miaj amikoj kiuj kune silentas._
...
simxu
: membroj de la aro x<sub>1</sub> reciproke faras x<sub>2</sub>

La rilato **simxu** prenas ĉiun eblan paron el la aro specifita en loko x<sub>1</sub> kaj asertas la rilaton specifitan ene de x<sub>2</sub>.
...
cmima
: x<sub>1</sub> estas membro de aro x<sub>2</sub>
...
> _Kelkaj junuloj el tiuj saĝaj personoj amas unu la alian._
