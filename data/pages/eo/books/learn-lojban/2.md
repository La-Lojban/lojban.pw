...
Vortaroj povas prezenti difinojn de rilat-vortoj kun simboloj kiel x<sub>1</sub>, x<sub>2</sub> ktp.:

prami
: x<sub>1</sub> amas x<sub>2</sub>

karce
: x<sub>1</sub> estas aŭto …

citka
: x<sub>1</sub> manĝas x<sub>2</sub> …

klama
: x<sub>1</sub> venas al x<sub>2</sub> …

Ĉi tiuj x<sub>1</sub>, x<sub>2</sub>, kaj tiel plu estas la eksplicita notacio por la tiel nomataj _lokoj_ (aliaj nomoj estas: _pozicioj_, _roloj de rilato_, **terbricmi** en Loĵbano). Lokoj estas plenigataj per argument-termoj (**sumti**) en la frazo.
...
- x<sub>1</sub> indikas _tiun kiu amas_, kaj
- x<sub>2</sub> indikas _tiun kiu estas amata de_.

Alivorte, ĉiu rilato havas unu aŭ pli da lokoj, kaj tiuj lokoj estas specifitaj kaj etikeditaj kiel x<sub>1</sub>, x<sub>2</sub>, kaj tiel plu. Ni metas argumentojn kiel **mi**, **do**, **le tavla** ktp. laŭ ordo, tiel plenigante tiujn lokojn kaj donante konkretan signifon al la rilato, tiel formante frazon.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… estas monto"></pixra>
...
> _Tio estas mia rapide kuranta amiko._
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> venas al x<sub>2</sub> el x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> amas x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> estas aŭto</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>x<sub>1</sub> manĝas x<sub>2</sub></td>
</tr></tbody></table>
...
pinxe
: x<sub>1</sub> trinkas x<sub>2</sub> el x<sub>3</sub>
...
plicru
: x<sub>1</sub> donas, donacas al x<sub>2</sub> objekton x<sub>3</sub>; x<sub>1</sub> permesas al iu x<sub>2</sub> uzi x<sub>3</sub>

#### Tasko

zgana
: x<sub>1</sub> observas/rimarkas x<sub>2</sub> uzante sensojn x<sub>3</sub>
...
<tr>
<td><i>Mi donas la pomon al la infano.</i></td>
...
- **mi** kiel x<sub>1</sub>, la unua loko de la rilato,
...
- **mi** kiel x<sub>1</sub>, la unua loko de la rilato ene de la termo
...
tavla
: x<sub>1</sub> parolas al x<sub>2</sub> …

melbi
: x<sub>1</sub> estas bela, agrabla al x<sub>2</sub> …
...
nandu
: x<sub>1</sub> estas malfacila al x<sub>2</sub>

tilju
: x<sub>1</sub> estas peza
...
klama
: x<sub>1</sub> venas al x<sub>2</sub> el x<sub>3</sub>
...
<td>Uzas kernajn argumentojn (x<sub>2</sub> kaj x<sub>3</sub> de klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Uzas kernan argumenton (x<sub>2</sub> = le zarci) kaj modalan termon (ca le nu do pinxe)</td>
</tr>
<tr>
...
1. La unua loko ofte estas la persono aŭ afero kiu faras ion aŭ estas io:
   ...
   **klama** = _x<sub>1</sub> iras …_

2. La objekto de ia ago kutime estas tuj post la unua loko:

   **punji** = _x<sub>1</sub> metas x<sub>2</sub> sur x<sub>3</sub>_,
...
4. Celo (_al_) lokoj preskaŭ ĉiam venas antaŭ deveno (_el_) lokoj:
   ...
   **klama** = _x<sub>1</sub> iras al x<sub>2</sub> el x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="La persono eliras el la vendejo."></pixra>
...
dunda
: x<sub>1</sub> donas x<sub>2</sub> al x<sub>3</sub>

benji
: x<sub>1</sub> transdonas x<sub>2</sub> al x<sub>3</sub> el x<sub>4</sub>

lebna
: x<sub>1</sub> prenas x<sub>2</sub> el x<sub>3</sub>
...
troci
: x<sub>1</sub> provas fari aŭ esti x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> marŝas

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="La infano provas marŝi."></pixra>
...
cinmo
: x<sub>1</sub> sentas x<sub>2</sub> (ka)

Ĉi tio signifas ke la infinitivo en la dua loko (x<sub>2</sub>) estas aplikata al iu alia loko (plej verŝajne, la unua loko, x<sub>1</sub>). Kazoj kie la infinitivo estas aplikata al lokoj aliaj ol x<sub>2</sub> estas maloftaj kaj estas klarigitaj en vortaroj por respondaj rilatoj aŭ en la kazo de rilat-vortoj elpensite neoficiale, povas esti deduktitaj el komuna senco per analogio kun aliaj similaj rilat-vortoj.

Alia ekzemplo:

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Li/ŝi helpas la amikon porti la sakojn."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Li/ŝi helpas la amikon porti la sakojn._

sidju
: x<sub>1</sub> helpas x<sub>2</sub> fari x<sub>3</sub> (ka)

La rilat-vorto **sidju** postulas ke ĝia tria loko estu plenita per infinitivo.

bevri
: x<sub>1</sub> portas x<sub>2</sub>
...
> _Mi sentas kvazaŭ iu malamas min._
> _Mi sentas esti malamata._

#### Tasko

zgana
: x<sub>1</sub> observas x<sub>2</sub>

kakne
: x<sub>1</sub> kapablas fari x<sub>2</sub> (eco)
...
djica
: x<sub>1</sub> deziras x<sub>2</sub> (evento)
...
zekri
: x<sub>1</sub> estas krimaga evento, x<sub>1</sub> (evento) krimo

cumki
: x<sub>1</sub> (evento) estas ebla
...
stidi
: x<sub>1</sub> sugestas agon x<sub>2</sub> (eco) al x<sub>3</sub>
...
> _Mi deziras la dolĉan manĝaĵon._
...
<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="La persono deziras la dolĉan manĝaĵon."></pixra>
...
Tamen, la Loĵbana rilat-vorto **stidi** postulas econ en sia x<sub>2</sub> loko. Simile, **djica** postulas eventon en sia x<sub>2</sub> loko.
...
> _La ĉokolado estas agrabla al mi (verŝajne pro ĝia gusto)._
> `Io pri la ĉokolado estas agrabla al mi`

cakla
: x<sub>1</sub> estas iom da ĉokolado
...
stidi
: x<sub>1</sub> sugestas x<sub>2</sub> (eco) al x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="la amiko / la amikoj"></pixra>
...
Defaŭlte, ĝi alkroĉas la duan lokon (x<sub>2</sub>). Ni povas alkroĉi pli da lokoj apartigante ilin per **bei**:

> **mi plicru do le plise**
> _Mi donas al vi la pomon._

<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="La persono donas al la amiko la ilon."></pixra>
...
ctuca
: x<sub>1</sub> instruas iun x<sub>2</sub> la temon x<sub>3</sub>

cmene
: x<sub>1</sub> estas nomo de x<sub>2</sub> uzata de x<sub>3</sub>
...
speni
: x<sub>1</sub> estas edzigita al x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="La hundo kiun mi kutime vidas en la parko."></pixra>
...
barda
: x<sub>1</sub> estas granda/ampleksa
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="La arbo estas granda."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Mi ŝatas ĉi tiujn kies ridetoj plaĉas al mi."></pixra>
...
pluka
: x<sub>1</sub> estas agrabla al x<sub>2</sub>

zutse
: x<sub>1</sub> sidas, estas sidanta sur x<sub>2</sub>
...
birka
: x<sub>1</sub> estas brako de x<sub>2</sub>
...
> _La amiko de vi kiu estas rilata al Parizo estas saĝa._
> <span>(<b>pe la .paris.</b> estas alkroĉita al la tuta argumento <b>le pa pendo be do be'o</b>)</span>

<!-- -->

> **le pu plicru be do bei le pa plise be'o pe la .paris. cu stati**
> _Tiu kiu donis al vi la pomon (kaj kiu estas rilata al Parizo) estas saĝa._
> <span>(<b>pe la .paris.</b> estas alkroĉita al la tuta argumento <b>le pu plicru be do bei le pa plise be'o</b>)</span>
...
<td><i>La telefono kiu estas bela al mi estas granda.</i></td>
</tr>
<tr>
<td><b>le fonxa pe mi cu melbi</b></td>
<td><i>La telefono kiu estas mia estas bela.</i></td>
</tr>
<tr>
<td><b>le pendo be do cu tavla</b></td>
<td><i>La amiko de vi parolas.</i></td>
</tr>
<tr>
...
<td><i>La bela al mi telefono de la amiko de mi estas granda.</i></td>
</tr></tbody></table>

Kovru la dekstran parton de la tabelo. Traduku la frazojn maldekstre al Loĵbano.

tuple
: x<sub>1</sub> estas kruro de x<sub>2</sub>

clani
: x<sub>1</sub> estas longa, longedaŭra

cinri
: x<sub>1</sub> (evento) estas interesa al iu x<sub>2</sub>
...
<table style="table-layout: fixed;">
<tbody><tr>
<td><i>Viaj kruroj estas longaj.</i></td>
<td><b>le tuple be do cu clani</b></td>
</tr>
<tr>
<td><i>La libro kiu estas mia estas interesa.</i></td>
<td><b>le cukta pe mi cu cinri</b></td>
</tr>
<tr>
<td><i>La persono rilata al vi estas saĝa.</i></td>
<td><b>le prenu pe do cu stati</b></td>
</tr>
<tr>
<td><i>La amiko de vi kiu estas rilata al Parizo estas saĝa.</i></td>
<td><b>le pendo be do be'o pe la .paris. cu stati</b></td>
</tr>
<tr>
<td><i>La bela al mi telefono de mia amiko estas granda.</i></td>
<td><b>le pa melbi be mi fonxa pe le pa pendo be mi cu barda</b></td>
</tr></tbody></table>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="Mi instruas / Mi estas instruisto."></pixra>
...
tunba
: x<sub>1</sub> estas gefrato de x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="Vi estas mia gefrato."></pixra>

#### Tasko

gerku
: x<sub>1</sub> estas hundo

badna
: x<sub>1</sub> estas banano

pendo
: x<sub>1</sub> estas amiko de x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="Kio estis dezerto estas nun ĝardeno."></pixra>

> **le pu kunti tumla ca purdi**
> _Kio estis dezerto estas nun ĝardeno._

kunti
: x<sub>1</sub> estas malplena

tumla
: x<sub>1</sub> estas terpeco
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="La dezerto estis ĝardeno."></pixra>
...
melbi
: x<sub>1</sub> estas bela

sutra
: x<sub>1</sub> estas rapida
...
<td>La "ca" aplikas al "mi melbi" - mia estado bela nun estas rapida</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> donas al x<sub>2</sub> ion x<sub>3</sub> por uzo
...
vecnu
: x<sub>1</sub> vendas x<sub>2</sub> al x<sub>3</sub> por prezo x<sub>4</sub>

ciska
: x<sub>1</sub> skribas x<sub>2</sub> sur surfaco x<sub>3</sub> per ilo x<sub>4</sub>
...
zbasu
: x<sub>1</sub> konstruas, faras x<sub>2</sub> el x<sub>3</sub>
...
klama
: x<sub>1</sub> iras al x<sub>2</sub> el x<sub>3</sub> tra x<sub>4</sub> per rimedo x<sub>5</sub>
...
mrilu
: x<sub>1</sub> poŝtas objekton x<sub>2</sub> al ricevanta adreso x<sub>3</sub> el leterkesto x<sub>4</sub> per transportista reto x<sub>5</sub>

pagbu
: x<sub>1</sub> estas parto de x<sub>2</sub>
...
- **fa** markas la argumenton kiu plenigas la unuan lokon de rilato (x<sub>1</sub>)
- **fe** markas la argumenton kiu plenigas la duan lokon (x<sub>2</sub>)
- **fi** markas la argumenton kiu plenigas la trian lokon (x<sub>3</sub>)
- **fo** markas la argumenton kiu plenigas la kvaran lokon (x<sub>4</sub>)
- **fu** markas la argumenton kiu plenigas la kvinan lokon (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="La persono trinkas el la glaso."></pixra>
...
tugni
: x<sub>1</sub> konsentas kun iu x<sub>2</sub> pri x<sub>3</sub> (propozicio)
...
xamgu
: x<sub>1</sub> estas bona por x<sub>2</sub> laŭ x<sub>3</sub>

cuxna
: x<sub>1</sub> elektas x<sub>2</sub> el inter x<sub>3</sub>

zgike
: x<sub>1</sub> estas muziko
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (Mi donas la pomon al vi)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> ne specifita, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (io estas bona por mi laŭ muziko)</td>
</tr></tbody></table>
...
> _Mi deziras ke estu almenaŭ io bongusta por ke mi manĝu ĝin._
> _Mi deziras por io esti tia ke mi manĝas ĝin._
...
> _Estas almenaŭ io bongusta: mi deziras ke mi manĝu ĝin, mi volas manĝi ĝin._
> _Estas io bongusta kiun mi deziras manĝi._
...
tavla
: x<sub>1</sub> parolas al iu x<sub>2</sub> pri temo x<sub>3</sub>
...
djuno
: x<sub>1</sub> scias x<sub>2</sub> (fakto) pri x<sub>3</sub>
...
<td>Ekzistas iu scianta (<b>da</b>) tia ke mi volas la okazaĵon ke ili helpas min; <b>da</b> estas la sama persono en la prenekso kaj ene de <b>le nu</b></td>
</tr></tbody></table>
...
Kiam frazo bezonas duan aŭ trian apartan variablon, la lojbana lingvo uzas **de** kaj **di** post **da** (vidu ankaŭ ["Grupado de kvantiziloj" en la CLL](/en/books/cll/16/#section-quantifier-grouping)):

da
: pronomo: unua variablo (kiel logika _X_).

de
: pronomo: dua variablo (kiel logika _Y_).

di
: pronomo: tria variablo (kiel logika _Z_).

> **da de zo'u mi djica le nu da tavla de**
> _Ekzistas iu kaj alia persono tia ke mi deziras, ke la unua parolis al la dua (**da** kaj **de** referencas tiujn du homojn en la prenekso kaj ene de **le nu**)._
...
zmadu
: x<sub>1</sub> superas x<sub>2</sub> en eco x<sub>3</sub>

mlatu
: x<sub>1</sub> estas kato
...
<td>Unue: du personoj (al kiuj ni referencas per variabloj) ĉiu superas unu personon; la superata persono povas malsami por ĉiu el la du, aŭ esti la sama. Due: ĉiu el du <b>le prenu</b> superas unu <b>le prenu</b>; ĉiu <b>le prenu</b> povas elekti novan referencaĵon, tial la paroj ne bezonas kongrui (komparu <a href="#scope">Amplekso</a>)</td>
</tr>
<tr>
...
ralte
: x<sub>1</sub> tenas x<sub>2</sub> en sia posedo
...
ponse
: x<sub>1</sub> posedas x<sub>2</sub>

#### Tasko

mamta
: x<sub>1</sub> estas patrino de x<sub>2</sub>
...
ponse
: x<sub>1</sub> laŭleĝe posedas x<sub>2</sub>
...
<tr>
<td><i>Mia amiko havas du infanojn</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Tri personoj parolas ĉiu al du infanoj."></pixra>
...
Por igi la amplekson egala, ni uzas specialan konjunkcion **ce'e** konektantan du termojn. Terminoj kunigitaj per **ce'e** estas komprenataj kiel havantaj *egalan amplekson*: ili agas kiel *kunuloj* por tio, kio sekvas.
...
**mo'u** signifas ke evento atingis sian naturan finon (natura kompletigo). Kiu evento? La evento **co'a speni** — iĝi edziĝinta. Tial, **mi mo'u co'a speni** signifas _Mi finas la procezon de iĝi edziĝinta_, t.e., _Mi estas freŝ-edzigita._
...
> _Okazis antaŭe ke mi iros al la monto._
> `Mi en pasinto: en futuro: iras al la monto.`

> **mi ba pu klama le cmana**
> _Okazos poste ke mi iris al la monto._
...
tavla
: x<sub>1</sub> parolas al x<sub>2</sub> pri x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Ĉi tie, ĉio estas stranga."></pixra>
...
stati
: x<sub>1</sub> estas saĝa/lerta

jundi
: x<sub>1</sub> estas atenta al x<sub>2</sub>

zvati
: x<sub>1</sub> ĉeestas ĉe x<sub>2</sub>
...
danlu
: x<sub>1</sub> estas mamulo

morsi
: x<sub>1</sub> estas morta
...
mupli
: x<sub>1</sub> estas ekzemplo de x<sub>2</sub> (eco) inter x<sub>3</sub> (aro)
...
mupli
: x<sub>1</sub> estas ekzemplo de x<sub>2</sub> inter x<sub>3</sub>
...
> _La personoj ĉirkaŭis la tablon._
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="La personoj ĉirkaŭis la tablon."></pixra>
...
smaji
: x<sub>1</sub> estas silenta

> **le since cu sruri le garna**
> _La serpentoj ĉirkaŭis la vergon._
> _Ĉiu el la serpentoj ĉirkaŭis la vergon._
...
> _La serpentoj ĉirkaŭis la vergon._
> _La serpentoj kune kiel maso ĉirkaŭis la vergon._

— ĉi tie, ni ne zorgas pri individuaj serpentoj, sed ni konstatas ke la serpentoj kiel maso kolektive ĉirkaŭis la vergon.

<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="La serpento ĉirkaŭis la personon."></pixra>
...
gunma
: x<sub>1</sub> estas maso formita el komponantoj x<sub>2</sub>
...
grake
: x<sub>1</sub> pezas x<sub>2</sub> (numero) gramojn
