...
dirgo
: x<sub>1</sub> estas guto de materialo x<sub>2</sub> …
...
plise
: x<sub>1</sub> estas pomo

fusra
: x<sub>1</sub> putriĝas aŭ malboniĝas kun aganto x<sub>2</sub>
...
valsi
: x<sub>1</sub> estas vorto kun la signifo x<sub>2</sub> en la lingvo x<sub>3</sub>
