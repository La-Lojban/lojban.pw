...
melbi
: x<sub>1</sub> estas bela / ĉarma / bela al iu x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> estas ĉambro por celo x<sub>2</sub> (propozicio)
...
Ĉi tie, **le se go'i** referencas al la dua loko (x<sub>2</sub>) de la antaŭa rilato, kiu estas **le nanmu**.
...
tcika
: x<sub>1</sub> (horoj, minutoj, sekundoj) estas la tempo de evento x<sub>2</sub>
...
detri
: x<sub>1</sub> (jaro, monato, tago) estas la dato/tempo de evento x<sub>2</sub>
...
nanca
: x<sub>1</sub> havas daŭron de x<sub>2</sub> (nombro) jaroj
...
masti
: x<sub>1</sub> estas x<sub>2</sub> monatoj longa

> **le nu carvi cu djedi li ci**
> _Pluvas dum tri tagoj._

djedi
: x<sub>1</sub> (evento) estas x<sub>2</sub> (nombro) plenaj tagoj longa
...
glare = x<sub>1</sub> estas varmega/varma
...
nabmi
: x<sub>1</sub> estas problemo al x<sub>2</sub>

se nabmi
: x<sub>1</sub> havas problemon x<sub>2</sub>

laldo
: x<sub>1</sub> estas maljuna …

certu
: x<sub>1</sub> estas fako, profesiulo en propraĵo x<sub>2</sub>
