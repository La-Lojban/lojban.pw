...
- **Cmavo by selma’o:** use [jbovlaste](https://jbovlaste.lojban.org/) or the narrative [Chapter 20](/en/books/friendly-cll/20/) catalogue below for “what is this cmavo class?”.
...
**bu'a** vs **broda:** [Chapter 5](/en/books/friendly-cll/5/) uses **broda**, **brode**, … as informal “slot-filler” brivla in examples. For **bound** predicate variables in a prenex, use **bu'a**/**bu'e**/**bu'i** (selma'o GOhA), not **broda**.

---

### A few more notes on variables

**Subscripts:** If you need more than three sumti variables or three selbri variables, add a **xi** subscript — **da xi vo**, **bu'a xi re** — each (cmavo + subscript) pair is a fresh binding ([Chapter 18](/en/books/friendly-cll/18/) for **xi** notation).
