...
- **Parser tools:** [camxes](https://lojban.github.io/cll/), [ilmentufa](https://lojban.github.io/ilmentufa/), and other community parsers accept a Lojban string and return its parse tree or an error — the fastest way to check a tricky sentence.
- **_cmavo_ by selmaʼo:** [Chapter 20](/en/books/friendly-cll/20/) of this book catalogues every selmaʼo with examples; [jbovlaste](https://jbovlaste.lojban.org/) lists individual _cmavo_.
- **Abbreviated EBNF for key rules** — the table below gives the handful of non-terminals that most affect learners.

| Rule | What it generates | Key _cmavo_ classes |
|------|------------------|---------------------|
| `text` | A full Lojban utterance | `I`, `NIhO`, `NO'I` |
| `sentence` | One _bridi_ or question | `I` (sentence separator) |
| `bridi_tail` | _selbri_ + trailing _sumti_ | `CU`, `VAU` |
| `selbri` | The predicate (may be a _tanru_) | `CO`, `KE`/`KEhE` |
...
| `prenex` | Bound variables before _bridi_ | `DA`, `GOhA` + `ZO'U` |
