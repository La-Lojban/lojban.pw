...
**jai** + modal tag is the fuller form: **tu'a le plise** ≈ **jai nu le plise** informally — but **tu'a** is the standard sumti-qualifier form.

**lo'i'e** — "a thing which is a member of the set"
: Rarely needed, but useful when explicitly drawing something *out* of a set.
...
- **tu'a** = something related to (vague sumti-raiser)
