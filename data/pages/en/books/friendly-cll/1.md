...
- **Internal links** use the form [Chapter *n*](/en/books/friendly-cll/*n*/). Pointers into *The Complete Lojban Language* use this site’s [CLL](/en/books/cll/) reader (same book, section anchors such as `#section-…`).
...
- Examples: **bold** Lojban, _italic_ gloss; CLL cross-links via [/en/books/cll/](/en/books/cll/); elision is normal in learner text; examples are sourced from CLL/corpus, never invented
