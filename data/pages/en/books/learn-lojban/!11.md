...
* uniqueness
  > $\exists ! x\,(x^2=0)$
  > There exists a unique value for the varialble $x$ such that for this value the expression $x^2+1=2x$ is true.
  > pa da zo'u li no du lo tenfa be nu'i da li re
  > There is just one $x$ such that $0$ is equal to the exponential result of $x$ to power $2$.
  > ro da ro de zo'u du go da de gi li no lo tenfa be nu'i ge da li re gi de li re
