...
<td><i>I want you to eat the GLC's apples.</i></td>
</tr>
<tr>
<td><b>ty.ny. melbi</b></td>
<td><i>TN is beautiful.</i></td>
</tr>
<tr>
...
<table>
<tbody><tr>
<td><i>ABC is beautiful.</i></td>
<td><b>.abu by. cy. melbi</b></td>
</tr>
<tr>
<td><i>I like the musician DP.</i></td>
<td><b>mi nelci dy.py.</b></td>
</tr></tbody></table>

#### Task

Write shorter variants of the text using letter names to refer to the previous arguments:
...
<td><i>We (not including you) go to the market.</i></td>
</tr>
<tr>
<td><b>ma'a penmi ti</b></td>
<td><i>We all (including you) meet here.</i></td>
</tr>
<tr>
<td><b>mi'o gleki</b></td>
<td><i>You and I are happy.</i></td>
</tr></tbody></table>
...
melbi
: x<sub>1</sub> is beautiful / pretty / handsome to someone x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> is a room for purpose x<sub>2</sub> (proposition)
...
lumci
: x<sub>1</sub> washes x<sub>2</sub>
...
Close the right part of the table. Translate the sentences on the left from Lojban using "he/she" in appropriate places:

<table>
<tbody><tr>
<td><b>mi tavla le ninmu .i ri jundi</b></td>
<td><i>I talk to the woman. She is attentive.</i></td>
</tr>
<tr>
<td><b>la .bob. cu zgana le nanmu .i ri melbi</b></td>
<td><i>Bob observes the man. He is beautiful.</i></td>
</tr></tbody></table>
...
Here, **le se go'i** refers to the second place (x<sub>2</sub>) of the preceding relation, which is **le nanmu**.
...
<td><i>I see the person. The person is beautiful.</i></td>
</tr>
<tr>
<td><b>la .tom. cu tavla le ninmu .i le se go'i cu cisma</b></td>
<td><i>Tom talks to the woman. The woman smiles.</i></td>
</tr></tbody></table>

cisma = x<sub>1</sub> smiles
...
tcika
: x<sub>1</sub> (hours, minutes, seconds) is the time of event x<sub>2</sub>
...
Close the right part of the table. Convert between English time format and Lojban:
...
detri
: x<sub>1</sub> (year, month, day) is the date/time of event x<sub>2</sub>
...
Close the right part of the table. Convert between English date format and Lojban:

<table>
<tbody><tr>
<td><b>li masti bu pa djedi bu re ca detri</b></td>
<td><i>It's January 2nd</i></td>
</tr>
<tr>
<td><i>March 5th, 2024</i></td>
...
nanca
: x<sub>1</sub> is of duration of x<sub>2</sub> (number) years
...
masti
: x<sub>1</sub> is x<sub>2</sub> months long

> **le nu carvi cu djedi li ci**
> _It's raining for three days._

djedi
: x<sub>1</sub> (event) is x<sub>2</sub> (number) full days long
...
<td><i>The child is three years old</i></td>
</tr>
<tr>
<td><b>mi djica le nu mi masti ti li re</b></td>
<td><i>I want to spend two months here</i></td>
</tr></tbody></table>
...
Complete the scale using appropriate scalar particles:
...
nabmi
: x<sub>1</sub> is a problem to x<sub>2</sub>

se nabmi
: x<sub>1</sub> has a problem x<sub>2</sub>

laldo
: x<sub>1</sub> is old …

certu
: x<sub>1</sub> is an expert, professional in property x<sub>2</sub>
...
<td><i>I win because I work</i></td>
</tr>
<tr>
<td><b>mi jinga to'e ki'u nai le nu mi pilno lo laldo</b></td>
<td><i>I win despite using old tools</i></td>
</tr></tbody></table>