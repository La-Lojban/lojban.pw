...
melbi
: x₁ is beautiful / pretty / handsome to someone x₂
...
sledi'u
: x₁ is a room for purpose x₂ (proposition)
...
Here, **le se go'i** refers to the second place (x₂) of the preceding relation, which is **le nanmu**.
...
tcika
: x₁ (hours, minutes, seconds) is the time of event x₂
...
detri
: x₁ (year, month, day) is the date/time of event x₂
...
nanca
: x₁ is of duration of x₂ (number) years
...
djedi
: x₁ (event) is x₂ (number) full days long
...
certu
: x₁ is an expert, professional in property x₂
