...
pa moi
: x<sub>1</sub> is first among x<sub>2</sub> (set)

re moi
: x<sub>1</sub> is second among x<sub>2</sub> (set)

ci moi
: x<sub>1</sub> is third among x<sub>2</sub> (set)

…

ro moi
: x<sub>1</sub> is last among x<sub>2</sub> (set)
...
muvdu
: x<sub>1</sub> moves to x<sub>2</sub> from x<sub>3</sub> via x<sub>4</sub>

jai gau muvdu fai le karce
: x<sub>1</sub> moves the car to x<sub>2</sub> from x<sub>3</sub> via x<sub>4</sub>
...
fengu
: x<sub>1</sub> is angry at x<sub>2</sub> (clause) for action x<sub>3</sub> (property of x<sub>2</sub>)
...
rupnusudu
: x<sub>1</sub> costs x<sub>2</sub> (number) US dollars
...
denpa
: x<sub>1</sub> waits for x<sub>2</sub> (event)…
...
<td><b>fau da'i ro da ta du la .djon.</b></td>
</tr>
</tbody>
</table>
...
pacna
: x<sub>1</sub> hopes for x<sub>2</sub> (possible event) with likelihood x<sub>3</sub> (number, by default **li so'a** i.e. close to 1)
...
kanpe
: x<sub>1</sub> expects x<sub>2</sub> (possible event) with expected likelihood x<sub>3</sub> (a number from 0 till 1, the default value is **li so'a**, i.e. near 1)
...
cumki
: x<sub>1</sub> (possible event) is possible, x<sub>1</sub> may, might occur, x<sub>1</sub> is a maybe.
...
lakne
: x<sub>1</sub> (possible event) is probable, likely
...
djica
: x<sub>1</sub> wants x<sub>2</sub> (possible event)
...
te mukti
: x<sub>1</sub> is motivated to bring about goal x<sub>2</sub> (possible event) by motive x<sub>3</sub> (event)
...
kakne
: x<sub>1</sub> can, is able to do x<sub>2</sub> (property of x<sub>1</sub>)

x<sub>2</sub> describes a possible event.

> **mi nitcu le nu mi sipna**
> _I need to sleep._

nitcu
: x<sub>1</sub> needs x<sub>2</sub> (possible event)

> **mi bilga le ka gunka**
> _I must work. I am obliged to work._

bilga
: x<sub>1</sub> must, is obliged to do x<sub>2</sub> (property of x<sub>1</sub>)

> **mi curmi le nu do citka ti**
> _I allow you to eat this._

curmi
: x<sub>1</sub> allows/permits x<sub>2</sub> (possible event)
...
tolcru
: x<sub>1</sub> forbids/prohibits x<sub>2</sub> (possible event)

> **xu do stidi le ka sipna kei mi**
> _Do you suggest that I sleep?_

stidi
: x<sub>1</sub> inspires x<sub>2</sub> (possible action) in actor x<sub>3</sub>
...
senpi
: x<sub>1</sub> doubts that x<sub>2</sub> (proposition) is true
...
> **se xanri**
> _x<sub>1</sub> imagines x<sub>2</sub> (possible event)_

<!-- -->

> **xanri**
> _x<sub>1</sub> (possible event) is imagined by x<sub>2</sub>_
