...
Dictionaries can present definitions of relation words with symbols such as x<sub>1</sub>, x<sub>2</sub> etc.:

prami
: x<sub>1</sub> loves x<sub>2</sub>

karce
: x<sub>1</sub> is a car …

citka
: x<sub>1</sub> eats x<sub>2</sub> …

klama
: x<sub>1</sub> comes to x<sub>2</sub> …

These x<sub>1</sub>, x<sub>2</sub>, and so on is the explicit notation for the so called _slots_ (other names are: _places_, _roles of relation_, **terbricmi** in Lojban). Slots are filled by argument terms (**sumti**) in the sentence.
...
- x<sub>1</sub> denotes _the one who loves_, and
- x<sub>2</sub> denotes _the one who is loved by_.

In other words, each relation has one or more slots, and those slots are specified and labeled as x<sub>1</sub>, x<sub>2</sub>, and so on. We put arguments like **mi**, **do**, **le tavla** etc. in order, thus filling these slots and giving a concrete meaning to the relation, thus forming a sentence.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… is a mountain"></pixra>
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> comes to x<sub>2</sub> from x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> loves x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> is a car</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>x<sub>1</sub> eats x<sub>2</sub></td>
</tr></tbody></table>
...
pinxe
: x<sub>1</sub> drinks x<sub>2</sub> from x<sub>3</sub>
...
plicru
: x<sub>1</sub> gives, donates to x<sub>2</sub> some object x<sub>3</sub>; x<sub>1</sub> allows someone x<sub>2</sub> to use x<sub>3</sub>

#### Task

zgana
: x<sub>1</sub> observes/notices x<sub>2</sub> using senses x<sub>3</sub>
...
<td><i>I give to you the apple.</i></td>
</tr></tbody></table>
...
<tr>
<td><i>I give to the child the apple.</i></td>
...
- **mi** as x<sub>1</sub>, the first place of the relation,
...
- **mi** as x<sub>1</sub>, the first place of the relation inside the term
...
tavla
: x<sub>1</sub> talks to x<sub>2</sub> …

melbi
: x<sub>1</sub> is beautiful, pretty to x<sub>2</sub> …
...
nandu
: x<sub>1</sub> is hard to x<sub>2</sub>

tilju
: x<sub>1</sub> is heavy
...
klama
: x<sub>1</sub> comes to x<sub>2</sub> from x<sub>3</sub>
...
<td>Uses core arguments (x<sub>2</sub> and x<sub>3</sub> of klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Uses core argument (x<sub>2</sub> = le zarci) and modal term (ca le nu do pinxe)</td>
</tr>
<tr>
...
1. The first place is often the person or thing that does something or is something:
   ...
   **klama** = _x<sub>1</sub> goes …_

2. The object of some action is usually just after the first place:

   **punji** = _x<sub>1</sub> puts x<sub>2</sub> on x<sub>3</sub>_,
...
4. Destination (_to_) places nearly always come before origin (_from_) places:
   ...
   **klama** = _x<sub>1</sub> goes to x<sub>2</sub> from x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="The person goes out of the shop."></pixra>
...
benji
: x<sub>1</sub> transfers x<sub>2</sub> to x<sub>3</sub> from x<sub>4</sub>

lebna
: x<sub>1</sub> takes x<sub>2</sub> from x<sub>3</sub>
...
troci
: x<sub>1</sub> tries to do or to be x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> walks

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="The child tries to walk."></pixra>
...
cinmo
: x<sub>1</sub> feels x<sub>2</sub> (ka)

This means that the infinitive in the second slot (x<sub>2</sub>) is applied to some other slot (most likely, the first slot, x<sub>1</sub>). Cases where the infinitive is applied to slots other than x<sub>2</sub> are rare and are explained in dictionaries for corresponding relations or in the case of relation words invented unofficially, can be deduced from common sense by analogy with other similar relation words.

Another example:

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="He/she helps the friend to carry the bags."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _He/she helps the friend to carry the bags._

sidju
: x<sub>1</sub> helps x<sub>2</sub> do x<sub>3</sub> (ka)

The relation word **sidju** requires its third slot to be filled with an infinitive.

bevri
: x<sub>1</sub> carries x<sub>2</sub>
...
zgana
: x<sub>1</sub> observes x<sub>2</sub>

kakne
: x<sub>1</sub> is able to do x<sub>2</sub> (property)
...
djica
: x<sub>1</sub> wants x<sub>2</sub> (event)
...
zekri
: x<sub>1</sub> is a criminal event, x<sub>1</sub> (event) a crime

cumki
: x<sub>1</sub> (event) is possible

Compare:

> **le nu zekri cu cumki**
> `That is criminal is possible.` > _It is possible that something is a crime._
...
stidi
: x<sub>1</sub> suggest action x<sub>2</sub> (property) to x<sub>3</sub>
...
> _I want the sweet food._

tu'a le titla
: something about the sweet food

titla
: … is sweet

<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="The person wants the sweet food."></pixra>
...
However, the Lojban relation word **stidi** requires a property in its x<sub>2</sub> slot. Similarly, **djica** requires an event in its x<sub>2</sub> slot.
...
stidi
: x<sub>1</sub> suggests x<sub>2</sub> (property) to x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="the friend / the friends"></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="The person gives to the friend the utensil."></pixra>
...
ctuca
: x<sub>1</sub> teaches someone x<sub>2</sub> the subject x<sub>3</sub>

cmene
: x<sub>1</sub> is a name of x<sub>2</sub> used by x<sub>3</sub>
...
speni
: x<sub>1</sub> is married to x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="The dog whom I habitually see in the park."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="The tree is big."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="I like these whose smiles pleases me."></pixra>
...
pluka
: x<sub>1</sub> is pleasant to x<sub>2</sub>

zutse
: x<sub>1</sub> sits, is sitting on x<sub>2</sub>
...
birka
: x<sub>1</sub> is an arm of x<sub>2</sub>
...
<td><i>The phone that is beautiful to me is big.</i></td>
</tr>
<tr>
<td><b>le fonxa pe mi cu melbi</b></td>
<td><i>The phone that is mine is beautiful.</i></td>
</tr>
<tr>
<td><b>le pendo be do cu tavla</b></td>
<td><i>The friend of yours talks.</i></td>
</tr>
<tr>
...
<td><i>The beautiful to me phone of the friend of mine is big.</i></td>
</tr></tbody></table>

Close the right part of the table. Translate the sentences on the left to Lojban.

tuple
: x<sub>1</sub> is a leg of x<sub>2</sub>

clani
: x<sub>1</sub> is long, lengthy

cinri
: x<sub>1</sub> (event) is interesting to someone x<sub>2</sub>
...
<table style="table-layout: fixed;">
<tbody><tr>
<td><i>Your legs are long.</i></td>
<td><b>le tuple be do cu clani</b></td>
</tr>
<tr>
<td><i>The book that is mine is interesting.</i></td>
<td><b>le cukta pe mi cu cinri</b></td>
</tr>
<tr>
<td><i>The person related to you is smart.</i></td>
<td><b>le prenu pe do cu stati</b></td>
</tr>
<tr>
<td><i>The friend of yours who is related to Paris is smart.</i></td>
<td><b>le pendo be do be'o pe la .paris. cu stati</b></td>
</tr>
<tr>
<td><i>The beautiful to me phone of my friend is big.</i></td>
<td><b>le pa melbi be mi fonxa pe le pa pendo be mi cu barda</b></td>
</tr></tbody></table>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="I teach / I am a teacher."></pixra>
...
tunba
: x<sub>1</sub> is a sibling of x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="You are my sibling."></pixra>

#### Task

gerku
: x<sub>1</sub> is a dog

badna
: x<sub>1</sub> is a banana

pendo
: x<sub>1</sub> is a friend of x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="What was a desert is now a garden."></pixra>

> **le pu kunti tumla ca purdi**
> _What was a desert is now a garden._

kunti
: x<sub>1</sub> is empty

tumla
: x<sub>1</sub> is a parcel of land
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="The desert was a garden."></pixra>
...
<td>The "ca" applies to "mi melbi" - my being beautiful now is fast</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> gives x<sub>2</sub> something x<sub>3</sub> for use
...
vecnu
: x<sub>1</sub> sells x<sub>2</sub> to x<sub>3</sub> for price x<sub>4</sub>

ciska
: x<sub>1</sub> writes x<sub>2</sub> on surface x<sub>3</sub> with tool x<sub>4</sub>
...
zbasu
: x<sub>1</sub> builds, makes x<sub>2</sub> out of x<sub>3</sub>
...
mrilu
: x<sub>1</sub> mails object x<sub>2</sub> to recipient address x<sub>3</sub> from mailbox x<sub>4</sub> by carrier network x<sub>5</sub>

pagbu
: x<sub>1</sub> is a part of x<sub>2</sub>
...
- **fa** marks the argument that fills the first slot of a relation (x<sub>1</sub>)
- **fe** marks the argument that fills the second slot (x<sub>2</sub>)
- **fi** marks the argument that fills the third slot (x<sub>3</sub>)
- **fo** marks the argument that fills the fourth slot (x<sub>4</sub>)
- **fu** marks the argument that fills the fifth slot (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="The person drinks from the glass."></pixra>
...
tugni
: x<sub>1</sub> agrees with someone x<sub>2</sub> about x<sub>3</sub> (proposition)
...
> _The one who comes from the city is my friend._
...
xamgu
: x<sub>1</sub> is good for x<sub>2</sub> in terms of x<sub>3</sub>

cuxna
: x<sub>1</sub> chooses x<sub>2</sub> from among x<sub>3</sub>

zgike
: x<sub>1</sub> is music
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (I give the apple to you)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> not specified, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (something is good for me in terms of music)</td>
</tr></tbody></table>
...
tavla
: x<sub>1</sub> talks to someone x<sub>2</sub> about topic x<sub>3</sub>
...
djuno
: x<sub>1</sub> knows x<sub>2</sub> (fact) about x<sub>3</sub>
...
<td>There is someone knowledgeable (<b>da</b>) such that I want the event that they help me; <b>da</b> is the same person in the prenex and inside <b>le nu</b></td>
</tr></tbody></table>
...
When a sentence needs a second or third distinct variable, Lojban uses **de** and **di** after **da** (see also [“Grouping of quantifiers” in the CLL](/en/books/cll/16/#section-quantifier-grouping)):

da
: pronoun: first variable (like logical _X_).

de
: pronoun: second variable (like logical _Y_).

di
: pronoun: third variable (like logical _Z_).

> **da de zo'u mi djica le nu da tavla de**
> _There is someone and someone else such that I wish the first talked to the second (**da** and **de** refer to those two people in the prenex and inside **le nu**)._
...
zmadu
: x<sub>1</sub> exceeds x<sub>2</sub> in property x<sub>3</sub>
...
<td>First: two people (whom we refere to with variables) each exceed one person; the person exceeded may differ for each of the two, or be the same. Second: each of two <b>le prenu</b> exceeds one <b>le prenu</b>; each <b>le prenu</b> can pick a new referent, so the pairs need not match (compare <a href="#scope">Scope</a>)</td>
</tr>
<tr>
...
panzi
: x<sub>1</sub> is a child, offspring of x<sub>2</sub>
...
ralte
: x<sub>1</sub> keeps x<sub>2</sub> in their possession
...
ponse
: x<sub>1</sub> owns x<sub>2</sub>

#### Task

mamta
: x<sub>1</sub> is a mother of x<sub>2</sub>

patfu
: x<sub>1</sub> is a father of x<sub>2</sub>

ralte
: x<sub>1</sub> keeps x<sub>2</sub> in their possession

ponse
: x<sub>1</sub> legally owns x<sub>2</sub>
...
<tr>
<td><i>My friend has two children</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Three people each talks to two children."></pixra>
...
To make the scope equal, we use a special conjunction **ce'e** connecting two terms. Terms joined by **ce'e** are understood to have *equal scope*: they act as *peers* for what follows.
...
mo'u
: term: natural completion — the event has reached its natural end
...
**mo'u** means that an event has reached its natural end (natural completion). Which event? The event **co'a speni** — to become married. Hence, **mi mo'u co'a speni** means _I finish the process of becoming married_, i.e., _I am newlywed._
...
tavla
: x<sub>1</sub> talks to x<sub>2</sub> about x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Here, everything is strange."></pixra>
...
stati
: x<sub>1</sub> is smart/clever

jundi
: x<sub>1</sub> is attentive to x<sub>2</sub>

zvati
: x<sub>1</sub> is present at x<sub>2</sub>
...
mupli
: x<sub>1</sub> is an example of x<sub>2</sub> (property) among x<sub>3</sub> (set)
...
mupli
: x<sub>1</sub> is an example of x<sub>2</sub> among x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="The people surrounded the table."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="The snake surrounded the person."></pixra>
...
gunma
: x<sub>1</sub> is a mass formed from components x<sub>2</sub>
...
grake
: x<sub>1</sub> weighs x<sub>2</sub> (number) grams
