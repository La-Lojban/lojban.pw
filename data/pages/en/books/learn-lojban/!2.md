...
These $x_1$, $x_2$, and so on is the explicit notation for the so called _slots_ (other names are: _places_, _roles of relation_, **terbricmi** in Lojban). Slots are filled by argument terms (**sumti**) in the sentence. 
...
<tbody><tr>
<td><b>klama</b></td>
<td>$x_1$ comes to $x_2$ from $x_3$</td>
</tr>
<tr>
<td><b>prami</b></td>
<td>$x_1$ loves $x_2$</td>
...
zgana
: $x_1$ observes/notices $x_2$ using senses $x_3$
...
<td>Uses core arguments ($x_2$ and $x_3$ of klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Uses core argument ($x_2$ = le zarci) and modal term (ca le nu do pinxe)</td>
</tr>
<tr>
...
dunda
: $x_1$ gives $x_2$ to $x_3$
benji
: $x_1$ transfers $x_2$ to $x_3$ from $x_4$
lebna
: $x_1$ takes $x_2$ from $x_3$
...
: $x_1$ observes $x_2$
kakne
: $x_1$ is able to do $x_2$ (property)
nelci
: $x_1$ likes $x_2$
...
stidi
: $x_1$ suggests $x_2$ (property) to $x_3$
...
ctuca
: $x_1$ teaches $x_2$ (subject) to $x_3$
cmene
: $x_1$ is a name of $x_2$ used by $x_3$
...
vecnu
: $x_1$ sells $x_2$ to $x_3$ for price $x_4$
ciska
: $x_1$ writes $x_2$ on surface $x_3$ with tool $x_4$
...
mrilu
: $x_1$ mails $x_2$ to $x_3$ from $x_4$ by carrier $x_5$
pagbu
: $x_1$ is a part of $x_2$
...
: $x_1$ is good for $x_2$
cuxna
: $x_1$ chooses $x_2$ from among $x_3$
...
<td>$x_1$=mi, $x_2$=le plise, $x_3$=do (I give the apple to you)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike xamgu</b></td>
<td>$x_1$ not specified, $x_2$=mi, $x_3$=le zgike (something is good for me in terms of music)</td>
</tr>
<tr>
<td><b>fi le prenu fe le melbi fo le xunre fa mi cuxna</b></td>
<td>$x_1$=mi, $x_2$=le melbi, $x_3$=le prenu, $x_4$=le xunre (I choose the beautiful one from among people out of the red ones)</td>
</tr></tbody></table>
...
: $x_1$ likes $x_2$
zmadu
: $x_1$ exceeds $x_2$ in property $x_3$
mlatu
: $x_1$ is a cat
...
mamta
: $x_1$ is a mother of $x_2$
patfu
: $x_1$ is a father of $x_2$
ralte
: $x_1$ keeps $x_2$ in their possession
ponse
: $x_1$ legally owns $x_2$
...
: $x_1$ is smart/clever
jundi
: $x_1$ is attentive to $x_2$
zvati
: $x_1$ is present at $x_2$
...
: $x_1$ likes $x_2$
mupli
: $x_1$ is an example of $x_2$ among $x_3$
le'e
...
gunma
: $x_1$ is a mass formed from components $x_2$
barda
: $x_1$ is big/large
zvati
: $x_1$ is present at $x_2$
