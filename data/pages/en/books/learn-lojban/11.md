...
vitke
: x<sub>1</sub> (guest) visits x<sub>2</sub> (someone) at x<sub>3</sub>
...
to'e zanru
: … disapproves … (something), … criticizes … (something)
...
jibri
: x<sub>1</sub> is a job of x<sub>2</sub>
...
merko
: x<sub>1</sub> is American (the USA sense)
...
simxu
: members of the set x<sub>1</sub> reciprocally do x<sub>2</sub>

The relation **simxu** takes every possible pair from the set specified in place x<sub>1</sub> and asserts the relation specified within x<sub>2</sub>.
...
cmima
: x<sub>1</sub> is a member of set x<sub>2</sub>
