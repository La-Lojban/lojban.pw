...
tarci
: x<sub>1</sub> is a star

va'i
: interjection: in other words
...
darno
: … is far from … (something)

certu
: … is an expert at … (property)
...
friti
: … offers … (something) to … (recipient)

le kabri
: the cup

jinto
: … is a well, … is a spring (water source)
...
dirgo
: x<sub>1</sub> is a drop of material x<sub>2</sub> …
...
fusra
: x<sub>1</sub> rots or decays with agent x<sub>2</sub>
...
zi'e
: interjection: continuing thought marker
...
valsi
: x<sub>1</sub> is a word with the meaning x<sub>2</sub> in language x<sub>3</sub>
