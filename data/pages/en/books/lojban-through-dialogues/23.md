...
<speaker sprite="koc2">**di'a** means "resuming / going back" — here it's used for returning. Combined with **klama** it gives you "to come back / return."</speaker>

<speaker sprite="sor5">So **di'a klama ti** = "go back here" = "return here." **ti** is just "here"?</speaker>

<speaker sprite="koc5">Yes — **ti** / **ta** / **tu** are spatial demonstratives: here / there / way over there. Same distance scale as **vi** / **va** / **vu** but pointing at objects rather than marking locations.</speaker>
...
<speaker sprite="sor7">**ba le nu vitke kei** — "after visiting." So **ba le nu [clause] kei** is the formula for "after doing something"?</speaker>

<speaker sprite="koc2">Exactly. **le nu** turns a verb into an event-noun; **ba** puts it after that event; **kei** closes the clause cleanly. You'll see this pattern constantly in storytelling.</speaker>
