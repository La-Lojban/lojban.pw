...
<speaker sprite="lif2">Winding down for the night. **sipna** = to sleep; **lerci** = late; **nitcu** = to need; **jibri** = job/occupation; **finti** = to author/program.</speaker>

<speaker sprite="lin8">Finally, the lesson where people admit they need to sleep. Relatable.</speaker>
...
<speaker sprite="lin7">**lo ka finti lo proga** — "the property of creating programs" — used as a noun-phrase for "programming." That's a flexible construction.</speaker>

<speaker sprite="lif5">**lo ka [verb]** turns any verb into a property-noun. "The-being-of programming" = programming. You can use it wherever a noun fits.</speaker>
