...
<speaker sprite="koc2">**pleji** = to pay; **detma'i** = calendar month; **kagni** = company / organization. And a lovely compound: **jo'u** = together with (both participate equally).</speaker>

<speaker sprite="sor4">Monthly electricity bills in Lojban. I feel very adult.</speaker>

<speaker sprite="koc4">Congratulations. You also now know how to form "every X" using **ca ro**.</speaker>
...
<speaker sprite="sor7">**mi jo'u le speni be mi** = "me together with my spouse." Different from **mi joi le speni be mi** which is "me-and-spouse as a single mass entity."</speaker>

<speaker sprite="koc2">Good distinction. **jo'u** = side by side, parallel. **joi** = merged into one unit. For travel companions, **jo'u** is usually right.</speaker>
