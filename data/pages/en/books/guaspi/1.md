...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /vme -crw !kseo ^vu -tum !kfor ^fe -fnau</I><td>The rat devours (violently eats) the cheese with a fork and knife</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /crw !kseo           </I><td>The rat eats the cheese
					(sentence: rat eat cheese) </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /crw !kseo             </I><td>The rat eats the cheese</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>crw !kseo                       </I><td>Eater of cheese</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |va -jiw /vn -sper -jiol</I><td>Hey, a crocodile!</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |qnu !qo -jan /tara /jun !kseo |zey !ju</I><td>John, the rat is after your cheese!</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /fer !se -dowu    </I><td>The rat carries (something) from
					the house</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /vyu !vo -crw !tara   </I><td>The rat likes for the rat to eat</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /vyu !crw              </I><td>The rat likes to eat</table>
...
<tr><td><I>^:i !tara /crw !xi -kseo |vu -xel </I><td>The rat eats smelly cheese
</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !tara /crw !kseo ^ve -tum !vden !xgno</I><td>The rat eats the cheese with its teeth</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |vi -bwy ^tara |va -cul !zu -crw /fi -go -crw !kseo</I><td>But the rat, which was full of food, didn't eat the cheese</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |va -tan /pur -far !tara |zey !ji</I><td>Damn, my rat ran away</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !qo -ben /ga -zu-xim !jw |cil</I><td>Ben is (declared to be) the name of this child</table>
...
<table width="100%"><col width="50%"><col width="50%">
<tr><td><I>^:i |qe -jai !qo -kira /py /zu-zni !cyr -far !ju</I><td>Says Kira, ``Why do you flee?'' (default saved, set)
<tr><td><I>^:i -po -sfa -daw -can -siw -dan !ju</I><td>``Don't you want to be rescued?''  (default inserted automatically)
<tr><td><I>^:i |va -pli ^vi -zu -gre ^jo /kuo !ji</I><td>``Please, at least talk to me!''   (default inserted automatically)
<tr><td><I>^:i |qa -jai ^qo -kira /jun !suy</I><td>Kira pursues the swimmer.  (prior default = narrator)
</table>
...
<TR><TD><I>^:i !do /suy -pne -qmy !kqua</I> <TD>It swims down through the water
<TR><TD><I>!do /suy !kqua + !do /pne !kqua + !do /qmy !kqua</I>
...
<table width="100%"><col width="50%"><col width="50%">
<tr><td><I>^:i !xo -fkar |xda ^vu -xge /fi -can -tai !qel =fkar</I><td>An old, black car emerged from its garage.
<tr><td><I>^:i !fkar /cyr -vle</I><td>The car turned left.
</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |vi -pli ^jo ^sa -ji /gey !xo -kliw</I><td>Please give me some nails</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |vi -pli ^jo ^sa -ji /gey !xo -beol |fmy ^vu -zu -cu</I><td>Please give me two nuts (female screws)</table>
...
<tr><td><I>bir</I><td><td>Past tense
<tr><td><td><I>^:i !ji /crw !kseo <U>^vu -bir</U> !jun -vnl !tara</I><td>I ate the cheese <em>before</em> the rat came hunting
<tr><td><I>zey</I><td><td>Genitive or possessive case: a relation of pertinence
<tr><td><td><I>-fkar <U>|zey</U> !ji</I><td><em>My</em> car (which I lease and which my brother is now driving)
<tr><td><I>jai</I><td><td>The speaker
<tr><td><td><I>^:i <U>|jai</U> !qo -kira /ju /dwu -csn -zu -jeu</I><td><em>Said</em> Kira, ``You're a monster''
<tr><td><I>plm</I><td><td>Such as: an example
<tr><td><td><I>-xy -pso |psi <U>^vu -plm</U> !xy -kai |kei</I><td>Bad people <em>such as</em> thieves
</table>
...
This cheese is flavor*less*. Some dimensions like \`\`*zao*-flavor'' are quantifiable (more or less) but unsigned, so their degree ranges from zero to larger values. Others like \`\`*gal*-high'' are signed. In either case *\`\`gl''* modifies a predicate so that its degree is zero or negligible.
...
This cheese is *de*solidifying. \`\`*vry*-reverse'' indicates that the process in its X2 case is occuring in the reverse of the usual order.
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i -dae !kara ^:o <U>-bal</U> !crw |jro ^tara ^kseo</I><td>If the box is open <em>then maybe</em> the rat will eat the cheese.</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !xa -ca /plw !co ^cu</I><td>3 is the sum of 1 and 2 (every triplet
					is in the equivalence class of 1+2)</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !ji /vga |kyam !ku -cy</I><td>I weigh 70 kilos (I heavy kilo 7 0)</table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:a |vi-gza ^vu-qe-kam !sa-cil 
   ^qu -jaiw=tiri |va-ga-xim !do /fi-jiw !su-cana-fer ^vi-gau </I><td>&para; Tigereye cries to the children, the barge, look out! </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |faw ^jo /suy !jr</I><td>Swim over here! </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |qi-qnu !qo-qosefo /ve-faw ^jo /qma -duw !gunu !ju</I><td>Josepho, move your ass! </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i -po !ju /daw -scu-zu-crw-zu-ter !fwa-pei !cana-fer</I><td>Do you want to be chewed up by the barge's propeller? </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i |qi-koy !do /va-gri ^ji /gul !qou !jw ^vu-cnu !xa-jl</I><td>Damn, I have to watch them every moment! </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !pu /kau !qai-kar !jw ^jw /vi-faw</I><td>Why can't they take care of themselves? </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:i !ji /suy |swa !dman =co </I><td>I swim for one second... </table>
...
<table width="100%"><col width="50%"><col width="50%"><tr><td><I>^:o -sno !can-zu-vem !jw</I><td>And that's enough for them to get into trouble.</table>
...
- \[Lja\] A modernized version of *Loglan*, much closer to the original *Loglan* than *gua\spi*, is *Lojban*. Information is available from The Logical Languages Group, 2904 Beau Lane, Fairfax, VA 22031, or lojbab@lojban.org. For on-line access, send a message whose body is \`\`index lojban'' to listserv@hebrew.cc.columbia.edu.
