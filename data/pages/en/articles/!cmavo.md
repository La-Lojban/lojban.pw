...
- NU:
  - constructs:
    ...
    - li'i:
      - examples:
        - 1:
          - lojban: mi morji le li'i mi verba
          - translation: I remember the experience-of (my being-a-child)
          - comment: This refers to the speaker's personal experience of being a child, encapsulating all the memories and feelings associated with that period of their life.
    - si'o:
      - type: abstractor
...
- BAI:
  - constructs:
    ...
    - ki'i:
      - type: modal tag
      - source: ckini
      - definition: [sumti] ne ki'i [sumti] = [sumti] that is related to [sumti].
      - examples:
        - 1:
