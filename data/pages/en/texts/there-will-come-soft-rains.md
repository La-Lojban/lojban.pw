...
meta.type: korpora
meta.description: There Will Come Soft Rains - by Sara Teasdale
...
<div class="w-full">
  ...
  <label
    ...
    class="hide-column-button-glico_gi_e_te_fanva_fo_le_lojbo float-left drop-shadow bg-white hover:bg-blue-600 focus:bg-blue-600 text-gray-900 hover:text-white border border-gray-600 font-bold leading-normal select-none py-2 px-4"
