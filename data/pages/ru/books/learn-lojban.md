...
<li><b>ie</b> произносится как <i>ye</i> в слове <i>yes</i></li></ul>
</td></tr>
<tr>
...
На ложбане мы в основном говорим о отношениях, а не о существительных или глаголах.
...
В Ложбане подобное понятие дополнительных ролей выражается с помощью отдельных отношений или, в большинстве случаев, с помощью модальных терминов:
...
Порядок мест в отношениях иногда может быть трудным для запоминания, но не беспокойтесь — вам не нужно запоминать все места всех слов отношений. (Вы помните значение сотен тысяч слов на английском языке?)
...
Инфинитивы - это глаголы, которые часто предшествуют приставке _to_ в английском языке. Примеры включают _I like to run_, где _to run_ является инфинитивом.
...
<pixra url="/assets/pixra/cilre/djica_tuha_le_titla.webp" caption="человек хочет сладкое" definition="Человек хочет сладкое."></pixra>
...
Короткое так называемое квалификаторное слово **tu'a** перед термином подразумевает абстракцию (свойство, событие или предложение), но выбирает только этот термин из этой абстракции, пропуская остальное. Его можно перевести как _что-то о_:

> **mi предлагаю что-то о пабе**
> _Я предлагаю что-то о пабе (возможно, посещение, встреча рядом и т. д.)._

<!-- -->

> **mi хочу что-то связанное с яблоком**
...
> **мне нравится Дорис. Я часто встречаю ее в парке.**
> _I like Doris. I often meet her in the park._

> **мне нравится Дорис. Что еще я могу сказать о ней? Я часто встречаю ее в парке.**
> _I like Doris. What else can I say about her? I often meet her in the park._

zgana
: наблюдать (используя любые чувства)

<pixra url="/assets/pixra/cilre/panka_ninmu.webp" caption="человек, которого я часто вижу в парке" definition="The person whom I habitually see in the park."></pixra>

Удаление относительной клаузы с помощью **noi** сохраняет смысл: _мне нравится Дорис._

В разговорном английском различие часто достигается с помощью интонации или догадкой. Кроме того, относительные клаузы с **noi** традиционно разделяются запятыми в английском языке. В них используются _which_ или _who_, и слово _that_ в них не используется.
...
На самом деле, **le bangu pe mi** - это лучший перевод _мой язык_, так как, подобно английскому, два аргумента связаны друг с другом неопределенным образом.
...
be'o
: правый граничный маркер для строки терминов, присоединенных с помощью **be** и **bei**
...
В английском языке глагол _is, are, to be_ заставляет существительное работать как глагол. В ложбане даже такие понятия, как _кошка_ (**mlatu**), _человек_ (**prenu**), _дом_ (**dinju**), _домашний_ (**zdani**), по умолчанию функционируют как глаголы (отношения). Только местоимения работают как аргументы.
...
**noi du** и **poi du** используются для введения альтернативных имен для чего-то. Они соответствуют английским _то есть, именно_:
...
Как видно из последнего примера, мы даже не можем отразить порядок слов в его английском переводе.
...
Таким образом, нам не нужно использовать глагол "иметь", чтобы обозначать такие отношения. То же самое относится и к другим членам семьи:
...
Правило чтения терминов слева направо может быть нарушено путем соединения модальных частиц с союзом **ce'e**:
...
Конечно, мы можем добавить больше аргументов к отношению с помощью **be** и **bei**, как мы делаем это внутри аргументных терминов:
...
В английском языке есть несколько вопросительных слов _wh-_ - _who_, _what_ и т. д. В ложбане для обоих используется одно слово: **ma**. Это слово является аргументом (как **mi**, **le prenu** и т. д.) и это как предложение заполнить пропущенное место. Например:
...
> **— ми плицру до ма**
> **— ле плисе**
> <span>_— Что я должен тебе дать?_ (вероятно, имеется в виду _Что это я должен был тебе дать?_)</span>
> _— Яблоко._

Для перевода _какой/какая/какое_, мы также используем **ма**:

> **— ма гугде ги'е се хабжу до**
> **— ле гугде'усу**
> _— В какой стране ты живешь?_
> _— США_
> `— Что такое страна и в ней живешь?`
> `— США`
...
**мо** похоже на **ма**, но это слово-отношение.

**мо** предлагает заполнить отношение вместо аргумента. Это как вопрос _Что делает X?_ или _Что такое X?_ на английском (в ложбане вам не нужно различать между бытием и действием).

Мы можем рассматривать **мо** как просьбу описать отношение между аргументами в вопросе.
...
В Lojban глагол **bajra** в предложении означает _Кто-то бежит_ (или _бежал_ / _бежит_, в зависимости от контекста). **bajra** также может означать команду, _Беги! Сделай это, чтобы ты бежал!_, но иногда контекст недостаточен для определения, является ли это призывом к бегу или просто утверждением о том, что кто-то бежит или бежал.
...
> **nelci ko**
> _Сделай так, чтобы тебя кто-то полюбил!_
...
Обратите внимание, что **prami** соответствует английскому _to love_, а **nelci** соответствует английскому _to like_.
...
Почему некоторые ячейки с междометиями с **cu'i** и **nai** пусты? Потому что в английском языке нет кратких способов выражения таких эмоций.
...
<pixra url="/assets/pixra/cilre/tadni.webp" caption="я учусь" definition="I study."></pixra>

 > **я сломал свой компьютер.**
 > _I made it so that my computer got broken._
 >
- <dl><dt>утверждать, что …</dt><dd>assert that …</dd></dl>

 > **ты утверждаешь, что я не прав?**
 > _Do you state that I am not right?_
 >
- <dl><dt>ожидать, что …</dt><dd>expect (in the sense of assessment, prediction) that …</dd></dl>

 <!-- -->

 > **я не ожидаю, что я победю.**
...
>_How are you?_
<!-- -->
> **я здоров. Я сейчас учу Ложбан. Я пытаюсь с тобой поговорить.**
...
> **хорошо. Какая будет погода завтра?**
...
> **я не знаю. Будет солнечно, надеюсь.**
...
Обратите внимание, что **солнце — это погода** (буквально _the sun is the weather_) — так используется **погода** в Ложбане.
...
эй
: обращение, привлекающее внимание: _Hey! Psst! Ага! Внимание!_
...
На английском мы говорим _Can you see_, на Ложбане мы говорим просто **ты видишь** — _You see?_
...
> **виска .i le плисе ку барда**
> _Да. Яблоко большое._

> **xu ты думаешь, что le плисе ca makcu**
> _Ты думаешь, что яблоко созрело?_

makcu
: ...созрело

> **.au mi хочу потрогать его**
> _Я хотел бы его ощупать._

> **.и уа, оно гладкое**
> _О, оно гладкое._

> **.и я надеюсь, что оно созрело, да**
> _Я надеюсь, что оно созрело, да._

> **панци пэй**
> _А как насчет запаха?_

> **.и, пожалуйста, понюхай плисе**
> _Пожалуйста, понюхай его._

> **le xrula cu panci**
> _Он пахнет цветами._

> **.и .au mi хочу попробовать плисе**
...
> **боль. я чувствую боль в колене**
> _Yes, I feel pain in the knee._

> **.и нет, это не опасно**
> _It's not dangerous._

> **.и сейчас я чувствую присутствие кого-то здесь**
> _And now I can sense a presence of someone here._

> **Алиса, пожалуйста, вернись немедленно!**
...
> **я слышал, как человек говорил**
> _I heard a person talking._

> **.и сейчас я чувствую холод**
> _Now I feel cold._

> **Эй, Алиса!..**
> _Hey, Alice!.._

В этом диалоге были затронуты наиболее важные понятия для человеческих чувств. В следующих разделах мы объясним их структуры местоимений, а также дополнительные отношения и примеры.
...
> _mi steba le nu le bruna be mi co'a speni le ninmu_
...
> _mi se cfipu_
> _xu do na ku gleki le nu le bruna co'a speni_
...
> _le ninmu cu pindi_
> _le ninmu na ku ponse le jdini_
> _mi na ku kakne le ka ciksi_
...
> **ты болен вирусом? Я предлагаю тебе пойти к врачу.**
...
> _У меня болит горло. Я думаю, что у меня простуда._
...
Обратите внимание, что второе место **болен** описывает симптомы, такие как **болит горло** = _иметь боль в горле_. Третье место указывает на название болезни, вызывающей эти симптомы. Очевидно, вы можете пропустить заполнение этих мест **болен**.
...
Некоторые модальные термины, такие как те, которые описывают время (временную форму), связывают текущее отношение с тем, которое следует после них:
...
se rai
: термин из **se traji**: быть самым в …
...
я предпочитаю
: термин **предпочитать**: предпочитая ...
...
Словарь объясняет такие сложные случаи, когда отношение, определенное термином, может вызывать затруднения. На практике отношение часто ясно из приведенных примеров. -->

### Использование «**не**» + термин. «**се больше**» — ‘_больше, чем …_’

**я не се больше тебя красивая**
_Я красивее тебя._

се больше
: термин из **больше**: больше, чем; само отношение описывает сравнение

Этот пример похож на

> **я больше тебя в красоте**
> _Я превосхожу тебя в красоте._

Другими словами, основное отношение **красивая** подобно третьему месту **больше**, который определяет критерии сравнения. Еще два примера:
...
- Модальный термин изменяет отношение справа от него:
  ...
  — здесь после термина идет аргумент.
...
- Модальный термин применяется ко всему отношению:
  ...
  — здесь модальный термин находится в конце отношения.

### Соединение высказываний с модальными терминами
...
- Для таких терминов, как _любой_ и _где-нибудь_:
...
Область действия модального термина распространяется от его использования до правого отношения, пока отношение и все его внутренние отношения (если они есть) не закончатся.
...
## Урок 6: модальные термины: время и пространство
...
Модальный термин времени с последующим аргументом описывает событие относительно события в этом аргументе:
...
ze'a
: модальный термин: в течение некоторого времени

ve'a
: модальный термин: на протяжении некоторого пространства

ze'u
: модальный термин: в течение длительного времени

ve'u
: модальный термин: на протяжении длительного пространства
...
Вот несколько наборов модальных терминов, которые могут помочь нам добавить более точные значения, когда это необходимо.
...
ba'o
: модальный термин: перестать делать что-то, уже сделать что-то (событие завершилось)
...
Этот метод может быть более удобным, чем английские _he_ или _she_, или даже ложбанские **ri** или **ra**. Он позволяет сделать речь более краткой, но точной, не повторяя потенциально длинные имена или другие термины аргументов.
...
Термины, такие как **na ku**, **pu**, отрицатели слева, такие как **na'e**, **no'e**, **to'e**, являются частями отношений.
...
### Сложные модальные термины: «_потому что_» — «**ki'u**», «_несмотря на_» — «**to'e ki'u nai**»

Модальные термины могут быть отрицательными двумя способами, чтобы получить связанные значения.

ki'u
: модальный термин: потому что, из-за объяснения ..., что можно объяснить фактом, что ...
...
ki'u nai
: модальный термин: не потому что, что нельзя объяснить фактом, что ...
...
ca'a
: термин потенциала: фактически есть
...
Термин **гау** указывает на агента события:
...
**gau**:
- модальный термин: вызвано ... (агентом), движимо ... (кем-то, чем-то)

**kalri**:
- $x_1$ открыто

Таким образом, глаголы вроде _открыть что-то_ и _переместить что-то_ можно перефразировать как _сделать что-то открытым_ и _сделать что-то движущимся_. Поэтому нам не нужно изучать дополнительные глаголы для каждого такого значения. Вместо этого мы всегда добавляем термин **gau**.
...
**se ni'i**
: модальный термин: с логическим следствием ..., логически поэтому
...
Отношения с **da'i** могут включать термин **fau**:
...
**gi'e** соединяет несколько отношений в одно с некоторыми общими терминами. Посмотрите: Он расширяется в **pu ku mi kelci la .soker. i je pu ku mi klama le zdani** ... что было бы длиннее.

С помощью **gi'e** мы сохраняем голову отношения постоянной и указываем термины после каждой конструкции отношения (**kelci la .soker.**, **klama le zdani** ...).
...
Обратите внимание, что времена как термины и времена, присоединенные к основному отношению отношения, имеют разницу при применении к предложениям, содержащим несколько присоединенных отношений:
...
**zo .bob.** - это слово, в то время как **la .bob.** - это то, что названо этим словом. Краткие квалификаторы **la'e** и **lu'e**, расположенные перед терминами, преобразуют ссылки и их объекты в обе стороны:
...
Все, что выражено в тексте, также должно быть выражено в речи и наоборот. Поэтому не может быть никакой пунктуации, которая не произносится. Это означает, что в лоджбане есть широкий спектр слов для цитирования других слов. Все лоджбан преобразуют текст в аргументный термин.
...
Используя **be**, вы можете заполнить не только слоты отношений, но также добавить модальные термины:
...
Без **be**, термин **de'i li vo** применялся бы ко всему отношению, а не к **xatra**. Мы хотим сказать, что первая дата относится только к письму, а вторая дата относится к отправке письма. Это означает, что в **le xatra be de'i li vo** часть **de'i li vo** (_4-е число, как дата_) применяется только к аргументу **le xatra**, а не ко всему предложению.

### Подробности о составных отношениях

Группировка терминов в грамматике Ложбана особенно важна, когда речь идет о танру (составных отношениях). Способ, которым отношения группируются в танру, определяет его значение. Например,
...
**ku'o** может быть опущено здесь, когда относительное предложение, которое нам нужно (**mi zgana ke'a**), заканчивается термином, в данном случае **ke'a**. После относительного предложения начинается что-то другое, кроме термина, поэтому относительное предложение не может продолжаться, и мы знаем, что оно успешно заканчивается без явных слов-ограничителей справа.
