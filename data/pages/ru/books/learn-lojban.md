...
flowchart LR
    ...
    %%  semi-automated
    subgraph head-terms["<i>термины головы</i>#nbsp;"]
        t1
        t2
    end
    subgraph tail-terms["<i>термины хвоста</i>#nbsp;"]
        tt3
        %% tt4
    end
...
Термины в ложбане, независимо от того, где они используются в конкретном предложении, в основном представлены:
...
Более простое предложение на ложбан содержит только одно основное слово отношения:
...
не указывает количество людей, говорящих со мной. На английском невозможно опустить число, потому что _people_ в английском подразумевает _более одного человека_. Однако на ложбан вы можете опустить число, даже если оно во множественном числе.
