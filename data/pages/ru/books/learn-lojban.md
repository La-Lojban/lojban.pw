...
Буквы произносятся так, как они написаны.
...
<td> как в слове <i>ch<u>o</u>ice</i>, <i>n<u>o</u>t</i> или <i>ough</i> в слове <i>th<u>ough</u>t</i> (не как в слове <i>so</i>, <b>o</b> должно быть "чистым" звуком).</td>
</tr>
<tr>
...
<td> как в слове <i>comm<u>a</u></i> (не как в словах <i>misty</i> или <i>cycle</i>)</td>
</tr>
<tr>
</tbody></table>
...
html
<td>как <i>ch</i> в шотландском <i>loch</i> или как в немецком <i>Bach</i>, как <i>J</i> в испанском <i>Jose</i> или <i>Kh</i> в современном арабском <i>Khaled</i>. Попробуйте произнести <i>ksss</i>, не поднимая язык, и вы получите этот звук.
</td></tr>
<tr>
<td><span class="audio-inline"><b class="guibutton"> ' </b></span>
</td>
<td>как английская <i>h</i>. Таким образом, апостроф считается правильной буквой ложбана и произносится как <i>h</i>. Он может находиться только между гласными. Например, <b>u'i</b> произносится как <i>oo-hee</i> (в то время как <b>ui</b> произносится как <i>wee</i>).
</td></tr>
<tr>
<td><span class="audio-inline"><b>.</b></span>
</td>
<td>точка (период, разрыв слова) также считается буквой в ложбане. Это короткая пауза в речи, чтобы остановить слова, бегущие друг в друга. Фактически, перед любым словом, начинающимся с гласной, ставится точка. Это помогает предотвратить нежелательное слияние двух последовательных слов в одно.
</td></tr>
<tr>
...
<ul><li><b>ia</b> произносится как <i>ya</i> в <i>yard</i></li>
<li><b>ie</b> произносится как <i>ye</i> в <i>yes</i></li></ul>
</td></tr>
<tr>
...
<ul><li><b>ua</b> произносится как <i>wo</i> в <i>wow</i></li>
<li><b>ue</b> произносится как <i>whe</i> в <i>when</i></li></ul>
</td></tr></tbody></table>

Ударение ставится на предпоследний гласный. Если слово имеет только один гласный, то его просто не ударяют.

Буква **r** может произноситься как _r_ в английском, шотландском, русском, так что есть диапазон приемлемых произношений для нее.

Неложбанские гласные, такие как короткий _i_ и _u_ в стандартном британском английском _hit_ и _but_, используются некоторыми людьми для разделения согласных. Так что, если у вас возникли проблемы с произношением двух согласных подряд (например, **vl** в **tavla**, что означает _говорить_), то вы можете сказать _tavɪla_ - где _ɪ_ очень короткий. Однако другие гласные, такие как **a** и **u**, должны быть длинными.
...
- голова:
  - состоит из так называемых "терминов",
  - **le prenu** является единственным термином головы в примере **le prenu cu tavla mi** выше,
  - **mi**, **ca** являются терминами головы в примере **mi ca cu tavla do** выше.
...
- хвост:
  - основное отношение (**tavla**, **prami**) с возможно одним или несколькими терминами после него,
  - **mi** является единственным термином хвоста в примере **le prenu cu tavla mi** выше.
  - **do** является единственным термином хвоста в примере **mi ca cu tavla do** выше.
...
<pixra url="/assets/pixra/cilre/mi.svg" caption="mi" definition="Я / мне"></pixra>

<pixra url="/assets/pixra/cilre/mi_prami_do2.svg" caption="mi prami do" definition="Я люблю тебя."></pixra>

<pixra url="/assets/pixra/cilre/do.svg" caption="do" definition="ты"></pixra>

На Ложбане мы в основном говорим о отношениях, а не о существительных и глаголах.
...
Мы также можем сказать, что **le** создает существительное из конструкции отношения с примерным значением _тот, который …_ (_человек_ — _человек_), или даже _те, кто делают…_ (_говорить с_ — _говорящие_), _те, кто являются…_ (_люди_ — _люди_).

Обратите внимание, что Lojban по умолчанию не различает _говорящего_ или _говорящих_. То есть **le tavla** неопределен в этом отношении, и мы скоро обнаружим способы определения числа.

Термины на Lojban, независимо от того, где они используются в данном предложении, в основном представлены:
...
- модальными терминами, такими как **ca** (_сейчас, в настоящее время_). Модальные термины указывают дополнительную, уточняющую информацию.
...
nintadni
: … новый студент, новичок

<pixra url="/assets/pixra/cilre/nintadni.svg" caption="mi nintadni" definition="Я новый студент, новичок."></pixra>

В отличие от английского языка, нам не нужно добавлять глагол "am/is/are/to be" в предложение. Он уже там. Слово отношения **nintadni** (_… новый студент_) уже имеет встроенный в свой перевод на английский язык этот английский "am/is/are/to be".
...
Более простое предложение на Lojban содержит только одно основное слово отношения:
...
Вы можете сказать это, когда видите приближающуюся машину. Здесь контекст будет достаточно ясен, что где-то есть машина, и, вероятно, это опасно.

**karce** сам по себе является глаголом, означающим _машина, быть машиной_.
...
Обратите внимание, что в Ложбане нет необходимости в слове _it_ в таком смысле. Вы просто используете нужное вам слово отношения.
...
Опять же, контекст, вероятно, скажет, кто любит кого и кто бежит.
...
Самый точный способ произносить или писать предложения на ложбане - поместить короткое слово **.i** в начало каждого из них:
...
Когда мы говорим одно предложение за другим на английском, мы делаем паузу (она может быть короткой) между ними. Но пауза имеет много разных значений на английском. На ложбане у нас есть лучший способ понимать, где заканчивается одно предложение и начинается другое.

Также обратите внимание, что иногда, когда произносим слова быстро, вы не можете понять, где заканчивается одно предложение и начинается слово следующего предложения. Поэтому рекомендуется использовать слово **.i** перед началом нового предложения.
...
не указывает количество людей, говорящих со мной. На английском невозможно опустить число, потому что _people_ в английском подразумевает _более одного человека_. Однако на Lojban вы можете опустить число, даже если оно во множественном числе.
...
Для чисел, состоящих из нескольких цифр, мы просто объединяем эти цифры.
...
Если мы хотим посчитать, мы можем разделять числа с помощью **.i**:
...
В языке Lojban порядок слов можно сохранить. Чтобы превратить любое утверждение в вопрос типа «Да/Нет», мы просто вставляем слово **xu** где-то в предложении, например, в начале:
...
Помните, что в языке Lojban знаки препинания, такие как "?" (вопросительный знак), в основном необязательны и используются в основном для стилистических целей. Это потому, что слово-вопрос **xu** уже показывает, что это вопрос.
...
То, что выражается интонацией на английском языке, выражается перемещением **xu** после той части, которую мы хотим подчеркнуть, в языке Lojban. Обратите внимание, что первое предложение с **xu** в начале задает наиболее общий вопрос без ударения на каком-либо конкретном аспекте.

**xu** - это междометие. Вот особенности междометий Lojban:
...
Местоимение **mi'o** (_ты и я вместе_) на самом деле может быть выражено как **mi joi do**, что означает точно то же самое (это просто длиннее). В Lojban вы можете использовать не одно слово для _мы_, а более точные конструкции, такие как **mi joi le pendo** (буквально _я и друзья_).

<pixra url="/assets/pixra/cilre/casnu.svg" caption="do joi le pendo joi mi casnu" definition="Ты, друг и я обсуждаем."></pixra>
#### Задание

Закройте правую часть таблицы. Переведите предложения слева с Lojban.
...
Закройте правую часть таблицы. Переведите предложения слева на Lojban.
...
В Lojban мы просто используем союз **.i je** (или **.e**, **gi'e**, **je**, в зависимости от того, что мы соединяем) и добавляем к нему оттенок контраста с помощью междометия **ku'i**. Это даст нам необходимый контраст. Как обычно, междометие модифицирует конструкцию перед ним.
...
Еще одно замечание: английские определения слов Lojban могут использовать времена, даже если оригинальные слова Lojban не подразумевают их, например:
...
Скобки _(_ и_)_ используются здесь только для показа структуры; они не являются необходимыми в обычном тексте на Lojban.
...
В английском языке мы начинаем слово с заглавной буквы, чтобы показать, что это имя. В Lojban мы используем префиксное слово **la**.
...
Имя Боба, название языка _Lojban_, можно использовать на Lojban без больших изменений:

> **la .lojban. cu bangu mi**
> _Я говорю на Lojban._
> Lojban - это мой язык.
> `Я использую язык Lojban.`
...
> _Я новый студент Lojban._
<!-- -->
> **mi tadni la .lojban.**
> _Я изучаю Lojban._

<pixra url="/assets/pixra/cilre/tadni.svg" caption="человек учится на Lojban" definition="Человек сейчас учится на Lojban."></pixra>

Буквы Lojban напрямую соответствуют звукам, поэтому есть некоторые правила для адаптации имен к тому, как они пишутся на Lojban. Это может звучать странно - в конце концов, имя - это имя - но все языки делают это в какой-то степени. Например, англоязычные говорящие обычно произносят _Jose_ как _Hozay_, а _Margaret_ на китайском - _Magelita_. Некоторые звуки просто не существуют на некоторых языках, поэтому вам нужно переписать имя так, чтобы оно содержало только звуки Lojban и было написано в соответствии с соответствием буквам и звукам.
...
Обратите внимание на то, как имя произносится на родном языке. В результате английские и французские имена _Robert_ звучат по-разному на Lojban: английское имя - **.robyt.** в британском английском языке или **.rabyrt.** в некоторых американских диалектах, но французское - **.rober.**
...
Вы можете выбрать приятное прозвище на Lojban, используя не только cmevla, но и слова-отношения. Вы также можете перевести свое настоящее имя на Lojban, если знаете, что оно означает, или выбрать совершенно новое имя на Lojban.
...
<th> Слово на Lojban </th>
<th> Значение на Lojban </th>
<th> Ваше имя
</th></tr>
</thead>
<tbody>
...
Lojban не имеет отдельных слов для _he_ или _she_. Возможные решения:
...
В Lojban нельзя сказать, например:
...
Чтобы представить себя на Lojban с использованием вашего именованного имени, следуйте приведенному выше примеру. Если ваше имя состоит из более чем одного глагольного слова, используйте **lu … li'u**:
...
> _Я говорил с моим другом на Lojban о том, что сад готов._
...
В Lojban **bajra** как предложение означает _Кто-то бежит_ (или _бежал_, в зависимости от контекста). **bajra** также может означать команду, _Беги!_, но иногда контекст недостаточен, чтобы определить, является ли это призывом к бегу или просто утверждением, что кто-то бежит или бежал.
...
Как видите, мы должны перестроить это отношение на английском языке, что все еще звучит странно. Однако вы можете использовать это на Lojban в смысле _Постарайтесь произвести хорошее впечатление._
...
- _some_ в вопросах превращается в _anything_, _anybody_; в Lojban это все еще **da**:
...
- Область действия: _any_ используется на английском языке при отрицании, в то время как Lojban использует **na ku**, но все еще **da**:
...
Времена Lojban обрабатывают время и место одинаково. Говорить, что _я работал давно_, грамматически не отличается от говорить _я работаю далеко на севере_. В английском языке слова, такие как _раньше_, окончание прошедшего времени _-ed_ и слова места, такие как _в_ или _рядом_ в трех разных схемах, а в Lojban они следуют одному и тому же принципу.
...
Обратите внимание на порядок гласных **i**, **a** и **u**. Этот порядок появляется многократно в Lojban и может быть полезно запомнить. _Короткое_ и _долгое_ всегда зависят от контекста, относительны и субъективны. Например, двести лет - это короткое время для эволюции видов, но долгое время для ожидания автобуса.
...
> _Я буду уже поговорил с доктором._
...
В славянских языках люди говорят буквально "Я мою себя". Чтобы быть ближе к славянскому стилю, мы можем использовать **lo nei**.

>**mi nelci mi**
>_Мне нравлюсь я сам._
...
Помните, что **ri** не может ссылаться на местоимения, такие как **mi**, поэтому в последнем примере может быть предпочтительнее использовать **lo nei**. При изменении первого существительного **lo nei** не меняется, что довольно удобно:
...
**nei** хорошо работает, когда в предложении есть только одно отношение. Но когда в нем есть несколько вложенных отношений, нам может понадобиться что-то другое. В
...
Когда вложенных отношений нет, эти два слова означают одно и то же:
...
**zu'ai** помещается на второе место глагола. Он показывает взаимное действие между первым местом и вторым местом. Члены этого взаимного действия помещаются на первое место и связываются союзом **jo'u**.
...
В английском здесь нет точности - _he_ означает _какой-то мужчина, упомянутый где-то в тексте или выведенный из контекста._ Ударил ли Билл Боба или Боб ударил Билла? Мы не знаем. В Lojban мы можем сказать:
...
В некоторых обозначениях 0,35 можно записать как .35, а в Lojban мы также можем опустить ноль, сказав **pi mu**.
...
Порядковые числительные, такие как «первый», «второй» и «третий», используются для упорядочивания элементов. В Lojban они образуются путем добавления числа, за которым следует **moi**:
...
Последнее предложение на Lojban означает, что друг также является супругом.
...
Мы уже видели два личных местоимения, **mi** (_я_ или _меня_) и **do** (_ты_). Однако _you_ в английском языке может иметь несколько значений, которые переводятся на Lojban специфическим образом:
...
**zoi** - это кавычка для цитирования не-Lojban текста. Его синтаксис выглядит как **zoi X. text .X**, где X - это слово Lojban (называемое разделительным словом), которое отделяет процитированный текст от пауз, и которое не найдено в написанном тексте или произнесенном фонемном потоке внутри этой цитаты. Обычно, но не обязательно, используется имя какой-то буквы, которая соответствует Lojban-названию языка, на котором происходит цитирование:

> **zoi gy. John is a man .gy. cu glico jufra**
> _“John is a man” is an English sentence._

где **gy.** означает **glico**. Другие популярные варианты разделительных слов - это слово _zoi_ само по себе и слово на Lojban, которое предлагает тему цитаты.

Lojban строго избегает любых неясностей между вещами и их названиями:
...
**la'o** служит для обозначения не-Lojban имен, например, биномиальных латинских названий Линнея (например, "Homo sapiens"), которые являются международно стандартизированными названиями для видов животных и растений.

Международно известные имена, которые можно легче узнать по написанию, а не по произношению, такие как _Goethe_, также могут появляться в тексте Lojban с помощью **la'o**:

> **la'o dy. Goethe .dy. cu me la'o ly. Homo sapiens .ly.**
> _Goethe is a Homo sapiens._

Однако использование **la'o** для всех имен вместо адаптации их к Lojban может привести к громоздкому тексту.

Все, что выражено в тексте, также должно быть выражено в речи и наоборот. Поэтому не может быть никакой пунктуации, которая не произносится. Это означает, что у Lojban есть широкий спектр слов для цитирования других слов. Все Lojban преобразуют текст в существительное.

**lu** … **li'u** цитируют только грамматически правильный текст. Чтобы процитировать любой текст на Lojban, мы используем цитаты **lo'u** … **le'u** вместо этого.
...
Многие отдельные английские слова соответствуют комбинациям слов в Lojban:
...
<!-- ## Вещи, еще не формализованные в Lojban

Хотя Lojban может быть самым говоримым языком №1 в мире, его грамматика настолько подробна. Тем не менее, есть некоторые
...
## [Словарь](https://la-lojban.github.io/uncll/uncll-1.2.14/xhtml_section_chunks/go01.html)
