...
В отличие от русского, нам не нужно добавлять конструкцию "- это" в предложение. Оно уже подразумевается. Слово отношения **nintadni** (_… быть новым студентом_) уже содержит в себе английское "- это", когды мы переводим на русский.
...
В ложбане мы выражаем время, когда что-то происходит (грамматически, на английском это обычно называется _временем_), с помощью модальных термов. Мы уже видели модальный терм **ca**, который означает _в настоящее время_.
...
- **pu** означает _до ... (какого-то события)_, **пу** в одиночку обозначает прошедшее время.
- **ca** означает _в то же время, что и ... (какое-то событие)_, **ца** в одиночку обозначает настоящее время.
- **ba** означает _после ... (какого-то события)_, **ба** в одиночку обозначает будущее время.
...
Обратите внимание, что терм **pu** (прошедшее время) ставится только в основное отношение (**ми пу цу цитка**). В ложбане предполагается, что событие _Я танцевал_ происходит относительно события поедания.
