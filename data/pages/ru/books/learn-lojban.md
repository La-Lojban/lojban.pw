...
Если мы ведём счёт, мы можем разделять числа с помощью **.i**:
...
Чтобы сказать _люди_ (множественное число) в отличие от _одного человека_, мы используем **za'u pa**, _более одного_ или просто **za'u**.
...
<table style="table-layout: fixed;">
 <tbody>
  <tr>
   ...
   <td>Пять человек идут на рынок.</td>
  </tr>
  <tr>
   <td>le pa re prenu cu stati .i do stati</td>
   <td>Двенадцать человек умны. Ты умён.</td>
  </tr>
  <tr>
...
<table style="table-layout: fixed;">
 <tbody>
  ...
  <tr>
   <td>Менее, чем 12 яблок, вкусны.</td>
...
Сложные глаголы - это мощный инструмент, который создаёт более богатые значения. Вы просто соединяете два глагола, и левая часть такого сложного глагола добавляет специфичность к правому.
...
В русском языке мы формируем вопрос типа «да/нет», используя интонацию или используя частицу _ли_, например:

> _Ты здесь. ⇒ Ты здесь ?_
> _Он здесь. ⇒ Здесь ли он ?_

В ложбане интонация не меняет смысл. Чтобы превратить любое утверждение в вопрос типа «Да/Нет», мы просто вставляем слово **xu** где-то в предложении, например, в начале:

> **xu do nelci le gerku**
> _Ты любишь собак, этих собак?_
...
Мы можем изменять значение высказывания, помещая **xu** после разных частей отношения. Объяснения, что изменилось в значении, даны в скобках:

> **xu do nelci le gerku**
> _Ты любишь этих собак?_

<!-- -->

> **do xu nelci le gerku**
> _ТЫ любишь этих собак?_ (Я думал, что это кто-то другой, кто их любит).

<!-- -->

> **do nelci xu le gerku**
> _Ты ЛЮБИШЬ этих собак? (Я думал, что ты к ним просто равнодушен)._

<!-- -->

> **do nelci le xu gerku xu**
> _Ты любишь ЭТИХ СОБАК? (Я думал, что ты любишь кошек)._

То, что выражается смысловым ударением в русском языке, в ложбане выражается постановкой **xu** после той части, которую мы хотим подчеркнуть. Обратите внимание, что первое предложение с **xu** в начале задает наиболее общий вопрос без акцента на каком-либо конкретном аспекте.
...
> **le verban ca co'i pinxe le jisra**
> _Дети выпили сок._
...
> _Мне хочется что-то связанное с яблоком (возможно, поедание, жевание, облизывание, бросание в друга и т.д.)_

> **tu'a le cakla cu pluka mi**
> _Шоколад мне нравится (скорее всего, из-за его вкуса)._
> `Что-то в шоколаде приятно мне`

cakla
: x1 представляет собой шоколад

Пропуская абстракции, только контекст говорит нам, что было опущено.

Также возможно изменение основной реляционной конструкции:

> **le cakla cu jai pluka mi**
> **tu'a le cakla cu pluka mi**
> _Шоколад нравится мне._

Это позволяет создавать размытые существительные с **jai**:

> **le jai pluka cu zvati ti**
> _Приятная вещь здесь._

Так как **le pluka** (_приятное событие_) является абстрактным, нельзя указать его местоположение. Однако участника абстракции можно физически поместить куда-то.
