...
> **Условная вероятность** - это вероятность того, что событие $A$ произойдет, при условии, что произошло событие $B$.<br/>
> **Условная вероятность** - это вероятность наступления события при условии, что какое-то событие заведомо наступило. 

Часто событие приходится рассматривать при условии, что уже произошло другое событие.

При наличии другого события суть эксперимента меняется, вероятность основного события также изменяется.
