...
Представим, что у нас есть корзина с разноцветными яблоками. Допустим, в корзине 6 красных яблок и 4 зеленых. Теперь давай узнаем, как вычислить вероятность того, что, выбрав яблоко наугад, оно окажется красным.

* Шаг 1: Определение всех возможных исходов (общее количество яблок):

   Всего у нас есть 6 красных и 4 зеленых яблока. Общее количество яблок равно 6 + 4 = 10.
...
Таким образом, вероятность выбора красного яблока равна 0.6 или 60%. Это означает, что если мы наугад выбираем одно яблоко из корзины, то существует 60%-ный шанс, что оно будет красным.

### Идеи теории вероятностей
...
Условная вероятность - это вероятность того, что событие $A$ произойдет, при условии, что произошло событие $B$. Обозначается такая вероятность с вертикальной чертой, напримре, для данного случая как $P(A|B)$.

Вертикальная черта перед событием $В$ означает, что событие $В$ рассматривается не как случайное, а как уже наступившее событие, изменяющее вероятность события $А$. 

#### Пример 1.

Вероятность выбросить два орла, дважды бросая монету, равна 0.25. Но если в первый раз орел уже выпал, то эта вероятность повышается до 0.5. А если при первом броске выпала решка, то вероятность события «два орла» снижается до нуля.

#### Пример 2.

Предположим, у вас есть магазин мороженого, и 4 из 6 вкусов - шоколадные (вероятность 67%). Если покупатель приходит и выбирает шоколадное мороженое, вероятность того, что следующий покупатель тоже выберет шоколад, может немного уменьшиться, потому что теперь в магазине осталось меньше шоколадных вкусов.

#### Пример 3.

Представим, что у нас есть коробка с карточками, на которых написаны числа от 1 до 10. Мы хотим найти условную вероятность того, что выбранное число будет четным (событие $A$), при условии, что оно меньше 6 (событие $B$).

- Событие $A$ - выбранное число четное.
- Событие $B$ - выбранное число меньше 6.

Теперь представим, что мы уже знаем, что выбранное число меньше 6 (событие $B$ произошло). В таком случае, мы сужаем наше множество возможных чисел до 1, 2, 3, 4, 5. Таким образом, событие $A$ (число четное) может произойти для чисел 2 и 4.

<div class="common"></div>

> Вероятность события А при условии, что событие В произошло, называется **условной вероятностью** события А при условии события В. Обозначается эта вероятность $P(A|B)$.

Теперь вычислим условную вероятность для последнего примера:

$P(A|B) = \frac{\text{Количество благоприятных случаев для } A \text{ при условии } B}{\text{Общее количество случаев при условии } B}$.

$P(A|B) = \frac{2}{5}$.

Итак, условная вероятность того, что выбранное число четное, при условии, что оно меньше 6, равна $\frac{2}{5}$ или 40%.

Проще говоря, если мы уже знаем, что выбранное число меньше 6, то есть 40% шансов, что оно также будет четным.

#### Пример 4.

В семье двое детей. Если считать, что рождение мальчика и девочки равновозможны, ответьте на два вопроса:
- какова вероятность того, что в семье оба ребенка девочки;
- известно, что один из них девочка. Какова вероятность того, что другой ребенок тоже девочка?
...
Итак, вероятность рождения двух девочек равна $1/4$.

В следующем вопросе тоже спрашивается о вероятности рождения двух девочек. Но отличие в том, что вероятность
надо найти исходя из дополнительного условия: "один из детей  — девочка". Это условие фактически описывает новую ситуацию. Возможных событий уже только три:
* мальчик и девочка
* девочка и мальчик
* девочка и девочка

Искомая вероятность наличия двух девочек в семье при условии, что один ребенок — девочка равна $1/3$.

Условие "один из детей — девочка" увеличило вероятность наличия двух девочек.

Таким образом, ддля нахождения вероятности события $А$ при условии наступления события $В$ нужно найти долю возможных событий (исходов), благоприятствующих $А$, не среди всех возможных событий опыта, а лишь среди тех, что
...
В некотором городе пятую часть населения составляют дети и подростки. Среди взрослых жителей четверть не работают (пожилые люди, учащиеся, домохозяйки и т.п.) Какова вероятность того, что случайно выбранный житель города — взрослый работающий человек?

Искомая вероятность равна доле взрослых работников среди всего населения города. Из условия ясно, что взрослые составляют $4/5$ населения города и $3/4$ из них работают. Значит, $4/5 \cdot 3/4 = 3/5$ населения  — взрослые работающие люди. 
...
Из условия следует, что доля взрослого населения $4/5$ и есть вероятность $P(B)$. А $3/4$ — доля работающих
среди взрослого населения — это условная вероятность $P(A|B)$. Вероятность одновременного наступления событий $А$ и $В$ оказалась равна произведению вероятностей, то есть $P(A \cap B) = P(B) \cdot P(A|B)$.

Эту формулу мы получили на примере, но она верна для любых случайных событий в любых случайных опытах. Полученное равенство мы
