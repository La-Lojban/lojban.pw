...
> **Вероятность** — это численная мера, выражающая степень возможности того, что определенное событие произойдет.
...
Вероятность является важным понятием в теории вероятностей, статистике и математике в целом. Она используется для измерения шансов и рисков в различных областях, таких как физика, биология, экономика и другие. Понимание вероятности помогает людям принимать разумные решения, основанные на статистических данных и предсказаниях.
...
<div class="common"></div>
> **Условная вероятность** - это вероятность того, что событие $A$ произойдет, при условии, что произошло событие $B$.

Давайте представим, что у нас есть коробка с карточками, на которых написаны числа от 1 до 10. Мы хотим найти условную вероятность того, что выбранное число будет четным (событие $A$), при условии, что оно меньше 6 (событие $B$).
...
Таким образом, вероятность того, что человек действительно болен при положительном результате теста, составляет примерно 17%. Это гораздо ниже, чем точность самого теста, и показывает, как важно учитывать редкость заболевания и вероятность ложноположительных результатов.
