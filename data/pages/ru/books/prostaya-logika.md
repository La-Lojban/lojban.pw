...
Например, суждение «Некоторые дети любят рисовать» обращается просто: «Некоторые любители рисовать — дети».
...
Всякая кошка (*М*) есть животное (*Р*).
...
*2-я фигура*. *Е*. Ни одна кошка (*Р*) не является птицей (*М*).

*Модус ЕАЕ*. *А*. Кошки (*S*) ловят мышей (*М*).

----

*Е*. Кошки (*S*) не едят яблоки (*Р*).
...
*Е*. Петербург не находится за полярным кругом.
...
Если <i>S</i>    есть <i>Р</i> , то <i>S<sub>1</sub></i>    есть <i>Р<sub>1</sub></i> .
...
<i>S<sub>1</sub></i>    не есть <i>Р<sub>1</sub></i> .
...
<i>S</i>    есть или <i>Р<sub>1</sub></i> , или <i>Р<sub>2</sub></i> , или <i>Р<sub>3</sub></i>

<i>S</i>    не есть ни <i>Р<sub>1</sub></i> , ни <i>Р<sub>2</sub></i> .

----

Следовательно, <i>S</i>    есть <i>Р<sub>3</sub></i> .

Например, установлено, что данное вещество (<i>S</i> ) содержит в себе или хлор (<i>P<sub>1</sub></i> ), или бром (<i>Р<sub>2</sub></i> ). Дальнейший анализ показал, что данное вещество не содержит в себе хлора. Следовательно, оно содержит бром.
...
<i>S</i>    есть или <i>P<sub>1</sub></i> , или <i>Р<sub>2</sub></i> , или <i>P<sub>3</sub></i> .

<i>S</i>    есть <i>P<sub>1</sub></i> .
...
Все активисты обязаны укреплять дисциплину.
...
Наш вечер был хорошо организован.
...
Каждый работник обязан беречь свои рабочие инструменты.
...
Увеличение сорняков вызывает уменьшение полезных растений.

Уменьшение полезных растений приводит к уменьшению урожая.

Уменьшение урожая приводит к голоду.
