...
- **Вероятность всегда находится между 0 и 1**. Вероятность измеряется от 0 до 1, где 0 означает невозможность события, а 1 — его обязательное произведение. Промежуточные значения между 0 и 1 указывают на степень вероятности события.
