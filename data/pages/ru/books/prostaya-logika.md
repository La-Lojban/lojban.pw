...
> Вероятность события А при условии, что событие В произошло, называется **условной вероятностью** события А при условии, что произошло событие В. Обозначается эта вероятность $P(A|B)$.
