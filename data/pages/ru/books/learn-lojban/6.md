...
<pixra url="/assets/pixra/books/learn-lojban/le_vehi_ja_vehu_cmana.webp" caption="le ve'i cmana cu jibni le ve'u cmana" definition="Холм рядом с горой."></pixra>
...
ba'o
: модальный терм: последствия — период после того, как событие закончилось
...
<pixra url="/assets/pixra/books/learn-lojban/puho_nenri.webp" caption="le prenu pu'o zvati le nenri" definition="Человек собирается быть внутри."></pixra>
...
> (Мы в последствиях разговора — **pu** относит это к прошлому.)

<pixra url="/assets/pixra/books/learn-lojban/baho_carvi.webp" caption="ba'o carvi" definition="После дождя. Дождь прекратился."></pixra>

<!-- -->

> **le verba ba'o cadzu le bisli**
> _Ребёнок больше не идёт по льду._
> (Мы в последствиях ходьбы.)
...
В сочетании с **pu**, **ca** или **ba** частица **ba'o** часто передаёт прошедшее, настоящее или будущее перфектное время, когда имеется в виду «в последствиях в тот момент»; сама **ba'o** означает «в последствиях», а не «перфектное время».
...
vasxu
: x<sub>1</sub> дышит x<sub>2</sub>

> **mi pu mo'u citka le plise**
> _Я съел яблоко до конца._
> (Естественное завершение: еда достигла естественного конца.)

<!-- -->

> **la .maks. pu mo'u zbasu ti voi dinju**
> _Макс построил этот дом._
> (Естественное завершение: постройка достигла естественного конца; он сейчас не строит.)

Противопоставьте **co'u** (прекратил, остановился — возможно, до естественного конца) и **mo'u** (закончил — достиг естественного конца): _Я перестал есть_ (**mi pu co'u citka**) может означать, что вы оставили еду; _Я доел яблоко_ (**mi pu mo'u citka le plise**) — что достигли естественного конца.
...
<pixra url="/assets/pixra/books/learn-lojban/deha_vasxu.webp" caption="mi de'a vasxu" definition="Я приостанавливаю дыхание. Я задерживаю дыхание."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/diha_vasxu.webp" caption="mi di'a vasxu" definition="Я возобновляю дыхание."></pixra>
...
co'u
: модальный терм: событие останавливается (прекращение; возможно до естественного конца)

mo'u
: модальный терм: естественное завершение — событие достигло своей естественной конечной точки
...
jundi
: x<sub>1</sub> обращает внимание на x<sub>2</sub>
...
На диаграмме **ba'o** (последствия) встречается дважды: после **mo'u** (естественное завершение) и после **co'u** (прекращение) — последствия могут следовать за любым из них. **co'i** — совершенный вид (событие как единое целое); **mo'u** — естественное завершение; **ba'o** — период после окончания события.
...
<pixra url="/assets/pixra/books/learn-lojban/pritu_le_tricu.webp" caption="le prenu cu pritu le tricu le zgana" definition="Человек находится справа от дерева с точки зрения наблюдателя."></pixra>
...
zunle
: x<sub>1</sub> находится слева от x<sub>2</sub>, если смотреть от x<sub>3</sub>

pritu
: x<sub>1</sub> находится справа от x<sub>2</sub>, если смотреть от x<sub>3</sub>

crane
: x<sub>1</sub> находится перед x<sub>2</sub> (x<sub>1</sub> между x<sub>2</sub> и тем, кто смотрит), если смотреть от x<sub>3</sub>

trixe
: x<sub>1</sub> находится позади x<sub>2</sub>, если смотреть от x<sub>3</sub>

sanli
: x<sub>1</sub> стоит на x<sub>2</sub>

zutse
: x<sub>1</sub> сидит на x<sub>2</sub>

vreta
: x<sub>1</sub> лежит на x<sub>2</sub>
...
marce
: x<sub>1</sub> это транспортное средство, перевозящее x<sub>2</sub>

se marce
: x<sub>1</sub> это пассажир x<sub>2</sub>

<!-- jai zu'e se marce
: x<sub>1</sub> takes a vehicle x<sub>2</sub> as a passenger -->

karce
: x<sub>1</sub> это машина, перевозящая x<sub>2</sub>

bloti
: x<sub>1</sub> это лодка, перевозящая x<sub>2</sub>

vinji
: x<sub>1</sub> это самолёт, перевозящий x<sub>2</sub>

trene
: x<sub>1</sub> это поезд из вагонов x<sub>2</sub>
...
pixra
: x<sub>1</sub> это картина x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viha_pixra.webp" caption="vi'a pixra" definition="2D картина, 2D рисунок."></pixra>

<pixra url="/assets/pixra/books/learn-lojban/vihu_pixra.webp" caption="vi'u pixra" definition="3D картина, скульптура."></pixra>
