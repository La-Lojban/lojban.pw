...
dirgo
: x<sub>1</sub> ay isang patak ng materyal na x<sub>2</sub> …
...
plise
: x<sub>1</sub> ay isang mansanas

fusra
: x<sub>1</sub> ay nabulok o nabubulok na may sanhi na x<sub>2</sub>
...
valsi
: x<sub>1</sub> ay isang salita na may kahulugang x<sub>2</sub> sa wika x<sub>3</sub>
