...
Ang mga diksyunaryo ay maaaring magpakita ng mga kahulugan ng mga salitang relasyon na may mga simbolo tulad ng x<sub>1</sub>, x<sub>2</sub>, atbp.:

prami
: x<sub>1</sub> ay nagmamahal sa x<sub>2</sub>

karce
: x<sub>1</sub> ay isang kotse …

citka
: x<sub>1</sub> ay kumakain ng x<sub>2</sub> …

klama
: x<sub>1</sub> ay pumupunta sa x<sub>2</sub> …

Ang mga x<sub>1</sub>, x<sub>2</sub>, at iba pa ay ang tahasang notasyon para sa tinatawag na _mga puwang_ (ibang pangalan ay: _mga lugar_, _mga tungkulin ng relasyon_, **terbricmi** sa Lojban). Ang mga puwang ay pinupunan ng mga termino ng argumento (**sumti**) sa pangungusap.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… ay isang bundok"></pixra>
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> ay pumupunta sa x<sub>2</sub> mula sa x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> ay nagmamahal sa x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> ay isang kotse</td>
</tr>
<tr>
<td><b>citka</b></td>
<td>x<sub>1</sub> ay kumakain ng x<sub>2</sub></td>
</tr></tbody></table>
...
pinxe
: x<sub>1</sub> ay umiinom ng x<sub>2</sub> mula sa x<sub>3</sub>
...
plicru
: x<sub>1</sub> ay nagbibigay, nag-aalok sa x<sub>2</sub> ng bagay na x<sub>3</sub>; x<sub>1</sub> ay nagpapahintulot sa isang tao x<sub>2</sub> na gamitin ang x<sub>3</sub>

#### Gawain

zgana
: x<sub>1</sub> ay nagmamasid/napapansin ng x<sub>2</sub> gamit ang pandama x<sub>3</sub>
...
<tr>
<td><i>Binibigay ko ang mansanas sa bata.</i></td>
...
- **le nicte** bilang x<sub>1</sub> ng relasyon,
...
- **mi** - x<sub>1</sub> ng panloob na relasyon,
- **viska** - ang panloob na relasyon,
- **le lunra** - x<sub>2</sub> ng panloob na relasyon.
...
- **mi** bilang x<sub>1</sub>, ang unang lugar ng relasyon,
...
- **mi** bilang x<sub>1</sub>, ang unang lugar ng relasyon sa loob ng termino
...
tavla
: x<sub>1</sub> ay nakikipag-usap sa x<sub>2</sub> …

melbi
: x<sub>1</sub> ay maganda, kaakit-akit para sa x<sub>2</sub> …
...
nandu
: x<sub>1</sub> ay mahirap para sa x<sub>2</sub>

tilju
: x<sub>1</sub> ay mabigat
...
klama
: x<sub>1</sub> ay pumupunta sa x<sub>2</sub> mula sa x<sub>3</sub>
...
<td>Gumagamit ng mga pangunahing argumento (x<sub>2</sub> at x<sub>3</sub> ng klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Gumagamit ng pangunahing argumento (x<sub>2</sub> = le zarci) at modal na termino (ca le nu do pinxe)</td>
</tr>
<tr>
...
1. Ang unang lugar ay kadalasang ang tao o bagay na gumagawa ng isang bagay o naging isang bagay:
   ...
   **klama** = _x<sub>1</sub> ay pumupunta …_

2. Ang bagay na kinikilusan ng isang aksyon ay karaniwang nasa pagkatapos ng unang lugar:

   **punji** = _x<sub>1</sub> ay naglalagay ng x<sub>2</sub> sa x<sub>3</sub>_,
...
4. Ang mga lugar ng patutunguhan (_sa_) ay halos laging nauuna sa mga lugar ng pinagmulan (_mula sa_):
   ...
   **klama** = _x<sub>1</sub> ay pumupunta sa x<sub>2</sub> mula sa x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="Umaalis ang tao mula sa tindahan."></pixra>
...
dunda
: x<sub>1</sub> ay nagbibigay ng x<sub>2</sub> sa x<sub>3</sub>

benji
: x<sub>1</sub> ay naglilipat ng x<sub>2</sub> sa x<sub>3</sub> mula sa x<sub>4</sub>

lebna
: x<sub>1</sub> ay kumukuha ng x<sub>2</sub> mula sa x<sub>3</sub>
...
troci
: x<sub>1</sub> ay sumusubok na gawin o maging x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> ay naglalakad

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="Sinusubukan ng bata na maglakad."></pixra>
...
cinmo
: x<sub>1</sub> ay nakakaramdam ng x<sub>2</sub> (ka)

Nangangahulugan ito na ang infinitive sa pangalawang puwang (x<sub>2</sub>) ay inilalapat sa ibang puwang (malamang, ang unang puwang, x<sub>1</sub>). Ang mga kaso kung saan ang infinitive ay inilalapat sa mga puwang maliban sa x<sub>2</sub> ay bihira at ipinapaliwanag sa mga diksyunaryo para sa mga kaukulang relasyon o sa kaso ng mga salitang relasyon na hindi opisyal na inimbento, maaaring mahulaan mula sa sentido komun sa pamamagitan ng paghahambing sa ibang katulad na mga salitang relasyon.

Isa pang halimbawa:

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Tinutulungan niya ang kaibigan na dalhin ang mga bag."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Tinutulungan niya ang kaibigan na dalhin ang mga bag._

sidju
: x<sub>1</sub> ay tumutulong sa x<sub>2</sub> na gawin ang x<sub>3</sub> (ka)

Ang salitang relasyon na **sidju** ay nangangailangan na ang ikatlong puwang nito ay mapunan ng isang infinitive.

bevri
: x<sub>1</sub> ay nagdadala ng x<sub>2</sub>
...
zgana
: x<sub>1</sub> ay nagmamasid sa x<sub>2</sub>

kakne
: x<sub>1</sub> ay may kakayahang gawin ang x<sub>2</sub> (property)

nelci
: x<sub>1</sub> ay gusto ng x<sub>2</sub>
...
djica
: x<sub>1</sub> ay gustong mangyari ang x<sub>2</sub> (pangyayari)
...
zekri
: x<sub>1</sub> ay isang kriminal na pangyayari, x<sub>1</sub> (pangyayari) ay isang krimen

cumki
: x<sub>1</sub> (pangyayari) ay posible
...
stidi
: x<sub>1</sub> ay nagmumungkahi ng aksyon na x<sub>2</sub> (property) sa x<sub>3</sub>
...
> _Gusto ko ang matamis na pagkain._
...
<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="Gusto ng tao ang matamis na pagkain."></pixra>
...
Gayunpaman, ang salitang relasyon sa Lojban na **stidi** ay nangangailangan ng property sa puwang nitong x<sub>2</sub>. Gayundin, ang **djica** ay nangangailangan ng pangyayari sa puwang nitong x<sub>2</sub>.
...
cakla
: x<sub>1</sub> ay ilang tsokolate
...
stidi
: x<sub>1</sub> ay nagmumungkahi ng x<sub>2</sub> (property) sa x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="ang kaibigan / ang mga kaibigan"></pixra>
...
Bilang default, ikinakabit nito ang pangalawang lugar (x<sub>2</sub>). Maaari nating ikabit ang higit pang mga lugar sa pamamagitan ng paghihiwalay sa kanila ng **bei**:

> **mi plicru do le plise**
> _Binibigyan kita ng mansanas._

<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="Binibigyan ng tao ang kaibigan ng kagamitan."></pixra>
...
ctuca
: x<sub>1</sub> ay nagtuturo sa isang tao x<sub>2</sub> ng paksa x<sub>3</sub>

cmene
: x<sub>1</sub> ay isang pangalan ng x<sub>2</sub> na ginagamit ng x<sub>3</sub>
...
speni
: x<sub>1</sub> ay kasal kay x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="Ang aso na palagi kong nakikita sa parke."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="Malaki ang puno."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Gusto ko ang mga ito na ang ngiti ay nakakatuwa sa akin."></pixra>
...
pluka
: x<sub>1</sub> ay nakakatuwa sa x<sub>2</sub>

zutse
: x<sub>1</sub> ay nakaupo, nakaupong nasa x<sub>2</sub>
...
birka
: x<sub>1</sub> ay isang braso ng x<sub>2</sub>
...
tuple
: x<sub>1</sub> ay isang binti ng x<sub>2</sub>

clani
: x<sub>1</sub> ay mahaba, mahabang-panahon

cinri
: x<sub>1</sub> (kaganapan) ay kawili-wili para sa isang tao x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="Nagtuturo ako / Ako ay isang guro."></pixra>
...
tunba
: x<sub>1</sub> ay kapatid ng x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="Ikaw ay kapatid ko."></pixra>

#### Gawain

gerku
: x<sub>1</sub> ay isang aso

badna
: x<sub>1</sub> ay isang saging

pendo
: x<sub>1</sub> ay kaibigan ng x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="Ang dating disyerto ay ngayon isang hardin."></pixra>

> **le pu kunti tumla ca purdi**
> _Ang dating disyerto ay ngayon isang hardin._

kunti
: x<sub>1</sub> ay walang laman

tumla
: x<sub>1</sub> ay isang parsela ng lupa
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="Ang disyerto ay dating hardin."></pixra>
...
melbi
: x<sub>1</sub> ay maganda

sutra
: x<sub>1</sub> ay mabilis
...
<td>Ang "ca" ay inilalapat sa "mi melbi" - ang pagiging maganda ko ngayon ay mabilis</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> ay nagbibigay sa x<sub>2</sub> ng isang bagay na x<sub>3</sub> para gamitin
...
vecnu
: x<sub>1</sub> ay nagbebenta ng x<sub>2</sub> sa x<sub>3</sub> sa presyong x<sub>4</sub>

ciska
: x<sub>1</sub> ay nagsusulat ng x<sub>2</sub> sa ibabaw na x<sub>3</sub> gamit ang kasangkapang x<sub>4</sub>
...
zbasu
: x<sub>1</sub> ay gumagawa, nagtatayo ng x<sub>2</sub> mula sa x<sub>3</sub>
...
klama
: x<sub>1</sub> ay pumupunta sa x<sub>2</sub> mula sa x<sub>3</sub> sa pamamagitan ng x<sub>4</sub> gamit ang paraan na x<sub>5</sub>
...
mrilu
: x<sub>1</sub> ay nagpapadala ng bagay na x<sub>2</sub> sa address ng tagatanggap na x<sub>3</sub> mula sa kahon ng liham na x<sub>4</sub> sa pamamagitan ng network ng tagapagdala na x<sub>5</sub>

pagbu
: x<sub>1</sub> ay bahagi ng x<sub>2</sub>
...
- ang **fa** ay nagmamarka sa argumento na pumupuno sa unang puwang ng isang relasyon (x<sub>1</sub>)
- ang **fe** ay nagmamarka sa argumento na pumupuno sa pangalawang puwang (x<sub>2</sub>)
- ang **fi** ay nagmamarka sa argumento na pumupuno sa ikatlong puwang (x<sub>3</sub>)
- ang **fo** ay nagmamarka sa argumento na pumupuno sa ikaapat na puwang (x<sub>4</sub>)
- ang **fu** ay nagmamarka sa argumento na pumupuno sa ikalimang puwang (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="Umiinom ang tao mula sa baso."></pixra>
...
tugni
: x<sub>1</sub> ay sumasang-ayon sa isang tao x<sub>2</sub> tungkol sa x<sub>3</sub> (proposisyon)
...
> _Ang isa na nanggaling sa lungsod ay kaibigan ko._
...
xamgu
: x<sub>1</sub> ay mabuti para sa x<sub>2</sub> sa mga termino ng x<sub>3</sub>

cuxna
: x<sub>1</sub> ay pumipili ng x<sub>2</sub> mula sa x<sub>3</sub>

zgike
: x<sub>1</sub> ay musika
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (Binibigyan kita ng mansanas)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> hindi tinukoy, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (may mabuti para sa akin sa usapin ng musika)</td>
</tr></tbody></table>
...
tavla
: x<sub>1</sub> ay nakikipag-usap sa isang tao x<sub>2</sub> tungkol sa paksang x<sub>3</sub>
...
djuno
: x<sub>1</sub> ay nakakaalam ng x<sub>2</sub> (katotohanan) tungkol sa x<sub>3</sub>
...
<td>May isang taong may kaalaman (<b>da</b>) na ang kahulugan ay gusto ko ang kaganapan na tulungan nila ako; <b>da</b> ay ang parehong tao sa prenex at sa loob ng <b>le nu</b></td>
</tr></tbody></table>
...
Kapag ang isang pangungusap ay nangangailangan ng pangalawang o pangatlong natatanging variable, ang Lojban ay gumagamit ng **de** at **di** pagkatapos ng **da** (tingnan din ang ["Grouping of quantifiers" sa CLL](/en/books/cll/16/#section-quantifier-grouping)):

da
: panghalip: unang variable (tulad ng lohikal _X_).

de
: panghalip: pangalawang variable (tulad ng lohikal _Y_).

di
: panghalip: pangatlong variable (tulad ng lohikal _Z_).

> **da de zo'u mi djica le nu da tavla de**
> _May isang tao at isa pang tao na ang kahulugan ay nais ko na makausap ng una ang pangalawa (**da** at **de** ay tumutukoy sa dalawang taong iyon sa prenex at sa loob ng **le nu**)._
...
zmadu
: x<sub>1</sub> ay higit sa x<sub>2</sub> sa katangiang x<sub>3</sub>

mlatu
: x<sub>1</sub> ay isang pusa
...
<td>Una: dalawang tao (na tinutukoy natin ng mga variable) ang bawat isa ay higit sa isang tao; ang taong nalampasan ay maaaring magkaiba para sa bawat isa sa dalawa, o maaaring pareho. Pangalawa: bawat isa sa dalawang <b>le prenu</b> ay higit sa isang <b>le prenu</b>; ang bawat <b>le prenu</b> ay maaaring pumili ng bagong referent, kaya ang mga pares ay hindi kailangang tumugma (ihambing ang <a href="#scope">Saklaw</a>)</td>
</tr>
<tr>
...
clani
: x<sub>1</sub> ay mahaba, matangkad
...
panzi
: x<sub>1</sub> ay isang anak, supling ng x<sub>2</sub>
...
ralte
: x<sub>1</sub> ay nagpapanatili ng x<sub>2</sub> sa kanilang pag-aari
...
ponse
: x<sub>1</sub> ay nagmamay-ari ng x<sub>2</sub>

#### Gawain

mamta
: x<sub>1</sub> ay isang nanay ng x<sub>2</sub>

patfu
: x<sub>1</sub> ay isang tatay ng x<sub>2</sub>

ralte
: x<sub>1</sub> ay nagpapanatili ng x<sub>2</sub> sa kanilang pag-aari

ponse
: x<sub>1</sub> ay legal na nagmamay-ari ng x<sub>2</sub>
...
<tr>
<td><i>Ang aking kaibigan ay may dalawang anak</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Tatlong tao ang bawat isa ay nakikipag-usap sa dalawang bata."></pixra>
...
Ang **mo'u** ay nangangahulugang ang isang pangyayari ay naabot na ang likas na wakas nito (natural na pagtapos). Anong pangyayari? Ang pangyayaring **co'a speni** — ang maging may-asawa. Kaya, ang **mi mo'u co'a speni** ay nangangahulugang _Natapos ko ang proseso ng pagiging may-asawa_, ibig sabihin, _Bagong kasal ako._
...
tavla
: x<sub>1</sub> ay nakikipag-usap sa x<sub>2</sub> tungkol sa x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Dito, lahat ay kakaiba."></pixra>
...
stati
: x<sub>1</sub> ay matalino/matalas

jundi
: x<sub>1</sub> ay matulungin sa x<sub>2</sub>

zvati
: x<sub>1</sub> ay naroroon sa x<sub>2</sub>
...
danlu
: x<sub>1</sub> ay isang mammal

morsi
: x<sub>1</sub> ay patay

co'a morsi
: x<sub>1</sub> ay namamatay

ca da
: sa isang punto sa oras

mupli
: x<sub>1</sub> ay isang halimbawa ng x<sub>2</sub> (property) sa x<sub>3</sub> (set)
...
mupli
: x<sub>1</sub> ay isang halimbawa ng x<sub>2</sub> sa x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="Pinalibutan ng mga tao ang mesa."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="Pinalibutan ng ahas ang tao."></pixra>
...
gunma
: x<sub>1</sub> ay isang masa na binubuo ng mga bahaging x<sub>2</sub>
...
grake
: x<sub>1</sub> ay tumitimbang ng x<sub>2</sub> (numero) gramo
