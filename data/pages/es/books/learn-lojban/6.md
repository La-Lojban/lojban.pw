...
<pixra url="/assets/pixra/books/learn-lojban/le_vehi_ja_vehu_cmana.webp" caption="le ve'i cmana cu jibni le ve'u cmana" definition="La colina está cerca de la montaña."></pixra>
...
ba'o
: término modal: consecuencias — el período después de que el evento ha terminado
...
<pixra url="/assets/pixra/books/learn-lojban/puho_nenri.webp" caption="le prenu pu'o zvati le nenri" definition="La persona está a punto de estar adentro."></pixra>
...
> (Estamos en las consecuencias del habla — **pu** sitúa eso en el pasado.)

<pixra url="/assets/pixra/books/learn-lojban/baho_carvi.webp" caption="ba'o carvi" definition="Después de la lluvia. La lluvia se ha detenido."></pixra>

<!-- -->

> **le verba ba'o cadzu le bisli**
> _El niño ya no camina sobre el hielo._
> (Estamos en las consecuencias del caminar.)
...
Con **pu**, **ca** o **ba**, **ba'o** a menudo traduce el pretérito perfecto, presente o futuro perfecto cuando el sentido es «en las consecuencias en ese momento»; **ba'o** significa «en las consecuencias», no «tiempo perfecto».
...
> (Completación natural: el comer alcanzó su final natural.)

<!-- -->

> **la .maks. pu mo'u zbasu ti voi dinju**
> _Max ha construido esta casa._
> (Completación natural: la construcción alcanzó su final natural; no está construyendo ahora.)

Contrasta **co'u** (cesó, se detuvo — quizá antes del final natural) y **mo'u** (terminó — alcanzó el final natural): _Dejé de comer_ (**mi pu co'u citka**) puede significar que dejaste comida; _Me comí la manzana_ (**mi pu mo'u citka le plise**) significa que alcanzaste el final natural.
...
<pixra url="/assets/pixra/books/learn-lojban/deha_vasxu.webp" caption="mi de'a vasxu" definition="Hago una pausa en la respiración. Aguanto la respiración."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/diha_vasxu.webp" caption="mi di'a vasxu" definition="Reanudo la respiración."></pixra>
...
co'u
: término modal: el evento se detiene (cese; puede ser antes del final natural)

mo'u
: término modal: completación natural — el evento ha alcanzado su punto final natural
...
jundi
: x<sub>1</sub> presta atención a x<sub>2</sub>
...
En el diagrama **ba'o** (consecuencias) aparece dos veces: tras **mo'u** (completación natural) y tras **co'u** (cese) — las consecuencias pueden seguir a cualquiera. **co'i** es aspecto perfectivo (evento como todo); **mo'u** es completación natural; **ba'o** es el período tras el fin del evento.
...
<pixra url="/assets/pixra/books/learn-lojban/pritu_le_tricu.webp" caption="le prenu cu pritu le tricu le zgana" definition="La persona está a la derecha del árbol desde el punto de vista del observador."></pixra>
...
zunle
: x<sub>1</sub> está a la izquierda de x<sub>2</sub> visto desde x<sub>3</sub>

pritu
: x<sub>1</sub> está a la derecha de x<sub>2</sub> visto desde x<sub>3</sub>

crane
: x<sub>1</sub> está enfrente de x<sub>2</sub> (x<sub>1</sub> está entre x<sub>2</sub> y quien mira) visto desde x<sub>3</sub>

trixe
: x<sub>1</sub> está detrás de x<sub>2</sub> visto desde x<sub>3</sub>

sanli
: x<sub>1</sub> está parado/parada sobre x<sub>2</sub>

zutse
: x<sub>1</sub> está sentado/sentada sobre x<sub>2</sub>

vreta
: x<sub>1</sub> está acostado/acostada sobre x<sub>2</sub>
...
marce
: x<sub>1</sub> es un vehículo que transporta a x<sub>2</sub>

se marce
: x<sub>1</sub> es un pasajero de x<sub>2</sub>

<!-- jai zu'e se marce
: x<sub>1</sub> toma un vehículo x<sub>2</sub> como pasajero -->

karce
: x<sub>1</sub> es un coche que transporta a x<sub>2</sub>

bloti
: x<sub>1</sub> es un bote que transporta a x<sub>2</sub>

vinji
: x<sub>1</sub> es una aeronave que transporta a x<sub>2</sub>

trene
: x<sub>1</sub> es un tren de vagones x<sub>2</sub>
...
pixra
: x<sub>1</sub> es una imagen de x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viha_pixra.webp" caption="vi'a pixra" definition="Imagen en 2D, dibujo en 2D."></pixra>

<pixra url="/assets/pixra/books/learn-lojban/vihu_pixra.webp" caption="vi'u pixra" definition="Imagen en 3D, escultura."></pixra>
