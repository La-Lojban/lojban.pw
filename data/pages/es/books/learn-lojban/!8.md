...
muvdu
: x₁ se mueve hacia x₂ desde x₃ a través de x₄

jai gau muvdu fai le karce
: x₁ mueve el auto hacia x₂ desde x₃ a través de x₄
...
fengu
: x₁ está enojado con x₂ (cláusula) por la acción x₃ (propiedad de x₂)
...
pacna
: x₁ espera x₂ (evento posible) con una probabilidad de x₃ (número, por defecto **li so'a**, es decir, cerca de 1)
...
kanpe
: x₁ espera x₂ (evento posible) con una probabilidad esperada de x₃ (un número de 0 a 1, el valor predeterminado es **li so'a**, es decir, cerca de 1)
...
lakne
: x₁ (evento posible) es probable, probablemente
...
curmi
: x₁ permite/permite que x₂ (evento posible)

> **mi tolcru le nu do nerkla**
> _Te prohíbo entrar._

tolcru
: x₁ prohíbe/prohíbe que x₂ (evento posible)
...
birti
: x₁ está seguro de que x₂ (proposición) es verdadera -->

> **mi senpi le du'u ra kakne le ka limna**
> _Dudo que él pueda nadar._

senpi
: x₁ duda que x₂ (proposición) sea verdadera
