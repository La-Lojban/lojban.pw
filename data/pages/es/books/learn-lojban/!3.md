...
zausku
: x₁ elogia a x₂ para la audiencia x₃ a través del medio x₄
...
retsku
: x₁ pregunta a x₂ (cita) a la audiencia x₃

spusku
: x₁ responde/dice la respuesta x₂ (cita) a la audiencia x₃
...
cusku
: x₁ dice x₂ (texto) para la audiencia x₃ a través del medio x₄
...
djuno
: x₁ sabe x₂ (proposición) sobre x₃

> **mi jimpe le du'u do pu citka**
> _Entiendo que estabas comiendo._

jimpe
: x₁ comprende x₂ (proposición) sobre x₃
