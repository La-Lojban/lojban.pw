...
melbi
: x<sub>1</sub> es hermoso / bonito / guapo para alguien x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> es una habitación para el propósito x<sub>2</sub> (proposición)
...
Aquí, **le se go'i** se refiere al segundo lugar (x<sub>2</sub>) de la relación anterior, que es **le nanmu**.
...
tcika
: x<sub>1</sub> (horas, minutos, segundos) es la hora del evento x<sub>2</sub>
...
detri
: x<sub>1</sub> (año, mes, día) es la fecha/hora del evento x<sub>2</sub>
...
nanca
: x<sub>1</sub> es de duración de x<sub>2</sub> (número) años
...
masti
: x<sub>1</sub> tiene x<sub>2</sub> meses de duración

> **le nu carvi cu djedi li ci**
> _Está lloviendo durante tres días._

djedi
: x<sub>1</sub> (evento) tiene x<sub>2</sub> (número) días completos de duración
...
glare = x<sub>1</sub> es caliente/cálido
...
nabmi
: x<sub>1</sub> es un problema para x<sub>2</sub>

se nabmi
: x<sub>1</sub> tiene un problema x<sub>2</sub>

laldo
: x<sub>1</sub> es viejo …

certu
: x<sub>1</sub> es un experto, profesional en la propiedad x<sub>2</sub>
