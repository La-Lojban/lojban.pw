...
vitke
: x<sub>1</sub> (invitado) visita a x<sub>2</sub> (alguien) en x<sub>3</sub>
...
jibri
: x<sub>1</sub> es un trabajo de x<sub>2</sub>
...
merko
: x<sub>1</sub> es estadounidense (en el sentido de EE. UU.)
...
simxu
: los miembros del conjunto x<sub>1</sub> recíprocamente hacen x<sub>2</sub>

La relación **simxu** toma todas las posibles parejas del conjunto especificado en el lugar x<sub>1</sub> y afirma la relación especificada en x<sub>2</sub>.
...
cmima
: x<sub>1</sub> es un miembro del conjunto x<sub>2</sub>
