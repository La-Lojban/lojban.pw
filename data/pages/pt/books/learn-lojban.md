...
Lojban utiliza o alfabeto latino (as vogais estão coloridas):
...
<td> como em <i>v<u>au</u></i></td></tr>
<tr>
<td><b class="audio-inline"><font color="#FF1493" class="guibutton">ai</font></b></td>
<td> como em <i>al<u>ai</u>de</i></td></tr>
<tr>
<td><b class="audio-inline"><font class="guibutton"color="#FF1493">ei</font></b></td>
<td> como em <i>el<u>ei</u>tro</i></td></tr>
<tr>
<td><b class="audio-inline"><font class="guibutton" color="#FF1493">oi</font></b></td>
<td> como em <i>m<u>oi</u>do</i></td></tr>
</tbody></table>

Quanto às consoantes, são pronunciadas como em inglês ou latim, mas há várias diferenças:

<table>
<tbody><tr>
<td><span class="audio-inline"><b class="guibutton">c</b></span>
</td>
<td>é pronunciado como o <i>c</i> em <i>casa</i>, como o <i>sh</i> em <i>ashá</i>, como o <i>tch</i> em português
</td></tr>
<tr>
<td><span class="audio-inline"><b class="guibutton">g</b></span>
</td>
<td>sempre é <i>g</i> como em <i>goiaba</i> (nunca <i>g</i> como em <i>gema</i>).
</td></tr>
<tr>
<td><span class="audio-inline"><b class="guibutton">j</b></span>
</td>
<td>como o <i>s</i> em <i>prazer</i> ou <i>tesouro</i>, ou como o <i>j</i> em francês, em <i>Bonjour</i>. 
</td></tr>
<tr>
<td><span class="audio-inline"><b class="guibutton">x</b></span>
</td>
<td>como o <i>ch</i> em inglês, em <i>church</i>, ou como o <i>j</i> em alemão, em Bach. Lembre-se de pronunciar <i>ksss</i> enquanto mantém a língua pressionada e você obterá esse som.
</td></tr>
<tr>
<td><span class="audio-inline"><b class="guibutton"> ' </b></span>
</td>

<td>como o <i>h</i> em inglês. Assim, o apóstrofo é considerado uma letra própria de Lojban e pronunciado como um <i>h</i>. Ele só pode ser encontrado entre vogais. Por exemplo, <b>u'i</b> é pronunciado como <i>oo-hee</i> (enquanto <b>ui</b> é pronunciado como <i>wee</i>).
</td></tr>
<tr>
<td><span class="audio-inline"><b>.</b></span>
</td>
<td>um ponto final (ponto, pausa na palavra) também é considerado uma letra em Lojban. É uma breve pausa na fala para evitar que as palavras se fundam. Na verdade, qualquer palavra que comece com uma vogal tem um ponto final na frente. Isso ajuda a evitar a fusão indesejável de duas palavras sequenciais em uma.
</td></tr>
<tr>
...
<ul><li><b>ia</b> é pronunciado como <i>ya</i> em <i>yarda</i></li>
<li><b>ie</b> é pronunciado como <i>ye</i> em <i>yessi</i></li></ul>
</td></tr>
<tr>
...
<ul><li><b>ua</b> é pronunciado como <i>wo</i> em <i>wowdy</i></li>
<li><b>ue</b> é pronunciado como <i>whe</i> em <i>wheno</i></li></ul>
</td></tr></tbody></table>

O acento é colocado na penúltima vogal. Se uma palavra tiver apenas uma vogal, ela não é acentuada.

A letra **r** pode ser pronunciada como o _r_ em inglês, escocês, russo, portanto, há uma variedade de pronúncias aceitáveis para ela.

Vogais não-Lojban, como o _i_ e o _u_ curtos em inglês britânico padrão _hit_ e _but_, são usadas por algumas pessoas para separar consoantes. Então, se você tiver dificuldade em pronunciar duas consoantes seguidas (por exemplo, o **vl** em **tavla**, que significa _falar com_), você pode dizer _tavɪla_ - onde o _ɪ_ é muito curto. No entanto, outras vogais como **a** e **u** devem ser longas.
...
> **mi ca cu tavla do**
> _Agora eu falo com você._

ca
: agora

Cada frase em Lojban é constituída pelas seguintes partes da esquerda para a direita:
...
- o separador de cabeça **cu**:
  - pronunciado como sapato, uma vez que **c** é para _sh_,
  - mostra que a cabeça terminou,
  - pode ser omitido quando fica claro que a cabeça está concluída.
- a cauda:
  - a construção principal de relação (**tavla**, **prami**) com possivelmente um ou mais termos depois dela,
...
Em Lojban, normalmente falamos de relações em vez de substantivos e verbos.
...
<tbody>
<tr>
<td><b>prenu</b> — <i>ser pessoa</i> </td>
...
Também podemos dizer que **le** cria um substantivo a partir de uma construção de relação com o significado aproximado de _aquele que é…_ (_é uma pessoa_ — _a pessoa_), ou ainda _aqueles que fazem…_ (_falar com_ — _os falantes_), _aqueles que são…_ (_são pessoas_ — _as pessoas_).

Observe que, por padrão, o Lojban não diferencia entre _o falante_ ou _os falantes_. Ou seja, **le tavla** é vago nesse sentido, e logo descobriremos maneiras de definir o número.

Termos em Lojban, independentemente de onde são usados na frase, são na maioria das vezes representados por:

- substantivos como **le prenu** (_a pessoa_)
- pronomes como **mi** (_eu_, _me_), **do** (_você_). Os pronomes funcionam exatamente como os substantivos, mas **le** não é usado para eles. Eles funcionam como substantivos por si só.
...
nintadni
:… (alguém) é um novo aluno, um novato

<pixra url="/assets/pixra/cilre/nintadni.webp" caption="mi nintadni" definition="Eu sou um novo aluno, um calouro."></pixra>

Ao contrário do inglês, não precisamos adicionar o verbo "ser/estar" à frase. Já está implícito. A palavra de relação **nintadni** (_… é um novo aluno_) já possui esse "ser/estar" embutido em sua tradução em inglês.
...
<pixra url="/assets/pixra/cilre/karce.webp" caption="karce" definition="Isso é um carro."></pixra>

> **karce**
> _Carro!_
> _Isso é um carro._

Você poderia dizer isso quando vê um carro vindo. Aqui o contexto seria claro o suficiente de que há um carro em algum lugar por perto e provavelmente é perigoso.

**karce** em si é um verbo que significa _é um carro, ser um carro_.

Claro que podemos ser mais precisos e dizer, por exemplo:
...
<pixra url="/assets/pixra/cilre/carvi.webp" caption="carvi" definition="… é uma chuva"></pixra>
...
Observe que em Lojban não há necessidade da palavra _it_ neste sentido. Apenas use a palavra de relação necessária.
...
<pixra url="/assets/pixra/cilre/pinxe_le_djacu.webp" caption="le prenu cu pinxe le djacu" definition="A pessoa bebe água."></pixra>
...
Feche a parte da tabela da direita. Traduza as frases do lado esquerdo do lojban.
...
Colocamos a pequena palavra **.i** para separar toda frase consecutiva:

> **mi tavla le prenu .i le prenu cu tavla mi**
> _Estou falando com as pessoas. As pessoas estão falando comigo._

**.i** separa frases como o ponto final ao final de frases em textos em inglês.

Ao dizer uma frase após a outra em inglês, fazemos uma pausa (pode ser curta) entre elas. Mas a pausa tem muitos significados diferentes no inglês. No lojban, temos uma maneira melhor de entender onde uma frase termina e outra começa.
...
**le** simplesmente transforma um verbo em um substantivo, mas tal substantivo não tem número associado a ele. A sentença

> **le prenu cu tavla mi**
> _As pessoas conversam comigo._
> _A pessoa conversa comigo._

não especifica o número de pessoas conversando comigo. Em inglês, é impossível omitir o número porque _people_ em inglês implica _mais de uma pessoa_. No entanto, em Lojban, você pode omitir o número mesmo que seja plural.

Agora, vamos especificar quantas das pessoas são relevantes para a nossa discussão.
...
Adicionamos um número após **le** e, portanto, especificamos pessoas individuais.

Para números com vários dígitos, apenas juntamos esses dígitos:

> **le re mu prenu cu tavla mi**
> _As 25 pessoas conversam comigo._
...
O número **za'u** significa _mais do que …_ (_\>_ em matemática), o número **me'i** significa _menos do que_ (_<_ em matemática):
...
> _Mais de três pessoas conversam comigo._
...
**za'u** por padrão significa **za'u pa**, assim tal contração é possível.
...
Verbo composto (**le tanru** em Lojban) é quando várias palavras verbais são colocadas uma após a outra.
...
<pixra url="/assets/pixra/cilre/dansu.webp" caption="le prenu cu melbi dansu" definition="A pessoa dança de forma agradável."></pixra>

> **do melbi dansu**
> _Você dança de forma agradável._

Aqui, o verbo **melbi** adiciona outro significado, pois é colocado à esquerda de outro verbo: **zdani**. A parte esquerda geralmente é traduzida usando adjetivos e advérbios.

Verbos compostos são um recurso poderoso que produz significados mais ricos. Você simplesmente coloca dois verbos juntos, e a parte esquerda do verbo composto adiciona um sabor ao direito.

Podemos colocar **le** (por exemplo, com um número) à esquerda do verbo composto para obter um substantivo composto:

le pa melbi zdani
: a casa bonita

Agora você sabe por que havia **cu** depois dos substantivos em nosso exemplo:

> **le pa prenu cu tavla mi**
> _A pessoa fala comigo._

Sem **cu** isso se transformaria em **le pa prenu tavla**, que teria o significado de _a pessoa-falante_ - o que quer que isso possa significar.
...
> _Quem fala é um amigo._

Lembre-se de colocar **cu** antes da construção principal de relação em uma frase para evitar a criação não intencional de verbos compostos.

Verbos compostos podem conter mais de dois verbos. Nesse caso, o primeiro modifica o segundo, o segundo modifica o terceiro e assim por diante:

<pixra url="/assets/pixra/cilre/cmalu_karce.webp" caption="ti cmalu karce" definition="Esta é um carro pequeno."></pixra>
...
Feche a parte direita da tabela. Traduza as frases da esquerda para o Lojban.
...
Feche a parte direita da tabela. Traduza as frases da esquerda para Lojban.

<table style="table-layout: fixed;">

<tbody><tr>
<td><i>Isto é um carro pequeno.</i>
</td>
...
> _Não é verdade que eu gosto de cachorros._
> _Eu não gosto de cachorros._
<!-- -->
> **mi na ku nelci do**
...
<td><i>Você vai para o mercado?</i>
</td></tr>
<tr>
...
<tr>
<td><i>O cachorro ama você?</i>
</td>
<td><b>xu le gerku cu prami do</b>
</td></tr></tbody></table>
### Felicidade e pedidos educados: ‘_Yay!_’ = «**ui**», ‘_Por favor!_’ = «**.e'o**»

A interjeição **ui** demonstra a felicidade de quem está falando. É usada como o rosto sorridente ‘_:)_’ na comunicação, para indicar que você está feliz com algo. Embora os emojis possam ser ambíguos, **ui** tem apenas um significado, o que é conveniente.

> **ui do klama**
> _Yay, você está vindo!_

ui
: interjeição: _Uhul!_, interjeição que expressa felicidade
...
.e'o
: interjeição: por favor (pronunciada como _ê-ó_ com uma pequena pausa ou quebra antes da palavra)
...
Feche a parte direita da tabela. Traduza as frases à esquerda para o Lojban.

le tcati
: o chá

<pixra url="/assets/pixra/cilre/tcati.webp" caption="tcati" definition="... é algum chá"></pixra>

le ckafi
: café

<pixra url="/assets/pixra/cilre/ckafi.webp" caption="ckafi" definition="... é algum café"></pixra>
...
<pixra url="/assets/pixra/cilre/do_e_mi_nintadni.webp" caption="do .e mi nintadni" definition="Você e eu somos novatos."></pixra>
...
.i je
: conjunção "e" combinando sentenças em uma.

.e
: conjunção "e" conectando substantivos.

gi'e
: conjunção "e" conectando caudas de sentenças.

Podemos combinar duas sentenças em uma declaração usando a conjunção **.i je**, que significa _e_:

> **do nintadni .i je mi nintadni**
> _You are a newbie. And I am a newbie._

Como ambas as sentenças têm a mesma cauda, podemos usar uma contração: a conjunção **.e** significa _e_ para substantivos e pronomes:
...
Ambas estas sentenças significam a mesma coisa:
...
<pixra url="/assets/pixra/cilre/pinxe_le_jisra.webp" caption="le prenu cu pinxe le jisra" definition="A pessoa bebe suco."></pixra>

Se a cabeça da sentença é a mesma, mas as caudas diferem, usamos a conjunção **gi'e**, que significa _e_ para caudas de sentenças:
...
ti
: este objeto, este lugar perto de mim

**je** é uma conjunção em Lojban que significa _e_ em verbos compostos.

Sem o **je**, a sentença muda de significado:

> **le melbi cmalu zdani cu jibni**
> _A bela casa pequena está perto._

Aqui, **melbi** modifica **cmalu**, e **melbi cmalu** modifica **zdani**, de acordo com o funcionamento dos verbos compostos.

Em **le melbi je cmalu zdani **(_a bela casa pequena_), tanto **melbi** quanto **cmalu** modificam diretamente **zdani**.

Outras conjunções comuns incluem:

> **le verba cu fengu ja bilma**
> _A criança está irritada ou doente (ou talvez esteja irritada e doente)_
...
.o nai
: ou ... ou ... mas não ambos (ao conectar substantivos e pronomes)

laldo
: ... é velho

Note: é melhor lembrar **jo nai** como uma construção única, e o mesmo para **.o nai**.
...
.u
: quer goste ou não ... (ao conectar substantivos e pronomes)
...
Se eu digo **do .e mi casnu le bangu**, pode significar que você discute a linguagem e eu discuto a linguagem. Mas isso não necessariamente significa que estamos na mesma conversa!

Isso pode ficar mais visível se expandirmos isso usando **.i je**:
...
Na verdade, em inglês, _but_ é o mesmo que _and_, e acrescenta um sabor de contraste.
...
> `Noite é um evento quando eu vejo a Lua.`

nicte
: (algum evento) é à noite
...
Aqui, **le nicte** é um substantivo na frase e **nu mi viska le lunra** é a principal relação da frase. No entanto, dentro dessa relação principal, podemos ver outra relação: **mi viska le lunra** incorporada!
...
kansa ⇒ le nu kansa
: ...estar junto com... ⇒ o estar junto

klama ⇒ le nu klama
: vir para... ⇒ a vinda

le nu do klama
: a sua vinda, você vindo

**le nu** corresponde frequentemente a _\-ing_, _\-ção_, _\-são_ em inglês.
...
gleki
: ...está feliz (por algum evento)

<pixra url="/assets/pixra/cilre/gleki.webp" caption="gleki" definition="… está feliz com o evento ..."></pixra>


Alguns substantivos descrevem eventos por si mesmos, então não se usa **le nu**:

> **le cabna cu nicte**
> _Agora é noite. Atualmente é noite._

le cabna
: o tempo presente, o evento atual.

Substantivos feitos com **le nu** podem ser usados para verbos que descrevem eventos por si mesmos:
...
- partículas (chamadas **le cmavo** em Lojban). Exemplos: **le**, **nu**, **mi**
- verbos (chamados **le selbrivla** em Lojban). Exemplos: **gleki**, **klama**.
  É bastante comum escrever várias partículas juntas, sem espaços entre elas. Isso é permitido pela gramática Lojban. Então, não se surpreenda ao ver **lenu** em vez de **le nu**, **naku** em vez de **na ku**, **jonai** em vez de **jo nai** e assim por diante. Isso não altera o significado. No entanto, isso não se aplica a verbos: eles devem ser separados com espaços.
...
<td><i>Gosto de você dançando.</i>
</td></tr>
<tr>
<td><b>xu do gleki le nu do pilno le skami</b>
</td>
<td><i>Você está feliz por usar computadores?</i>
</td></tr>
<tr>
...
<tr>
<td><i>Eu quero que você esteja feliz.</i>
</td>
<td><b>mi djica le nu do gleki</b>
</td></tr></tbody></table>

### Termos modais. Tempos simples: ‘_foi_’, ‘_é_’, ‘_será_’ — «**pu**», «**ca**», «**ba**»

Em Lojban, expressamos o tempo quando algo acontece (gramaticalmente, em inglês, geralmente é chamado de _tense_) com termos modais. Já vimos o termo modal **ca** que significa _atualmente_.
...
> _As pessoas estão falando comigo (atualmente)._
...
Quando depois da partícula relacionada ao tempo nós colocamos um substantivo simples, então formamos um termo com um significado um pouco diferente:

> **mi pinxe le djacu ca le nu do klama**
> _Eu bebo a água enquanto você está vindo._

A parte **ca le nu do klama** é um longo termo que significa _enquanto você vem / enquanto você está vindo_. O **le nu do klama** é um substantivo que significa **vindo de você, sua vinda**.

> **mi citka ba le nu mi dansu**
> _Eu como depois que eu danço._

As partículas relacionadas ao tempo são agrupadas em séries de acordo com o seu significado para torná-las mais fáceis de lembrar e usar.

Palavras para tempos simples:

- **pu** significa _antes de ... (algum evento)_, **pu** sozinho denota o tempo passado.
...
Tempos adicionam informações sobre o tempo em que algo acontece. O inglês nos obriga a usar certos tempos. É preciso escolher entre
...
Mas em Lojban, as partículas relacionadas aos tempos são opcionais, podemos ser tão vagos ou tão precisos quanto quisermos.
...
na verdade não diz nada sobre quando isso acontece. O contexto é claro o suficiente na maioria dos casos e pode nos ajudar. Mas se precisarmos de mais precisão, é só adicionar mais palavras.

Da mesma forma, **ba** significa _depois de ... (algum evento)_ então quando dizemos **mi ba cu citka** queremos dizer que comemos depois do momento de falar, é por isso que significa _eu vou comer_.

Podemos combinar partículas de tempo com e sem argumentos substantivos depois delas:

> **mi pu cu citka le plise ba le nu mi dansu**
> _Eu comi as maçãs depois que eu dancei._

Observe que o termo **pu** (tempo passado) é colocado apenas na relação principal (**mi pu cu citka**). Em Lojban, supõe-se que o evento _eu dancei_ ocorre em relação ao evento de comer.
...
Para dizer _será agradável_, devemos usar o termo de tempo passado:

> **le nicte ba cu pluka**
> _A noite será agradável._

Também note que adicionar um substantivo após uma partícula relacionada ao tempo pode levar a um significado drasticamente diferente:
...
Ambas as frases significam o mesmo, **ba pluka** é uma construção de relação que significa _... será agradável_.

A estrutura de **le nicte ba pluka** é a seguinte:

- **le nicte** - cabeça da frase com apenas um termo **le nicte**
- **ba pluka** - cauda da frase com apenas um verbo **ba pluka**

Compare isso com a frase anterior **le nicte ba cu pluka**:

- **le nicte ba** - cabeça da frase com dois termos **le nicte** e **ba**
- **pluka** - cauda da frase com apenas um verbo **pluka**

A vantagem de **le nicte ba pluka** sobre **le nicte ba cu pluka** é apenas na concisão; você pode geralmente omitir a palavra **cu** em tais casos, já que a frase não pode ser entendida de outra forma mesmo.

Se desejar colocar um termo modal antes de um substantivo, você pode separá-lo do texto seguinte explicitamente "terminando" o termo com a palavra auxiliar **ku**:
...
Uma última observação: as definições em inglês das palavras Lojban podem usar tempos verbais mesmo quando as palavras Lojban originais não os implicam, por exemplo:
...
Embora _fala_, _é_ etc. estejam no tempo presente (nem sempre é possível eliminar o tempo nos verbos em inglês, porque é assim que o inglês funciona), devemos sempre assumir que o tempo não está implícito no significado das palavras Lojban definidas, a menos que a definição em inglês dessas palavras mencione explicitamente essas restrições temporais.
...
A maioria dos verbos descreve eventos sem especificar a fase desses eventos. Os contornos de evento nos permitem ser mais precisos:
...
co'a cikna
: … acorda, torna-se desperto

pu co'a cikna
: … acordou, tornou-se desperto
...
<pixra url="/assets/pixra/cilre/sipna.webp" caption="le prenu ca'o sipna" definition="A pessoa está dormindo."></pixra>
...
> _Eu cheguei na estação._

le tcana
: a estação

<pixra url="/assets/pixra/cilre/mohu_klama_le_tcana.webp" caption="le prenu mo'u klama le tcana" definition="A pessoa chegou na estação."></pixra>

**co'i** geralmente corresponde ao tempo perfeito em inglês:

> **le verba ca co'i pinxe le jisra**
> _As crianças tomaram o suco._

Podemos omitir **ca** nessas frases, pois o contexto seria claro o suficiente na maioria desses casos.
...
A ordem relativa das partículas relacionadas ao tempo é importante. Em **ca co'i**, primeiro dizemos que algo acontece no presente (**ca**), então afirmamos que, neste momento presente, o evento descrito foi concluído (**co'i**). Somente ao usar essa ordem obtemos o tempo presente perfeito.

Avisos modais. Intervalos: '_durante_' — «**ze'a**»
...
> _Eu dormi a noite inteira. Eu dormi toda a noite._

Nota: não podemos elidir o **cu** aqui, pois **nicte sipna** (_... é um dorminhoco noturno_) é um tanru e levaria a outro significado (se bem que estranho).
...
Observe que **nicte** é um evento em si, então não precisamos de **nu** aqui.
...
<pixra url="/assets/pixra/cilre/ri'a.webp" caption="ri'a" definition="porque ... (devido a algum evento)"></pixra>
...
Partículas modais que denotam lugar funcionam da mesma forma:

> **mi cadzu fa'a do to'o le zdani**
> _Eu caminho na sua direção, longe da casa._

Observe que, ao contrário de **klama**, as partículas modais **fa'a** e **to'o** denotam direções, não necessariamente o início ou fim da rota. Por exemplo:

> **le prenu cu klama fa'a do**
> _A pessoa vem em sua direção._

significa que a pessoa está simplesmente se movendo em sua direção, mas não necessariamente em sua direção (talvez para algum lugar ou pessoa próxima a você).
...
to'o
: de ..., a partir da direção de ...

bu'u
: em ... (algum lugar)

Nota: **nu** mostra que uma nova frase embutida começa dentro da frase principal. Colocamos **kei** depois de tal relação para mostrar sua borda direita, semelhante a como usamos ")" ou "]" na matemática. Por exemplo:
...
Parênteses _(_ e _) _ são usados aqui apenas para mostrar a estrutura; eles não são necessários em um texto Lojban normal.
...
No final do enunciado, **kei** nunca é necessário, pois já significa a borda direita.
...
> _Eu comi (depois de dançar) as maçãs._

Podemos rearranjar a frase movendo **ba le nu mi dansu** ao redor, desde que ele permaneça após **pu**.
...
zvati
: ...está presente em... (algum lugar ou evento), ...fica em... (algum lugar)
...
**le cmevla**, ou a _palavra de nome_, é um tipo especial de palavra usada para construir nomes pessoais. É fácil reconhecer le cmevla em um fluxo de texto, pois são as únicas palavras que terminam em uma consoante e são envolvidas por um ponto de cada lado.

Exemplos de le cmevla são: **.paris.**, **.robin.**

Se o nome de alguém é _Bob_, então podemos criar um cmevla por nós mesmos que soaria o mais próximo possível desse nome, por exemplo: **.bab.**
...
<pixra url="/assets/pixra/cilre/tcidu_la_lojban.webp" caption="a pessoa está lendo." definition="The person is reading."></pixra>

**la** é semelhante a **le**, mas converte uma palavra em um nome em vez de um simples substantivo.

Em inglês, iniciamos uma palavra com letra maiúscula para mostrar que é um nome. Em Lojban, usamos o prefixo da palavra **la**.

Sempre use **la** ao produzir nomes!

Um nome pode consistir em vários le cmevla um após o outro:

> **la .bab.djansyn. cu tcidu**
> _Bob Johnson lê/está lendo._

Aqui, separamos os dois le cmevla com apenas um ponto, o que é suficiente.

É comum omitir pontos na frente e no final de le cmevla para escrever textos mais rapidamente, por exemplo, quando se está textando. Afinal, le cmevla ainda são separados de palavras adjacentes por espaços ao redor deles:
...
> `Eu uso Lojban para me comunicar.`
...
Observe como o nome é pronunciado nativamente. Como resultado, os nomes em inglês e francês _Robert_ ficam diferentes em Lojban: o nome em inglês é **.robyt.** no inglês britânico, ou **.rabyrt.** em alguns dialetos americanos, mas o francês é **.rober.**
...
* São necessários mais dois pontos finais porque se não houver essas pausas na fala, pode se tornar difícil saber onde começa e termina o nome, ou em outras palavras, onde a palavra anterior termina e a próxima começa.
* A última letra de um cmevla deve ser uma consoante. Se um nome não terminar em consoante, normalmente adicionamos um **s** no final; então em Lojban, _Mary_ se torna **.meris.**, _Joe_ se torna **.djos.**, e assim por diante. Alternativamente, podemos deixar a última vogal de fora, então _Mary_ se tornaria **.mer.** ou **.meir**.
* Também é possível colocar um ponto final entre o primeiro e sobrenome de uma pessoa (embora não seja obrigatório), então _Jim Jones_ se torna **.djim.djonz.**
...
- consoantes:
  ...
  - **.** (ponto, separador de palavras)

Para criar um nome em Lojban, siga estas regras:

1. o nome deve terminar em uma consoante, exceto **'**. Se não acontecer, adicione uma consoante no final por conta própria. Além disso, envolva-o de pontos de cada lado: **.lojban.**.
2. vogais podem apenas ser colocadas entre duas consoantes: **.sam.**, **.no'am.**
3. consoantes duplas são fundidas em uma: _dd_ se torna **d**, _nn_ se torna **n**, etc. Ou um **y** é colocado entre elas: **.nyn.**
4. se uma consoante sonora e uma surda estiverem próximas, insira um **y** entre elas: **kv** se torna **kyv**. Você também pode remover uma das letras: **pb** pode ser transformado em um único **p** ou um único **b**.
5. se um de **c**, **j**, **s**, **z** estiverem próximos, insira um **y** entre eles: **jz** se torna **jyz**. Você também pode remover uma das letras: **cs** pode ser transformado em um único **c** ou um único **s**.
6. se **x** estiver próximo a **c** ou próximo a **k**, insira um **y** entre eles: **cx** se torna **cyx**, **xk** se torna **xyk**. Você também pode remover uma das letras: **kx** pode ser transformado em um único **x**.
7. os substrings **mz**, **nts**, **ntc**, **ndz**, **ndj** são corrigidos adicionando um **y** dentro ou excluindo uma das letras: **nytc** ou **nc**, **.djeimyz.**
...
10. o som para o "h" em inglês, como em Harry, pode ser deixado de fora ou substituído por **x**. _Harry_ pode se tornar **.aris.** ou **.xaris.**

### Palavras de relação como nomes

Você pode escolher um apelido divertido em Lojban usando não apenas cmevla, mas também palavras de relação. Você também pode traduzir seu nome atual para Lojban se souber o que significa, ou escolher um nome em Lojban completamente novo.
...
<tr>
<td>Mei Li</td>
<td><i>bonito</i> em chinês mandarim</td>
<td><b>le melbi</b></td>
<td><i>os bonitos</i></td>
<td><b>la melbi</b>
</td></tr></tbody></table>

### ‘_ele_’ ‘_ela_’

Lojban não possui palavras distintas para _ele_ ou _ela_. Soluções possíveis:

le ninmu
: a mulher (no sentido de gênero)

<pixra url="/assets/pixra/cilre/ninmu.webp" caption="le ninmu" definition="a mulher (humana fêmea)"></pixra>

le nanmu
: o homem (no sentido de gênero)

<pixra url="/assets/pixra/cilre/nanmu.webp" caption="le nanmu" definition="o homem (humano macho)"></pixra>

> **le ninmu cu tavla le nanmu .i le ninmu cu jatna**
> _A mulher conversa com o homem. Ela é uma líder._
...
> _Eu fui para o campo. Ele/ela foi bonito(a)._
...
> _Eu converso com o amigo. Ele/Ela é atencioso(a)._
...
Aqui, **ri** ignora o pronome anterior **mi** e, portanto, se refere a **le prenu**, que é o substantivo/pronome anterior disponível.

### Apresentando-se. Vocativos

Em Lojban, os _vocativos_ são palavras que se comportam como interjeições (como **xu** que discutimos anteriormente), mas exigem que o substantivo seguinte seja anexado a elas:
...
Nós usamos **coi** seguido de um substantivo ou pronome para cumprimentar alguém.
...
<pixra url="/assets/pixra/cilre/coho.webp" caption="co'o do" definition="Adeus a você!"></pixra>

<div class="common"></div>

> **coi ro do**
> _Olá a todos!_
> `Olá para cada um de vocês`

- é como as pessoas normalmente começam uma conversa com várias pessoas. Outros números são possíveis, é claro: **coi re do** significa *Olá, vocês dois* etc.
...
Nota: em inglês, _Goodnight!_ significa _Goodbye!_ ou denota desejar que alguém tenha uma boa noite. Pelo seu significado, _Goodnight!_ não faz parte da série de cumprimentos acima. Assim, usamos uma terminologia diferente em Lojban:
...
Claro que podemos ser vagos dizendo apenas **pluka nicte** (apenas significando _noite agradável_ sem qualquer desejo explicitamente dito).

O vocativo **mi'e** + um substantivo/pronome é usado para se apresentar:

> **mi'e la .doris.**
> _Eu sou Doris. Aqui é a Doris falando._
...
> _Estou partindo, Robert._

cliva
: partir (de algo ou alguém)

Sem o **doi**, o nome pode se tornar o primeiro substantivo da relação:

> **mi cliva la .robert.**
> _Estou deixando Robert._

**doi** é como o "O" do inglês arcaico (como em "Ó vós da pouca fé") ou o vocativo do latim (como em "Et tu, Brute"). Algumas línguas não distinguem entre esses contextos, embora, como você pode ver, o inglês antigo e o latim o façam.

Dois vocativos a mais são **ki'e** para dizer obrigado e **je'e** para aceitá-los:
...
Podemos omitir o substantivo após o vocativo somente se ele estiver no final da frase. Por exemplo, podemos simplesmente dizer:
...
Assim, se você não sabe o nome do ouvinte e quer continuar a mesma frase após o vocativo, você simplesmente coloca **do** depois dele.

Se você usar o vocativo sozinho (sem um substantivo depois dele) e a frase ainda não estiver terminada, então você precisa separá-lo do resto. Isso ocorre porque as coisas que são mais propensas a seguir o vocativo em uma frase podem ser facilmente interpretadas como descrevendo o seu interlocutor. Para separá-lo do substantivo/pronome seguinte, use a palavra **do**. Por exemplo,
...
> _Yay, Olá! Alice saiu de Doris._
...
Portanto, uma interjeição imediatamente após um vocativo modifica esse vocativo. Da mesma forma, uma interjeição modifica o substantivo vocativo quando colocada depois dele:
...
Esses $x_1$, $x_2$ e assim por diante são chamados de _lugares_, _papéis da relação_ ou _argumentos_ e representam a ordem em que colocamos substantivos ou pronomes na frase. Por exemplo:
...
- $x_1$ denota _quem ama_, e
- $x_2$ denota _quem é amado por_.

Em outras palavras, cada relação tem um ou mais papéis, e esses papéis são especificados e rotulados como $x_1$, $x_2$ e assim por diante. Nós colocamos substantivos e pronomes em ordem, preenchendo esses papéis e dando um significado concreto à relação, formando assim uma frase.
...
A frase significa que minha casa está simplesmente localizada na direção da montanha, mas não necessariamente significa que quero chegar a essa montanha. O destino final de minha chegada não é necessariamente a montanha, mas a casa.
...
A ordem dos argumentos dos verbos compostos é a mesma do último verbo na frase:
...
Neste caso, existem três lugares, e se você quiser excluir o segundo lugar no meio, você tem que usar **zo'e**:
...
O inglês usa um conjunto limitado de preposições que são reutilizadas em vários verbos e, portanto, não têm um significado fixo. Por exemplo, considere a preposição inglesa _to_:
...
Em cada um desses exemplos, _to_ tem um novo papel que, na melhor das hipóteses, é remotamente similar aos papéis em outras frases.

É importante observar que outras línguas usam diferentes maneiras de marcar os papéis dos verbos que, em muitos casos, são muito diferentes dos usados em inglês.

O Lojban, por exemplo, marca papéis centrais de relações por meio da definição completa dessas relações com os papéis colocados em sequência (ou marcados com **fa**, **fe** e assim por diante):
...
melbi
: $x_1$ é bonito, agradável para $x_2$...

Tais papéis centrais são essenciais para definir relações.

No entanto, pode haver papéis opcionais que tornam as relações mais precisas:

> _Eu falo com você enquanto como._
<!-- -->

> _Para mim é difícil porque esta coisa é pesada._

No Lojban, uma noção semelhante de papéis opcionais é expressa por meio de relações separadas ou, para a maioria dos casos comuns, com termos modais:
...
Preposições em inglês são semelhantes a partículas modais no Lojban, embora uma preposição em inglês usual possa ter muitos significados, enquanto no Lojban cada partícula modal tem apenas um significado (mesmo que vago).
### Regras gerais na ordem dos argumentos

A ordem dos lugares em verbos pode ser às vezes difícil de lembrar, mas não se preocupe - você não precisa lembrar todos os lugares de todos os verbos. (Você se lembra do significado de centenas de milhares de palavras em inglês?)
...
Normalmente, você pode adivinhar a ordem usando o contexto e algumas regras:

1. O primeiro lugar geralmente é a pessoa ou coisa que faz algo ou é algo:

    **klama** = _$x_1$ vai..._

2. O objeto de alguma ação é geralmente logo após o primeiro lugar:
...
4. Os lugares de destino (_para_) quase sempre vêm antes dos lugares de origem (_de_):
    ...
    **klama** = _$x_1$ vai para $x_2$ a partir de $x_3$_

    <pixra url="/assets/pixra/cilre/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="A pessoa sai da loja."></pixra>

5. Lugares menos usados vêm em direção ao fim. Esses tendem a ser coisas como _por padrão_, _por meio_ ou _feita de_.


A ideia geral é que os primeiros lugares a serem usados são os mais prováveis.
...
Os infinitivos são verbos que frequentemente são prefixados com _to_ em inglês. Exemplos incluem _I like to run_, com _to run_ sendo o infinitivo.
...
<pixra url="/assets/pixra/cilre/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="A criança está tentando andar."></pixra>

A partícula **ka** funciona muito como **nu**, mas indica que o substantivo à esquerda faz ou faria a ação após **ka**. Isso faz com que o primeiro substantivo do verbo externo (**troci** neste caso) seja também o primeiro substantivo omitido do verbo incorporado iniciado por **ka** (**cadzu** neste caso), assim você não precisa repetir esse substantivo na segunda vez.

Algumas vezes, verbos exigem apenas infinitivos em alguns de seus lugares. Definições dessas palavras marcam esses lugares como _propriedade_ ou **ka**. Por exemplo:

cinmo
: $x_1$ sente $x_2$ (ka)

Isso significa que o infinitivo no segundo lugar ($x_2$) é aplicado a algum lugar (provavelmente, o primeiro lugar, $x_1$). Casos em que o infinitivo é aplicado a lugares que não $x_2$ são raros e são explicados para os verbos correspondentes ou, no caso de verbos inventados informalmente, podem ser deduzidos pelo senso comum.

Observe que apenas o primeiro lugar vazio da relação incorporada assume o significado do lugar externo:
...
Aqui, o primeiro lugar vazio é o segundo lugar de **prami**, assim ele assume o valor **mi** (_eu_).

Também é possível, usando o pronome **ce'u**, marcar explicitamente um lugar que precisa ser aplicado a algum substantivo exterior:
...
> _Eu sinto como se alguém me odeie._
> _Eu sinto sendo odiado._
...
Esse _evento_ significa que você tem que preencher o lugar com um substantivo que represente um evento. Por exemplo:
...
No lojban, não é permitido dizer, por exemplo:

> **mi djica le plise**
> _Eu quero a maçã._ <div class="naldra"></div> 

porque você quer fazer algo com a maçã ou quer algum evento acontecendo com a maçã, como:
...
<pixra url="/assets/pixra/cilre/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="A pessoa quer o doce."></pixra>
...
A pequena palavra qualificadora chamada **tu'a** antes de um termo implica uma abstração (propriedade, evento ou proposição), mas seleciona apenas esse termo dessa abstração, pulando o restante. Pode ser vagamente traduzido como _algo sobre_:

> **mi stidi tu'a le barja**
> _Eu sugiro algo sobre o pub (talvez visitá-lo, encontrar-se perto dele, etc.)._
...
Na primeira frase, a palavra _que_ é essencial para identificar a pessoa em questão. Ela esclarece quem entre as pessoas no contexto estamos falando. Escolhemos apenas aquelas que são minhas amigas dentre provavelmente muitas pessoas ao redor. Talvez haja apenas uma pessoa ao redor que é minha amiga.

Quanto a _que incidentalmente é minha amiga_ da segunda frase, ela fornece apenas informações adicionais sobre a pessoa. Isso não nos ajuda a identificar a pessoa. Por exemplo, isso pode acontecer quando todas as pessoas ao redor são minhas amigas.
...
No Lojban, usamos **poi** para cláusulas relativas que identificam entidades (objetos, pessoas ou eventos) e **noi** para informações incidentais.
...
Por outro lado, cláusulas relativas com **noi** contêm apenas informações adicionais sobre o substantivo ao qual estão anexadas. Esse substantivo é suficientemente definido por si só, de modo que a remoção de uma cláusula relativa com **noi** não muda seu significado:

> **mi nelci la .doris. noi mi ta'e zgana bu'u le panka**
> _Eu gosto de Doris, a quem eu vejo habitualmente no parque._
> _Eu gosto de Doris. O que mais posso dizer sobre ela? Eu costumo vê-la no parque._

zgana
: observar (usando quaisquer sentidos)

<pixra url="/assets/pixra/cilre/panka_ninmu.webp" caption="le prenu noi mi ta'e zgana bu'u le panka" definition="A pessoa que eu vejo habitualmente no parque."></pixra>

Remover a cláusula relativa com **noi** mantém o significado: _Eu gosto de Doris._

No inglês falado, a distinção frequentemente é alcançada por meio da entonação ou por adivinhação. Além disso, cláusulas relativas com **noi** são tradicionalmente separadas por vírgulas em inglês. Elas usam _which_ ou _who_, e a palavra _that_ não é usada nelas.
...
> _A árvore, à qual eu vou, é grande._

Observe a palavra **ke'a**. Movemos a segunda frase sobre a mesma árvore para uma cláusula relativa e substituímos o substantivo **le tricu** por **ke'a** na cláusula relativa. Portanto, o pronome **ke'a** é como _quem_ e _que_ em inglês. Ele se refere ao substantivo ao qual a cláusula relativa está ligada.

Literalmente, nossa frase em Lojban soa como

> _A árvore, tal que eu vou para a qual, é grande._

**ke'a** pode ser omitido se o contexto for suficiente. As duas frases seguintes têm o mesmo significado:

> **le prenu poi pendo mi cu tavla mi**
> **le prenu poi ke'a pendo mi cu tavla mi**
> _A pessoa que é amiga minha fala comigo._

**ke'a** geralmente é assumido para preencher o primeiro espaço vazio:

> **mi nelci la .doris. noi mi ta'e zgana bu'u le panka**
> **mi nelci la .doris. noi mi ta'e zgana ke'a bu'u le panka**
> _Eu gosto da Doris, a quem eu vejo habitualmente no parque._

Aqui, **mi** preenche o primeiro espaço do verbo **ta'e zgana** (_...vejo habitualmente..._), portanto, **ke'a** é assumido para o próximo, segundo espaço.

Cláusulas relativas, assim como relações usuais, podem conter construções com termos modais:
...
Por fim, **voi** é usado para formar substantivos semelhantes a **le**, mas com cláusulas relativas:

> **ti voi le nu ke'a cisma cu pluka mi cu zutse tu**
> _Estes, cujo sorriso me agrada, estão sentados._

<pixra url="/assets/pixra/cilre/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Eu gosto destes, cujos sorrisos me agradam."></pixra>
...
> _Dentre estes, aqueles cujo sorriso me agrada estão sentados._
...
> _Estes (que incidentalmente têm o sorriso que me agrada) estão sentados._

**noi** simplesmente adiciona informações incidentais que não são necessárias para determinar a que se refere **ti** (_estes_). Talvez não haja mais ninguém por perto para descrever.
...
> _Eu falo com Doris, que está sentada ali e em cima de Alice (que agora sorri)._

Observe a parte **zutse tu .e la .alis.**.

Para todos **poi**, **noi** e **voi**, o marcador de limite

### Cláusulas curtas relativas com "sobre"

Às vezes, você pode precisar anexar um substantivo ou pronome adicional a outro substantivo:

> **mi djuno le vajni pe do**
> _Eu sei de algo importante sobre você._
...
Observe que as cláusulas relativas estão conectadas a substantivos, enquanto **be** é parte do verbo.

Na verdade, **le bangu pe mi** é uma tradução melhor para _minha língua_, já que, assim como em inglês, os dois substantivos estão relacionados entre si de maneira vaga.

No entanto, você pode dizer **le birka be mi** como _meu braço_. Mesmo se você cortar o braço, ele ainda será seu. É por isso que **birka** tem um lugar do proprietário:
...
Em inglês, o verbo _is, are, to be_ faz um substantivo funcionar como um verbo. Em Lojban, até conceitos como _gato_ (**mlatu**), _pessoa_ (**prenu**), _casa_ (**dinju**), _lar_ (**zdani**) funcionam como verbos por padrão. Apenas pronomes funcionam como substantivos.
...
me
: … está entre ..., … é um dos ..., … são membros de ... (seguido de um substantivo)

> **la .alis. ta'e ctuca**
> _Alice ensina habitualmente._

ta'e
: partícula modal: o evento ocorre habitualmente
...
A partícula **me** leva um substantivo após ela e indica que provavelmente há outros professores e Alice é um deles.

A partícula **du** é usada quando Alice é, por exemplo, a professora que estávamos procurando ou falando. Isso indica identidade.

Assim, **me** e **du** às vezes podem corresponder ao que em inglês expressamos usando o verbo _to be/is/was_.

Em Lojban, priorizamos o significado do que pretendemos dizer, em vez de confiar em como é literalmente expresso em inglês ou em outras línguas.
...
> **mi du la .kevin.**
> _Sou Kevin (quem você precisava)._

<!-- -->

> **ti du la .alis. noi mi ta'e zgana bu'u le panka**
> _Esta é Alice que eu vejo habitualmente no parque._

**noi du** e **poi du** são usados para introduzir nomes alternativos para algo. Eles correspondem a _namely, i.e._ em inglês:

> **la .alis. cu penmi le prenu noi du la .abdul.**
> _Alice encontrou a pessoa, nomeadamente Abdul._

Quando se usa **me**, você pode conectar vários substantivos com _and_:
...
### Partículas modais dentro de nomes

Podemos colocar uma partícula modal não apenas antes da construção da relação principal da sentença, mas também no final dela, produzindo o mesmo resultado:
...
> _A leitura agora está complicada._
...
Quando não utilizamos **nu**, não temos relações de eventos. Nomes começam com **le** e terminam com seu verbo (seja um verbo simples ou composto, com construção **be** ou não). Assim, podemos colocar partículas de termo antes de um verbo em um nome apenas antes desse verbo:
...
Então **pu** pertence a **le kunti tumla** e **ca** pertence a **purdi** (como **le pu kunti tumla** não pode adicionar **ca** no final).

Isso não contradiz o uso de **be** após o verbo, pois, com **be**, você muda o verbo: **bangu be mi** é considerado um verbo.

Ter várias partículas modais em sequência não é um problema:
> **le pu ze'u kunti tumla ca purdi**
> _O que foi um deserto por muito tempo agora é um jardim._

ze'u
: termo modal: por muito tempo

Colocar partículas de termo depois de nomes os vincula a verbos externos:
...
### Novos substantivos de lugares do mesmo verbo
...
> **mi se plicru ti do**
> _Eu sou concedido isso por você._
...
Você pode querer mudar as coisas para enfatizar diferentes coisas, por exemplo, para mencionar as coisas mais importantes em uma frase primeiro. Então, os pares a seguir significam a mesma coisa:
...
le se plicru
: aqueles que são dados, destinatários de presentes

le te plicru
: aqueles objetos que são dados para uso, presentes

**te** troca os dois primeiros lugares dos verbos.

Como sabemos, quando adicionamos **le** na frente de um verbo, ele se torna um substantivo. Então

- **le plicru** significa _aqueles que podem caber no primeiro lugar de **plicru**_
- **le se plicru** significa _aqueles que podem caber no segundo lugar de **plicru**_
- **le te plicru** significa _aqueles que podem caber no terceiro lugar de **plicru**_

Assim, em Lojban, não precisamos de palavras separadas para _doador_, _destinatário_ e _presente_. Reutilizamos o mesmo verbo e economizamos muito esforço por causa desse design inteligente. De fato, não podemos imaginar um presente sem implicar que alguém o deu ou o dará. Quando fenômenos úteis estão interconectados, Lojban reflete isso.

Para facilitar a compreensão e memorização de palavras de predicado prefixadas com **se**, **te**, elas são colocadas no dicionário em entradas para muitos verbos junto com suas definições, embora você possa descobrir seu significado sozinho.

### Alterando outros lugares nas relações principais
...
> _Eu fiz a cadeira a partir do pedaço de madeira._

zbasu
: $x_1$ constrói, faz $x_2$ a partir de $x_3$
...
Da mesma forma que nosso exemplo com **le se plicru** (_o destinatário_) e **le te plicru** (_o presente_), podemos usar **te**, **ve**, **xe** para derivar mais palavras de outros lugares dos verbos:

klama
: $x_1$ vai para $x_2$ a partir de $x_3$ via $x_4$ por meio de $x_5$

Assim, podemos derivar que

le klama
: o que vai / os que vão
...
> _Eu concordo (com alguém) sobre visitar pais._
...
Com as tags de lugar, podemos mover os lugares:
...
- **le plise** = _a maçã_, colocamo-la no terceiro lugar de **plicru**, o que é dado
- **mi** = _eu_, colocamo-lo no segundo lugar de **plicru**, o destinatário.

Como podemos ver no último exemplo, não podemos refletir sequer a ordem das palavras em sua tradução em inglês.
...
Podemos usar tags de lugar dentro de substantivos colocando-as depois de **be**:

> **le pa klama be fi le tcadu cu pendo mi**
> _Aquele que vem à cidade é meu amigo._

---

Também podemos colocar todos os substantivos de uma relação principal na frente da cauda da sentença (preservando sua ordem relativa). Por causa dessa liberdade, podemos dizer:

> **mi do prami** o que é o mesmo que
> **mi do cu prami** o que é o mesmo que
> **mi prami do**
> _Eu te amo._
...
> _Existe alguém que é meu amigo e fala consigo mesmo._
...
> _Existe alguém que é meu amigo, por quem eu os amo._

Como **da** é usado apenas uma vez, podemos ser tentados a eliminar o prenex. Mas como lidar com a oração relativa **poi pendo mi** (_que é meu amigo_)?
...
Substantivos que começam com números como **pa le pendo** (_há alguém que é meu amigo_), **ci le prenu** (_há três pessoas_) podem se referir a novas entidades sempre que são usados. É por isso que

> **pa le pendo be mi ca tavla pa le pendo be mi**
> _Existe um amigo meu que conversa com um amigo meu._

Esta frase não é precisa ao dizer se é seu amigo que está falando sozinho, ou você está descrevendo dois amigos seus, em que o primeiro está falando com seu segundo.

É mais razoável dizer:

> **le pa pendo be mi ca tavla ri**
> _O meu amigo está falando sozinho._

ri
: pronome: refere-se ao substantivo anterior, excluindo **mi**, **do**.

Aqui, **ri** refere-se ao substantivo anterior: **le pa pendo** como um todo.

Observe a diferença:

- **da** significa _há algo/alguém_, **da** sempre se refere à mesma entidade quando usado mais de uma vez na mesma relação.
- substantivos como **pa le mlatu** (com um número nu) são semelhantes ao uso de **pa da poi me le mlatu**, mas podem se referir a novas entidades sempre que são usados.

> **mi nitcu le nu pa da poi mikce zo'u da kurju mi**
> _Preciso de um médico para cuidar de mim (implicando "qualquer médico servirá")._
...
> _Usar a língua (a discutida) não é suficiente._
...
> _Eu quero algo relacionado a uma maçã, algumas maçãs (provavelmente, comê-las, talvez mastigá-las, lambê-las, jogá-las em seu amigo etc.)_
...
> `Existe algo que é um braço de mim`

birka
: $x_1$ é um braço de $x_2$

Nós usamos a mesma estratégia para expressar relacionamentos familiares:

> **pa da bruna mi**
> **mi se bruna pa da**
> _Alguém é meu irmão._
> _Eu tenho um irmão._
> `Existe alguém que é um irmão de mim`
...
Então não precisamos do verbo _to have_ para denotar esses relacionamentos. O mesmo se aplica a outros membros da família:
...
Se você possui algo de acordo com alguma lei ou documento, deve usar **ponse**:
...
Ao usar **zo'u**, podemos tornar nossa frase mais clara:
...
Aqui, vemos que cada um dos amigos é dito falar com duas crianças, e pode ser diferentes crianças cada vez, com um total de até seis crianças.
...
Isso seleciona dois grupos, um de três amigos e o outro de duas crianças, e diz que cada um dos amigos fala com cada uma das crianças.
...
**mo'u** significa que um evento está completo. Qual evento? O evento **co'a speni** — se casar. Portanto, **mi mo'u co'a speni** significa _eu termino o processo de me casar_, ou seja, _eu sou recém-casado(a)._ 
...
Primeiro, é dito que um evento começou (**co'a**), então é afirmado que é um evento de terminar de ser casado. Portanto, **mi co'a mo'u speni** significa _eu fico viúvo_.
...
> **mi co'u ponse da**
> _Eu perdi todas as minhas propriedades._
...
Isso pode parecer um exemplo difícil de entender. Aqui, uma pessoa foi capaz de dizer _Eu possuo algo._ Mas depois disso, essa pessoa perdeu tudo o que possuía.

Outro exemplo:

> **ro da vi cu cizra**
> _Tudo é estranho aqui._
> `Todo objeto aqui é estranho`

vi
: aqui, a curta distância
...
2. _Aqui, tudo é estranho_ simplesmente descreve esses objetos ou eventos que estão aqui (e são estranhos). Não sabemos nada sobre outros em outros lugares.

<pixra url="/assets/pixra/cilre/viku_cizra.webp" caption="vi ku ro da cizra" definition="Aqui, tudo é estranho."></pixra>

Outro exemplo com um substantivo que começa com um número:

> **pa le prenu ta'e jundi**
> _Há uma pessoa que é habitualmente atenciosa._

— é a mesma pessoa que é atenciosa.

> **ta'e ku pa le prenu cu jundi**
> _Acontece habitualmente que há uma pessoa que é atenciosa._

— é sempre aquela pessoa que é atenciosa. As pessoas podem mudar, mas sempre há uma pessoa atenciosa.
### Substantivos genéricos. «Eu gosto de gatos (em geral)». Conjuntos

> **mi nelci le'e mlatu**
> _Eu gosto de gatos._

Já vimos que **le** é em sua maioria traduzido como o inglês _the_. No entanto, em alguns casos, podemos querer descrever um objeto ou evento típico que melhor exemplifica um tipo de objeto ou evento em nosso contexto. Nesse caso, substituímos **le** por **le'e**:

> **mi nelci le'e badna .i mi na ku nelci le'e plise**
> _Eu gosto de bananas. Eu não gosto de maçãs._

Eu posso não ter nenhuma banana ou maçã na mão. Eu estou simplesmente falando sobre bananas e maçãs como eu entendo, lembro ou defino elas.

Para fazer um substantivo que descreve o conjunto de objetos ou eventos (do qual derivamos um elemento típico), usamos a palavra **le'i**:

> **le danlu pendo pe mi cu mupli le ka ca da co'a morsi kei le'i mabru**
> _Meu animal de estimação é um exemplo que em algum momento os mamíferos morrem._
...
> _Cada cobra cercou a vara._

— aqui, cada cobra provavelmente cercou a vara enrolando-se nela.
...
Isso significa que cada maçã é pesada, ou isso significa que elas são pesadas se forem consideradas juntas?

Em Lojban, podemos facilmente distinguir esses dois casos:

> **le ci plise cu tilju**
> _Cada uma das três maçãs é pesada._

> **le plise cu tilju**
> _Cada maçã é pesada._
...
**li** é um prefixo que indica que um número, um horário, ou alguma expressão matemática está chegando.

> **li mu no**
> _Número 50._

Um simples **mu no** que não seja precedido por **li** seria usado para denotar 50 objetos ou eventos.
## Lição 3. Citação. Perguntas. Interjeições
...
Vamos adicionar colchetes para torná-lo mais fácil de ler.

> **la .alis. cu prami (sei la .bob. cu gleki) la .kevin.**
> _Alice ama (Bob está feliz) Kevin._
> _Alice ama Kevin (Bob está feliz)._

Podemos adicionar mais substantivos ao verbo com **be** e **bei**, assim como fazemos com substantivos:
...
zausku
: x1 elogia x2 para a audiência x3 por meio de x4

### Aspas

Para citar texto, colocamos a partícula de citação **lu** antes da citação e colocamos **li'u** após ela. O resultado é um substantivo representando o texto citado:
...
Uma característica interessante do Lojban é que **lu** - «citação» e **li'u** - «des-citação» são pronunciáveis. É bastante útil, pois, no Lojban falado, você não precisa mudar a entonação para mostrar onde começa e termina um texto citado.

No entanto, em um texto escrito que cita uma conversa, o autor frequentemente chama a atenção do leitor para o conteúdo das citações. Nesses casos, **sei** é preferível.
...
> _Yan disse: 'Jane cumprimentou-me'._

rinsa
: $x_1$ cumprimenta alguém $x_2$

<pixra url="/assets/pixra/cilre/rinsa2.webp" caption="A pessoa cumprimenta o amigo." definition="A pessoa cumprimenta o amigo."></pixra>

Observe que, no Lojban, distinguimos coisas e seus nomes:
...
Como você pode ver, **je'u** não faz parte de suas palavras. Ele representa sua atitude em relação à relação. Se você quiser citar "**je'u mi jinga**", use aspas desta forma:

> **lu je'u mi jinga li'u se cusku ra**
> _"Verdadeiramente, eu ganhei", ele disse._

Observou a diferença entre os dois exemplos?
...
Os outros três verbos têm a mesma estrutura de lugar:
...
**zo** é um marcador de citação, semelhante a **lu**. No entanto, **zo** cita apenas uma palavra imediatamente após ela. Isso significa que não é necessário uma palavra de fim de citação como **li'u**; já sabemos onde a citação termina. Ao fazer isso, economizamos duas sílabas e tornamos nosso discurso mais conciso.
...
Para se apresentar em Lojban usando seu nome Lojbanizado, siga o exemplo acima. Se o seu nome consistir em mais de uma palavra verbo, use **lu … li'u**:
...
Para ilustrar isso melhor, aqui está uma variação boba:
...
> _Eu disse ao meu amigo: "O jardim está pronto", ao proferi-lo em voz alta._

cusku
: $x_1$ diz $x_2$ (texto) para público $x_3$ via meio $x_4$
...
* **cusku** significa _dizer um texto_,
* **tavla** significa _conversar em uma língua_.

### Perguntas de conteúdo

O inglês tem várias palavras de pergunta com prefixo _wh-_ — _who_, _what_, etc. Em Lojban, nós usamos uma palavra para todas essas: **ma**. Isso é como uma instrução para preencher o espaço em branco. Por exemplo:
...
> **— mi plicru do ma**
> **— le plise**
> <span>_— Eu te dou o quê?_ (provavelmente significando "O que eu deveria estar te dando?")</span>
> _— A maçã._

Para traduzir _qual/o que_, nós também usamos **ma**:
...
**mo** é semelhante a **ma**, mas pergunta pela relação principal em vez de um substantivo. É como perguntar "O que X faz?" ou "O que é X?" em inglês (lembre-se, Lojban não o obriga a distinguir entre ser e fazer!).

Podemos ver **mo** como pedindo a alguém para descrever a relação entre os substantivos na pergunta.

> **— do mo**
> _— Como vai você? O que está acontecendo?_
> `— Você é o quê, você faz o quê?`

Este é o modo mais comum de perguntar "Como vai você?" ou "E aí?" em Lojban. Algumas respostas possíveis:
...
> **mi gunka**
> _— Estou trabalhando._

Outra forma de perguntar "Como vai você?":
...
> **la .meilis. cu mo**
> _— Quem é Mei Li? / O que é Mei Li? / O que Mei Li está fazendo?_
...
- **prami**: _Eu adoro/amo ele._
- **xebni**: _Eu odeio ele._
- **fengu**: _Eu estou com raiva dele._
- **cinba**: _Eu beijei ele._

Note novamente que o tempo não é importante aqui: assim como **cinba** pode significar _beijar_, _beijou_, _vai beijar_ e assim por diante, **mo** não faz uma pergunta sobre nenhum momento específico.

Para diferenciar entre _fazer_ e _ser algo ou alguém_ usamos verbos adicionais com **ma**:
...
O uso de termos modais com **ma** pode nos dar outras perguntas úteis:
...
**pe ma** é usado somente com substantivos:
...
A palavra **xo** significa _Quantas?_ e, portanto, pergunta por um número. A resposta completa será:
...
Se você usar erroneamente **nu** em vez de **du'u**, ainda será compreendido. No entanto, falantes fluentes de Lojban geralmente distinguem entre essas partículas.
### Perguntas indiretas
...
Isso nunca pode ser uma pergunta indireta: está pedindo uma resposta (mesmo que você esteja fazendo isso de forma retórica).
...
### Citações indiretas (discurso indireto): "Eu disse que viria."
...
> _Alice disse algo sobre Michelle ter cumprimentado ela antes._
...
A combinação **se du'u** permite expressar discurso indireto.

Aqui estão alguns exemplos de verbos relacionados a fala ao usar discurso indireto:
...
Assim, o Lojban tem várias palavras para _que ..., _ dependendo do tipo de coisa que é significada.
...
Conhecemos essas interjeições como **ui** (_Yay!_), **.a'o** (_Espero que sim_).
...
<pixra url="/assets/pixra/cilre/ui_jinga.webp" caption="ui mi jinga" definition="Yay! Eu ganhei!"></pixra>

As interjeições funcionam como **sei** com suas relações. **ui** significa o mesmo que **sei mi gleki**, então também poderíamos dizer **do jinga sei mi gleki**, com o mesmo significado (embora seja um pouco mais longo).
...
ie
: interjeição: _Sim! Aye!_ (concordância)
...
> **.a'o do clira klama**
> _Espero que você chegue cedo._
...
Você pode adicionar ou remover interjeições de uma frase sem o risco de quebrá-la.

Qualquer palavra que comece com uma vogal pura (excluindo **u** e **i** antes de vogais) é prefixada com um ponto em Lojban na escrita e com uma pausa na fala. Portanto, a grafia correta é **.a'o** e assim por diante. É comum omitir os pontos na escrita. No entanto, ao falar, você deve sempre mostrar esse ponto fazendo uma breve pausa antes de dizer tal palavra para evitar a fusão de duas palavras vizinhas em uma só.

Assim como com **xu** ou relações **sei**, podemos adicionar interjeições após qualquer substantivo, pronome ou verbo, expressando assim nossa atitude em relaçã

### Interjeições de exortação
...
.e'ei
: interjeição: _Vamos lá!_ (incentivo, instigação, provocação). Palavra não oficial
...
> _Eu sugiro que você beba o suco. Você deveria beber o suco._
...
Em Lojban, **bajra** como uma sentença significa _Alguém corre_ (ou _está correndo_ / _corria_, dependendo do contexto). **bajra** também pode significar um comando, _Corra!_, mas às vezes o contexto não é suficiente para determinar se é um impulso para correr ou simplesmente uma afirmação de que alguém corre ou está correndo.
...
colocando o ênfase em nossa educação em **do** (_você_).
...
Como você pode ver, precisamos reestruturar essa relação em inglês, o que ainda soa estranho. No entanto, você poderia usá-lo em Lojban no sentido de _Tente causar uma boa impressão._

Note que **prami** corresponde a _amar_ em inglês, enquanto **nelci** corresponde a _gostar_ em inglês.

Podemos até ter vários **ko** em uma única sentença:
...
ji'a
: _além disso, também_, significa que existem outras pessoas que também são iguais (você, neste caso) ou que fazem a mesma coisa
...
Aqui está uma visão mais abrangente: interjeições emocionais, instigantes e várias outras interjeições por série.
...
<tr>
<td><b>.au cu'i</b><br/><i>meio</i><br/>indiferença
</td>
...
<td><b>.ai nai</b><br/>involuntariamente, acidentalmente
</td>
...
<tbody>
<tr>
<td><b>ua</b><br/><small>"uá" como em "<u>uó</u>nico", "<u>u</u>ma vez"</small><br/><i>Aha! Eureka!</i>
</td>
<td><b>ue</b><br/><small>"ué" como em "<u>ué</u>t"</small><br/><i>Que surpresa!</i>
</td>
<td><b>ui</b><br/><small>"uéé" como "ué"</small><br/><i>viva!</i>
</td>
<td><b>uo</b><br/><small>"uó" como em "<u>uó</u>mbate", "<u>uá</u>t"</small><br/><i>voilà!</i>
</td>
...
<tbody>
<tr>
<td><b>ia</b><br/><small>"iá" como em "<u>iá</u>rd"</small><br/><i>Acredito</i>
</td>
<td><b>ie</b><br/><small>"ié" como em "<u>ié</u>s"</small><br/><i>sim! concordo!</i>
</td>
<td><b>ii</b><br/><small>"iée" como em "ouça <u>ié</u>"</small><br/><i>ai!</i>
</td>
<td><b>io</b><br/><small>"ió" como em "<u>ió</u>gurte"</small><br/><i>respeit

<td><b>.u'o</b><br/><small>"oohoh" como em "do<u>is falcõ</u>es"</small><br/><i>coragem</i>
</td>
<td><b>.u'u</b><br/><small>"oohooh" como em "do<u>is buhos</u>"</small><br/><i>desculpe!</i>
</td></tr>
<tr>
<td><b>.u'a cu'i</b><br/>&nbsp;
</td>
...
<td><b>.u'e nai</b><br/><i>Pff!</i><br/>lugar-comum
</td>
...
<tbody>
<tr>
<td><b>.i'a</b><br/><small>"eehah" como em "casa de  <u>eha</u>"</small><br/><i>ok, aceito isso</i>
</td>
<td><b>.i'e</b><br/><small>"eeheh" como em "le<u>ite ha</u>"</small><br/><i>Aprovo!</i>
</small></td>
<td><b>.i'i</b><br/><small>"eeheeh" como em "calor <u>ueh</u>ra"</small><br/><i>Eu estou com você nessa</i>
</td>
<td><b>.i'o</b><br/><small>"eehoh" como em "s<u>e haw</u>"</small><br/><i>graças a isso</i>
</td>
<td><b>.i'u</b><br/><small>"eehooh" como em "s<u>e hoo</u>k"</small><br/><i>familiaridade</i>
</td></tr>
<tr>
<td><b>.i'a cu'i</b><br/>&nbsp;
</td>
...
<td><b>.i'e nai</b><br/><i>Vaias!</i><br/>desaprovação
</td>
...
<table>
<thead><tr><th colspan="5">Anexos</th></tr></thead>
<tbody>
<tr>
</td>
<td><b>.a'a</b><br/><small>"ahah" como em "aha"</small><br/><i>eu estou ouvindo</i>
</td>
<td><b>.a'e</b><br/><small>"aheh"</small><br/><i>atenção</i>
</td>
<td><b>.a'i</b><br/><small>"aheeh" como em "Sw<u>ahi</u>li"</small><br/><i>oof!</i><br/>esforço
</td>
...
<td><b>.a'u cu'i</b><br/><i>Tédio</i><br/>desinteresse
</td></tr>
<tr>
...
<td><b>.a'u nai</b><br/><i>Ugh! Eca!</i><br/>repulsão
</td></tr>
</tbody></table>

<table>
<thead><tr><th colspan="5">Instigando</th></tr></thead>
<tbody>
<tr>
</td>
...
<td><b>.o'o</b><br/><small>"ohoh" como em "pior"</small><br/><i>paciência</i>
</td>
...
<tr>
<td><b>.o'a nai</b><br/><i>Que vergonha.<br/>Isso me deixa envergonhado.</i>
</td>
...
Observe como uma emoção se transforma em sua oposta ao usar **nai**, e para a emoção intermediária ao usar **cu'i**.

Por que algumas células de interjeições com **cu'i** e **nai** estão vazias? Porque o inglês não possui formas concisas de expressar tais emoções.
...
Aqui, duas interjeições modificam a mesma construção (a frase inteira), mas não se modificam entre si, então a ordem delas não é importante.
...
E se esquecemos de adicionar **ui** no início dessa frase?
...
Agora que conhecemos as partes mais importantes da gramática, podemos começar a acumular novas palavras através de situações.

### Expressões coloquiais

Aqui estão algumas estruturas comuns usadas por falantes fluentes de Lojban, juntamente com exemplos ilustrando seu uso.
...
- <dl><dt>mi djuno le du'u ma kau</dt><dd>Eu sei o que/quem …</dd></dl>
 ...
 > _Eu não sei._
 >
- <dl><dt>jinvi le du'u</dt><dd>… tem a opinião de que …</dd></dl>
...
<pixra url="/assets/pixra/cilre/tadni.webp" caption="mi tadni" definition="Eu estudo."></pixra>
...
Note que **le solri cu tcima** (literalmente _o sol é o tempo_) é a forma de usar **tcima** em Lojban.
...
Verbos relacionados à percepção serão explicados após o diálogo.
...
> _Eu espero que ela esteja madura, sim._
...
<pixra url="/assets/pixra/cilre/le_prenu_cu_tirna_lei_djacu.webp" caption="A pessoa ouve as águas." definition="le prenu cu tirna lei djacu"></pixra>
...
tolycladu
: $x_1$ é relativamente silencioso

tonga
: $x_1$ é um tom de $x_2$

Podemos usar **cladu** e palavras semelhantes diretamente:
...
> _Eu ouço algo relativamente silencioso._
...
Assim como na visão, podemos dizer _ouvir um som_ e _ouvir algo que produz o som_:

> **— ma sance gi'e se tirna do**
> _— Qual som você ouve?_
...
ganse
: $x_1$ sente estímulo $x_2$ (objeto, evento) por meio de $x_3$
...
> _Eu observo a forma da maçã._

> **.i le plise cu se tarmi le'e cukla**
> _A maçã é redonda._

zgana
: $x_1$ nota, observa, assiste $x_2$. Não se limita à visão
...
sumne
: $x_1$ sente o cheiro de $x_2$ (odor)

panci
: $x_1$ é um odor de $x_2$ (objeto)

<pixra url="/assets/pixra/cilre/sumne.webp" caption="O gato sente o cheiro da flor." definition="le mlatu cu sumne le xrula"></pixra>

> **mi sumne le xrula**
> _Eu sinto o cheiro da flor._

<!-- -->

> **mi sumne le panci be le za'u xrula**
> _Eu sinto o odor das flores._

<!-- -->

> **mi sumne le panci be le plise**
> _Eu sinto o odor da maçã._

> **.i le plise cu se panci le xrula**
> _A maçã cheira a flores._

Observe que o inglês pode ser confuso quando se trata de distinguir entre o cheiro de um objeto e o cheiro de algo que o objeto produz. Dizemos _sentir o cheiro da maçã_, _a maçã cheira a flores_. Essa distinção dupla é importante porque a maçã produz partículas aromáticas distintas da própria maçã. O mesmo se aplica a um prato caindo e seu som — podemos não querer misturá-los.
...
<pixra url="/assets/pixra/cilre/zgana_le_vrusi.webp" caption="le prenu cu zgana le vrusi be le grute" definition="A pessoa prova, observa o sabor da fruta."></pixra>
...
<pixra url="/assets/pixra/cilre/se_vrusi_lo_ka_kukte.webp" caption="le grute cu se vrusi le titla" definition="As frutas são doces."></pixra>
...
Diferentes idiomas usam diferentes conjuntos de palavras para denotar cores. Alguns idiomas simplesmente se referem a cores fazendo referência a outros objetos "protótipos" com cores, tons ou formas semelhantes. Em Lojban, usamos todas as opções:
...
> _Isto é vermelho. Isso tem a cor das coisas vermelhas._
...
Aqui estão alguns exemplos de cores que correspondem à língua inglesa. Você também pode usar outros verbos de cor, refletindo a forma como os falantes de diferentes idiomas geralmente categorizam as coisas.
...
simlu
: $x_1$ parece como $x_2$ (propriedade de $x_1$)

> **.i le pelxu xrula cu se farna le solri**
> _Flores amarelas estão orientadas em relação ao sol._

se farna
: $x_1$ está orientado em relação a $x_2$
...
> _Eu estou na fronteira de um mar azul._
...
gusni
: $x_1$ é uma luz iluminando $x_2$ a partir da fonte de luz $x_3$
...
> _Enquanto eu estava dormindo, mesmo assim percebi você chegando._

<!-- -->

<pixra url="/assets/pixra/cilre/le_prenu_cu_senva_tuha_le_nei.webp" caption="mi ca'o sipna gi'e sanji le nu mi sipna" definition="Eu durmo e estou ciente de que estou dormindo."></pixra>
...
ganse
: o observador $x_1$ percebe, nota algum estímulo (evento) por meio de $x_3$

sanji
: $x_1$ está consciente, ciente de $x_2$ (evento)

**ganse** não implica nenhum processamento mental; apenas descreve a percepção, reconhecimento, detecção de algum estímulo por meio de canais sensoriais (especificados em $x_3$).
...
<pixra url="/assets/pixra/cilre/badri.webp" caption="A pessoa parece estar triste." definition="The person seems to be sad."></pixra>
...
_Fico curioso se a garota gosta do irmão._
...
se zdile
: $x_1$ está se divertindo com $x_2$
...
pacna
: $x_1$ espera que $x_2$ seja verdadei
...
> _Você tem um vírus? Sugiro que vá ao médico._
...
> _Acredito que estou com um resfriado._
...
Observe que o segundo lugar de **bilma** descreve os sintomas, como **le ka cortu le galxe** = _ter dor de garganta_. O terceiro lugar indica o nome da doença que causa esses sintomas. Obviamente, você pode optar por não preencher esses lugares do **bilma**.
### Corpo humano
...
A maioria das palavras para partes do corpo tem a mesma estrutura de lugar de **xadni**:
...
> _Também tenho dois irmãos que não estão presentes no momento._
...
Os verbos para os nomes dos membros da família têm uma estrutura de lugar semelhante:

speni
: $x_1$ é marido/esposa de $x_2$

**co'a speni** significa _se casar_:

> **mi co'a speni la .suzan.**
> _Casei-me com a Susan._
...
verba
: $x_1$ é uma criança, pessoa imatura com idade de $x_2$ (evento)
...
laldo
: $x_1$ é velho, envelhecido

Pares de palavras tradicionais (para humanos apenas):

le ninmu
: mulher / mulheres

le nanmu
: homem / homens masculinos
...
Observe que **le prenu** significa _as pessoas_ ou _os indivíduos_. Em contos de fadas e histórias fantásticas, não apenas humanos (**lo'e remna**) mas também animais ou seres alienígenas de outros planetas podem ser considerados indivíduos.
...
> **ie**
> **.i mas eu não paguei muito dinheiro**
> _Sim._
> _Mas eu não paguei muito dinheiro._

<!-- -->

> **Qual foi o preço do carro?**
> _Qual foi o preço do carro?_

<!-- -->

> **Eu paguei mil dólares para a empresa pelo carro.**
> _Eu paguei mil dólares para a empresa pelo carro._

<!-- -->

> **Eu vendi um carro velho meu para meu amigo.**
> **Meu amigo pagou dois mil euros pelo carro.**
> _Eu vendi um carro velho meu para meu amigo._
> _Meu amigo pagou dois mil euros pelo carro._
...
> **Qual é a localização da sua casa?**
...
> **A borda da montanha.**
> **Eu moro no campo.**
> **Minha casa é uma casa grande e tem três quartos, além de um banheiro e um banheiro.**
> _A borda da montanha._
> _Eu moro no campo._
> _Minha casa é uma casa grande e tem três quartos, além de um banheiro e um banheiro._

<!-- -->

> **Entendo.**
> **Mas eu nasci na cidade e agora moro nos subúrbios de Paris.**
> **Eu moro perto de uma loja.**
> _Entendo._
...
zarci
: $x_1$ é uma loja
## Lição 5. Termos modais, «**da**», sua posição relativ

### Como os termos modais se referem à relação?

Alguns termos modais, como aqueles que descrevem o tempo (tempo verbal), conectam a relação atual com a relação no substantivo após eles:
...
> _Eu caminhei em direção ao rio._

<!-- -->

> **mi pu cadzu se ka'a le rirxe**
> _Eu caminhei para o rio._
...
No primeiro exemplo, **se ka'a** conecta **le rirxe** e então o segundo lugar de **klama** segue, sendo preenchido com **le dinju**. É o mesmo que preencher o segundo lugar de **klama** duas vezes, conectando-os com **.e** - e.
...
> _A pessoa caminhou como se estivesse carregando algo pesado._

bevri
: $x_1$ carrega $x_2$

tai
: termo modal: como …, parecendo com …

<!--
- Alguns termos descrevem as relações do primeiro lugar da relação com o substantivo após o termo:

> **Mi jinga se rai le ka clani**
> _Eu venço sendo o mais alto._

se rai
: termo de **se traji**: sendo o mais...

Aqui o $x_1$ da relação corresponde ao mais alto em comparação especificado após **se rai**.

- Finalmente, alguns termos descrevem as relações do primeiro lugar da relação e da própria relação com o substantivo após o termo:

> **Le fragari cu se nelci mi te rai le'i jbari**
> _Entre as frutas, eu prefiro morangos._
...
O $x_1$ da relação descreve o mais preferido nesta comparação, a relação em si descreve a comparação.

O dicionário explica esses casos difíceis em que a relação definida pelo termo pode apresentar dificuldades. Na prática, a relação geralmente está clara pelos exemplos fornecidos. -->

### Usando «**ne**» + termo. «**se mau**» — ‘_mais que …_’

**mi ne se mau do cu melbi**
_Eu sou mais bonito(a) do que você._

se mau
: termo de **se zmadu**: mais que; a relação em si descreve a comparação

Este exemplo é similar a

> **Mi zmadu do le ka melbi**
> _Eu ultrapasso você em beleza._

Em outras palavras, a relação principal **melbi** é similar ao terceiro lugar de **zmadu**, que especifica os critérios de comparação. Mais dois exemplos:

> **Mi prami do ne se mau la .doris.**
> _Eu amo você mais do que Doris._
> 

<!-- -->

> **Mi ne se mau la .doris. cu prami do**
> _Eu amo você mais do que Doris ama._
> _Eu amo você mais do que Doris ama você._
> `Eu (mais que Doris) amo você.`

Mais exemplos:

> **Mi nelci le'e pesxu ne se mau le'e jisra**
> _Eu gosto mais de geleia do que suco._
...
> _Eu gosto mais de geleia do que suco._
> `Geléia ultrapassa suco em quanto eu gosto.`

E agora uma frase interessante:

> _Bob gosta mais de Betty do que de Mary._

Isso pode ser interpretado de duas formas diferentes em inglês!

1. Bob gosta mais de Betty e gosta menos de Mary.
2. Bob gosta mais de Betty, porém Mary também gosta de Betty, embora não tanto quanto Bob!

Nós comparamos Betty com Mary em relação a como Bob gosta delas?

Ou ao invés disso, comparamos Bob com Mary em relação a como eles gostam de Betty?

O inglês é ambíguo nesse sentido.

No entanto, **se mau** sempre compara o substantivo após ele com o primeiro lugar da relação, e sabendo disso nós entendemos o seguinte:
...
> _Betty é amada por Bob mais do que Mary. Bob gosta menos de Mary._
### Comparativos: ‘_igual_’, ‘_o mesmo_’

> **Eu tenho o mesmo tamanho que minha irmã, mas eu não sou ela.**
> _Eu igualo minha irmã em metros, mas não sou idêntico(a) a ela._
...
> _Eu difiro de você gostando do quê._
...
> _Eu e nenhum dos meus amigos gostamos de banana._
> _Entre meus amigos, sou o único que gosta de banana._

O conceito de _não apenas_ é expresso de maneira semelhante:

> **mi .e le su'o pendo be mi cu nelci le'e badna**
> _Não sou apenas eu que gosto de banana entre meus amigos._
> _Eu e alguns dos meus amigos gostamos de banana._

<!-- Uma maneira mais precisa:

> **mi se steci le ka nelci le'e badna kei le'i pendo be mi**
> _Sou o único que gosta de banana entre meus amigos._ (aliás, implicando que você é amigo de si mesmo)

se steci
: $x_1$ é o único em $x_2$ (propriedade de $x_1$) entre $x_3$ (conjunto) -->

<!-- Observe que este exemplo implica que você é amigo de si mesmo :) Caso contrário, use uma declaração ainda mais precisa:

> **mi se steci le ka nelci le'e badna kei le'i me mi .e le pendo be mi**
> _Sou o único que gosta de banana entre o conjunto de mim e meus amigos._ -->

<!-- Negando isso, obtemos:

> **na ku mi se steci le ka nelci le'e badna**
> _Não é verdade que apenas eu gosto de banana._

— talvez ninguém goste de banana, talvez eu + outros gostem. -->

<!-- Mais um exemplo interessante:

> **le'e troci cu se steci le ka snada**
> _Apenas aquele que tenta tem sucesso._
> `Aquele que tenta é o único que tem sucesso.`

> **le'e po'o zukte be le ka troci cu fliba**
> _O único que apenas tenta fracassa._
> `Aquele que tenta e nada mais faz, fracassa.`
...
.
fliba
: $x_1$ fracassa em fazer $x_2$ (propriedade de $x_1$)

E mais uma solução:

> **ro snada pu troci**
> _Todo mundo que tem sucesso tentou._

ro
: número: cada, todo

Como você pode ver, Lojban oferece diferentes métodos de dizer o mesmo, alguns dos quais podem ser significativamente diferentes das formas em inglês. -->

### '_A maioria_', '_muito_' e '_demais_'

Palavras como _maioria_ e _muito_ também são números em Lojban:
...
> _Não mais do que 20 pessoas virão._
...
Termos simples sem argumentos depois deles podem ser movidos ao redor da frase adicionando **ku** depois deles.

**ku** impede que os substantivos seguintes se liguem a esses termos. Compare:
...
> _Eu estou bebendo suco quando você chega em casa._

<!-- -->

> **mi pinxe le jisra .i ca bo do co'i klama le zdani**
> _Eu estou bebendo suco e ao mesmo tempo você chega em casa._

Os dois exemplos transmitem o mesmo significado. A segunda opção é usada principalmente quando qualquer uma das relações originais parece estendida.

Outra utilização é mover os termos modais fora do escopo de outros termos modais:

> **mi na ku te vecnu ki'u le nu kargu**
> _Não é verdade que eu compro porque é caro._

Neste exemplo, pode-se supor que eu só compro coisas se elas forem caras. No entanto, este não é o caso.

Aqui, **na ku** nega que eu compro as coisas porque elas são caras. **na ku** é aplicado à relação como um todo, assim, "cobre" **ki'u**.

> **mi na ku te vecnu .i ki'u bo kargu**
> _Eu não compro. É porque é caro._

Neste caso, eu não compro as coisas. Por quê? Porque elas são caras. Talvez eu prefira apenas coisas baratas.

Aqui, **ki'u** é colocado em outra frase. Assim, **na ku** não se estende sobre ela.

Ambos os exemplos podem ser traduzidos como _Eu não compro porque é caro._ No entanto, eles têm significados diferentes.

Uma regra especial é o uso de **.i ba bo** e **.i pu bo**. Compare:
...
**.i ba bo** significa _depois, então_. A frase depois de **.i ba bo** refere-se a algo que aconteceu depois do que aconteceu na relação anterior.

**pu** é mudado para **ba**, e vice-versa. Esta regra especial para Lojban foi feita por analogia com as línguas naturais. Então, você só precisa lembrar este comportamento especial dessas duas palavras.

### Coisas existentes, ‘_existem..._’

Na verdade, existem três palavras na série **da**: **da**, **de**, e **di**. Nós as usamos quando nos referimos a diferentes objetos em um discurso:

> **ci le mlatu cu citka re le finpe**
> _Existem três gatos, existem dois peixes para cada gato, e cada gato come dois peixes._

Se você precisar de mais palavras como essas em um discurso, adicione um sufixo **xi** a elas e, em seguida, qualquer número (que podemos chamar de índice). Assim,
...
Às vezes é útil mostrar o tópico de uma relação e, em seguida, comentar sobre ele:

> **le'e finpe zo'u mi nelci le'e salmone**
> _No caso do peixe, eu gosto de salmão._

salmone
: ... é um salmão

zo'u
: termina o tópico e inicia o comentário da relação

** zo'u ** é mais útil quando um pronome como ** da ** é definido no tópico e depois usado no comentário:
...
> _Para cada coisa que é um cachorro: eu gosto dele._
> _Eu gosto de todos os cachorros._

<!-- -->

> **da de zo'u da viska de**
_Existe **da** e **de** de tal maneira que **da** vê **de**._

Os dois pronomes ** da ** e ** de ** indicam que existem duas coisas que estão na relação em que uma vê a outra. Pode ser o caso de as duas coisas serem realmente apenas uma coisa que se ama: nada na frase exclui essa interpretação, é por isso que a tradução coloquial não diz "Alguém vê outra pessoa." As coisas referidas por diferentes pronomes da série ** da ** podem ser diferentes ou as mesmas.

Está perfeitamente ok para esses pronomes aparecerem mais de uma vez na mesma frase:

> **da zo'u da prami da**
> _Existe **da** de tal forma que **da** ama **da**. Existe alguém que se ama a si mesmo._
...
As palavras 'qualquer' e 'algum', juntamente com seus derivados, têm muitos significados em inglês. Devemos ter cuidado ao traduzir o significado pretendido:
...
- 'algum': algo não especificado:
  ...
  > _Alguém veio. Adivinha quem foi._

  <!-- -->

  > **mi pu tirna da. i je mi fliba le ka jimpe le du'u da mo kau**
  > _Eu ouvi algo, mas falho em entender o que era._

- 'algum' em perguntas se transforma em 'alguma coisa', 'alguém'; em Lojban, ainda é **da**:
...
O contexto geralmente resolve o que é correto. Adicionamos tempos quando sentimos que precisamos deles.
...
- O tempo da relação principal é entendido em relação a quem profere essa relação.
- O tempo da relação dentro da relação principal também é entendido em relação a quem profere essa relação.

Em Lojban:

- somente o tempo da relação principal é relativo a quem profere a relação.
- os outros tempos são relativos uns aos outros. É por isso que, em **la .alis. pu cusku le se du'u ri pu penmi la .doris. la'u le djedi be li ci** o segundo **pu** é relativo ao primeiro **pu**. Em **la .alis. pu cusku le se du'u ri ca kansa la .doris.**, usamos **ca** (_ao mesmo tempo_) que é relativo à relação externa (**pu cusku** — _disse_).
...
Assim é como podemos usar combinações de tempos para especificar o quão longe vamos no passado ou no futuro:
...
Observe a ordem das vogais **i**, **a** e **u**. Essa ordem aparece repetidamente no Lojban e pode valer a pena memorizar. _Curto_ e _longo_ são sempre dependentes do contexto, relativos e subjetivos. Por exemplo, duzentos anos é um curto tempo para uma espécie evoluir, mas um longo tempo para esperar pelo ônibus.
...
> `Eu aqui-passado-distância-tempo-longo trabalho`

> **pu zu vu ku zasti fa le ninmu .e le nanmu**
> _Há muito tempo e longe daqui, uma mulher e um homem viveram._
...
ze'i
: termo modal: por um curto período 
...
ve'a
: termo modal: em algum espaço 

ze'u
: termo modal: por um longo tempo 

ve'u
: termo modal: em um espaço longo 

Novamente, é fácil lembrar o padrão **i**, **a**, **u**.
...
> _Muito em breve, vou morar em Jacarta por um tempo._

> **le jenmi pe la .romas. ba ze'u gunta la .kart.xadact.**
> _O exército dos romanos estará atacando Cartago por muito tempo._

Isso não significa que os romanos não estejam atacando Cartago nos dias de hoje. Em Lojban, se diz que algo é verdadeiro em um momento específico, isso não significa que não seja verdadeiro em nenhum outro momento. Você pode dizer **pu bal ze'u** para que saibamos que essa atividade estava no futuro quando vista de algum ponto no passado, mas no passado quando vista a partir de hoje.
...
<pixra url="/assets/pixra/cilre/le_vehi_ja_vehu_cmana.webp" caption="le ve'i cmana cu jibni le ve'u cmana" definition="A colina está próxima da montanha."></pixra>
...
> **ti ve'u gerku**
> _Este é um cachorro grande. Este é um cachorro cobrindo um grande espaço._
...
> _Eu vou falar com o médico (e talvez eu esteja falando agora também)._
...
<pixra url="/assets/pixra/cilre/baho_carvi.webp" caption="ba'o carvi" definition="Consequência da chuva. A chuva parou."></pixra>

<!-- -->

> **mi ba ba'o tavla le mikce**
> _Eu vou ter falado com o médico._

<!-- -->

> **.a'o mi ba zi ba'o gunka**
> _Espero que em breve eu tenha feito o trabalho._
...
> **ra pu de'a vasxu**
> _Ela parou de respirar (mas pode respirar novamente mais tarde)._

<pixra url="/assets/pixra/cilre/deha_vasxu.webp" caption="mi de'a vasxu" definition="Eu pauso na respiração. Eu prendo a respiração."></pixra>

<!-- -->

> **mi pu di'a citka le plise**
> _Eu continuei a comer maçãs._
...
> **mi di'a jundi**
> _Eu estou de volta (sendo atencioso)._

jundi
: $x_1$ presta atenção a $x_2$

Essas duas expressões são comuns em chats de texto para indicar que você está ausente ou não prestando atenção e, em seguida, voltando online:

Claro que também é possível dizer apenas **de'a** ou **di'a** e esperar que a mensagem seja compreendida.
...
> _Eu estava continuamente comendo maçãs._

Observe a diferença:

- **ru'i** indica que o evento é contínuo e nunca pausa.
- **ca'o** implica que o evento progride. Às vezes, pode pausar e depois retomar seu progresso.

### Colocando contornos

Contornos de eventos podem ser usados para se referir a um espaço se os prefixarmos com **fe'e**:

> **le rokci cu fe'e ro roi zvati**
> _As pedras estão em toda parte._

### ‘_à esquerda_’, ‘_à direita_’

> **le prenu cu sanli le dertu bu'u le pritu be mi**
> _A pessoa está em pé no chão à direita de mim._
...
> _Pegue a caneta à sua esquerda._
...
> _A pessoa está à direita de uma árvore, vista do meu ponto de vista._

<!-- -->

> **le dinju cu zunle le rokci ti**
> _A casa está à esquerda da pedra, visto daqui._

zunle
: $x_1$ está à esquerda de $x_2$ quando visto de $x_3$

pritu
: $x_1$ está à direita de $x_2$ quando visto de $x_3$

crane
: $x_1$ está à frente de $x_2$ ($x_1$ está entre $x_2$ e quem observa) quando visto de $x_3$

trixe
: $x_1$ está atrás de $x_2$ quando visto de $x_3$

sanli
: $x_1$ está em pé sobre $x_2$
...
<td>Vire e mova para a direita. A mesa está na frente de um prédio pequeno. O telefone está em cima da mesa. Além disso, pegue um lápis e um papel. Eles estão também em cima da mesa. Em seguida, leve as três coisas para casa e coloque-as no meu quarto.
</td></tr>
<tr>
...
<td><i>Então fomos a um aeroporto.</i>
</td></tr>
<tr>
...
A tabela a seguir representa o alfabeto básico em Lojban e como pronunciar as letras (abaixo de cada letra):
...
- a palavra para **'** (apóstrofe) é **.y'y**.

Podemos soletrar palavras usando esses nomes. Por exemplo, CNN será **cy. ny. ny.**

<!-- Uma letra maiúscula sozinha tem um significado especial. Ela denota o nome daquela letra:

**A** é o mesmo que **.abu**, **B** é o mesmo que **by.** e assim por diante. Eles têm o mesmo significado e até mesmo são lidos da mesma forma que **.abu**, ** by.** etc. Então _CNN_ também pode ser escrito como **CNN** em Lojban e ainda será pronunciado e terá o mesmo significado que **cy. ny. ny.** -->

### Letras em vez de '_ele_' e '_ela_'

Uma sequência de um ou mais nomes de letras pode funcionar como um pronome, fornecendo um método alternativo para se referir a substantivos e nomes mencionados anteriormente em um discurso.
...
Como a primeira letra em **.alis.** é **a** (ignorando o ponto) e a primeira letra em **nurma** é **n**, podemos usar palavras de letras para se referir a esses substantivos correspondentes:

- **.a bu** se refere a **la .alis.**
- **ny.** se refere a **le nurma**

Esse método pode ser mais conveniente do que o _he_ ou _she_ em inglês, ou até mesmo o **ri** ou **ra** em Lojban. Ele nos permite tornar o discurso mais conciso e preciso, sem precisar repetir nomes ou substantivos potencialmente longos repetidamente.

No entanto, é importante observar que pode haver situações em que queremos nos referir de volta, por exemplo, a **le nurma**, mas outro substantivo ou nome começando com **n** aparece no meio tempo, tornando **ny.** incapaz de se referir à área rural. Nesses casos, a solução mais rápida é repetir o substantivo ou nome inteiro, ou seja, dizer **le nurma**:
...
Se um nome consistir em vários cmevla, você pode usar as primeiras letras deles para se referir a esse nome. O mesmo se aplica a verbos compostos:
...
A frase **mi klama py. my.** significaria _Eu vou para PM_, o que teria um significado diferente.
...
### Diferentes formas de dizermos ‘_nós_’ em Lojban
...
Então, ao falar, você precisa ter mais cuidado sobre qual significado de _nós_ você precisa.
...
**mi** também pode significar _nós_! Lojban não faz distinção entre singular e plural por padrão. Então, se várias pessoas estão falando juntas, **mi** (que se refere a um ou mais falantes) é perfeitamente correto para _nós_. Na prática, você normalmente encontrará **mi** usado assim quando uma pessoa presumir falar (ou mais frequentemente, escrever) em nome de outras.
...
### «**ri**» ao invés de ‘_he_’ e ‘_she_’

Anteriormente, aprendemos sobre o pronome **ri**:

ri
: pronome: refere-se ao substantivo anterior ou ao pronome que acabou de ser mencionado (saltando pronomes estáveis como **mi**, **do**, palavras para _nós_)

> **mi catlu le nanmu .i ri melbi**
> _Eu olho para o homem. Ele é bonito._

melbi
: $x_1$ é bonito / belo / atraente para alguém $x_2$

**ri** se refere ao último substantivo completo utilizado no texto ou discurso de alguém:

> **la .alis. cu sipna bu'u le sledi'u pe la .alis.**
> _Alice dorme no quarto de Alice._
> `Alice dorme-no no-quarto de-Alice.`
...
sledi'u
: $x_1$ é um quarto com o propósito $x_2$ (proposição)

O **ri** é equivalente a repetir o último substantivo ou nome, que é **la .alis.** aqui.

Um aspecto a ser considerado é que **ri** não repete **le sledi'u pe ri** (que também é um substantivo), porque **ri** é parte desse substantivo e, portanto, esse substantivo não é "anterior", ainda não foi finalizado quando **ri** aparece. Isso impede que **ri** se refira a si mesmo recursivamente.

Outro exemplo:

> **le du'u le prenu cu melbi cu se djuno ri**
> _Ela sabe que ela é bonita._

O **ri** se refere a **le prenu** (e não a **le du'u le prenu cu melbi** embora ambos os substantivos estejam completos: **le prenu** começa por último, após o início de **le du'u le prenu cu melbi**).

A relação dentro de formas **sei** é um texto paralelo. **ri** pula os substantivos dentro das relações **sei**:

> **mi viska la .lukas. sei la .doris. pu cusku .i ri jibni la .micel.**
> _Eu vejo Lucas, - disse Doris. Ele está perto de Michelle._

Neste exemplo, **ri** não pode se referir a **la .doris.** Simplesmente pulamos toda a relação **sei la .doris. pu cusku** ao decidir a que **ri** deveria se referir.

Pronomes que são estáveis ao longo do diálogo ou da história são ignorados por **ri**. Nós apenas os repetimos diretamente:
...
- os pronomes **ti**, **ta**, **tu** são pegos por **ri** porque você pode ter mudado para o que está apontando, então repetir **tu** pode não ser efetivo.
- de maneira semelhante, **ri** em si (ou melhor, seu antecedente) pode ser repetido por um **ri** posterior. Na verdade, uma sequência de palavras **ri** sem outros substantivos intervenientes sempre irão repetir o mesmo substantivo:
...
Nos idiomas eslavos, as pessoas dizem literalmente _eu lavo-me_. Para ficar mais próximo do estilo eslavo, podemos usar **lo nei**.
...
**lo nei** links para o primeiro substantivo da relação atual.
...
>_Um cachorro se morde._

---

**nei** funciona bem quando uma frase contém apenas uma relação. Mas quando ela tem várias relações incorporadas, podemos precisar de algo diferente. Em

>**la .doris. cu djuno lo du'u la .alis. cu prami lo nei**
>_Doris sabe que Alice se ama._
...
**zu'ai** é colocado no segundo lugar do verbo. Ele mostra a ação mútua entre o primeiro lugar e o segundo lugar. Os membros dessa ação mútua são colocados no primeiro lugar e conectados com a conjunção **jo'u**. -->
...
- **le go'i** refere-se ao primeiro lugar da relação anterior.
  - **go'i** apresenta ainda outra maneira de se referir de volta a um substantivo que precisamos.
...
Aqui, **le se go'i** refere-se ao segundo lugar ($x_2$) da relação precedente, que é **le nanmu**.

Outro exemplo:

> _Bill viu Nick. Ele o acertou._

O inglês não se importa com a precisão aqui - _he_ significa apenas _alguma pessoa do sexo masculino mencionada em algum lugar próximo ao texto ou deduzida a partir do contexto._ Bill acertou Bob ou Bob acertou Bill? Nós não sabemos. Em Lojban, podemos dizer:
...
**go'i** em si é um verbo e, portanto, tem uma estrutura de lugar:
...
Interjeições como **pei** (quando usadas sozinhas), **xu**, **.ui**, **.u'i**, **je'u** aquelas formadas com **sei** e a interjeição de pergunta não são partes de relações. Portanto, não são copiados por **go'i**.
...
**li**, um prefixo para números, também é usado para marcar horários.

- **cacra bu** é um prefixo que indica que o número de horas segue. O tempo de 24 horas é usado quase sempre em Lojban.
- **mentu bu** é um prefixo que indica que o número de minutos segue.
- **snidu bu** é um prefixo que indica que o número de segundos segue.
...
> _As dez horas é o tempo em que eu chego._
...
- **nanca bu** é um prefixo que indica que o ano segue.
- **masti bu** é um prefixo que indica que o mês segue.
- **jefydei bu** é um prefixo que indica que o dia da semana segue.
- **djedi bu** é um prefixo que indica que o dia segue.
...
> _O dia cinco de julho (sétimo mês), ano 2005 é quando eu nasci._
...
djedi
: o $x_1$ (evento) tem duração de $x_2$ dias inteiros

### Novos verbos de uma escala: ‘_além de_’ - «**na'e**», ‘_anti-_’ - «**to'e**»

> **mi na'e nelci do**
> _Eu gosto de você além de amar você._

Partículas na "escala esquerda" (a qual **na'e** pertence) são colocadas à esquerda das construções às quais se referem, formando uma escala:

A escala em si pode ser especificada usando a etiqueta modal **ci'u**.

- **je'a** = _certamente (posição afirmativa na escala)_. A palavra **je'a** confirma o significado de uma parte de uma frase. Geralmente, é simplesmente omitida.
...
- **na'e** = _não- (diferente da posição afirmativa na escala)_
  ...
  > `A cadeira é outra coisa além de vermelha na escala de ter uma cor`

- **no'e** = _não realmente (ponto médio na escala)_. A palavra **no'e** dá a uma parte da frase um significado intermediário.

  > **mi no'e nelci do**
  > _Quanto a amar ou odiar você, sou indiferente a você. Nem gosto nem odeio você._

- **to'e** = _anti-, des-, mal- etc. (oposto na escala)_. A palavra **to'e** dá a uma parte da frase um significado oposto. É semelhante ao prefixo de língua inglesa _anti-_.

  > **mi to'e nelci do**
  > _Eu odeio você._
  > `Eu sou antiapaixonado por você`
...
ki'u
: termo modal: porque, devido a explicação ..., o qual pode ser explicado pelo fato de que ...
...
ki'u nai
: termo modal: não porque, o qual não pode ser explicado pelo fato de que ...

> **mi se nabmi ki'u nai le nu mi laldo ce'e ki'u le nu mi na certu**
> _Estou em apuros não porque sou velho, mas porque não sou um especialista._
...
to'e ki'u
: porque não, o qual pode ser explicado pelo fato de que não acontece que ...

> **mi jinga to'e ki'u le nu mi pu surla**
> _Eu venci porque eu não tinha descansado._

Combinando **to'e** e **nai**, obtemos:

to'e ki'u nai
: apesar da razão ..., não porque não, o qual não pode ser explicado pelo fato de que não acontece ...
...
Usando **se** altera a ordem dos argumentos. Caso contrário, o significado é preservado.

se ki'u
: portanto, o qual explica o fato de que ...

> **ra bilma se ki'u le nu ra na pu cusku zo coi do**
> _Ele está doente, o que explica por que ele não disse oi para você._

se ki'u nai
: mas isso não significa que ..., o qual não explica o fato de que ...
...
se to'e ki'u
: ..., a ausência do qual explica o fato de que ...
...
se to'e ki'u nai
: ..., a ausência do qual não explica o fato de que ...
...
### ‘_Possível poder_’, ‘_foram_’ e ‘_não foram ainda_’
...
> _Meu amigo se mostra uma pessoa amigável._
...
> _Eu já estive em Madri._

<!-- -->

> **mi nu'o zvati la .madrid.**
> _Eu nunca estive em Madri._

ka'e
: termo de potencial: possível poder
...
**li** que vimos anteriormente é similar a **le**, mas começa uma expressão matemática (ou apenas um número ou um registro de tempo).

Note que **li re su'i ci** (_2+3_) é considerado uma única expressão e tratado como um único substantivo.
...
Neste caso, tivemos que converter pronomes em verbos usando **me**.
...
> _Esse é o meu último rato._

<!-- -->

> **le cerni tarci cu ro moi le'i tarci poi cumki fa le nu viska ke'a pu le nu co'a donri**
> _O planeta Vênus é a última estrela visível antes do amanhecer._
...
Também há outro método que mantém a mesma ordem das palavras em inglês:
...
_Portanto_ é a palavra reversa em relação a _porque_:
...
Aqui, não podemos usar **ri'a**, pois não estamos falando sobre um resultado, mas sobre implicação lógica. O fato de estar escuro segue lógicamente do sol não estar brilhando.

> **mi darxi la .kevin. mu'i le nu ky. lacpu le kerfa be mi**
> _Eu bati no Kevin porque ele puxou meu cabelo._

**mu'i**
: termo: porque (devido a motivo...)
...
O inglês omite o segundo evento e diz _Sally bateu no Joey porque ele puxou o cabelo dela._ No entanto, isso não só é vago, mas, para alguns, psicologicamente perigoso. As pessoas geralmente não reagem a estímulos automaticamente, mas como resultado de motivação, e confundir respostas complexas com simples causa física pode nos levar a acreditar que não temos controle sobre nossas emoções ou mesmo nossas ações. Assim, é frequentemente útil dizer não apenas reações físicas (**ri'a**), mas enfatizar respostas que têm um elemento cognitivo / emocional (**mu'i**).

> **le ctuca pu plicru la .ben. le jemna ki'u le nu by. pu zabna gunka**
> _O professor deu a Ben a pedra como presente porque ele trabalhou bem._
...
ki'u
: termo modal: por causa (devido à explicação...)

A diferença entre motivação e justificação nem sempre é clara, mas podemos dizer que a justificação envolve alguma regra ou padrão, enquanto a motivação não exige isso. Compare:

> **le ctuca pu plicru la .ben. le jemna ki'u le nu by. pu zabna gunka**
> _O professor deu a Ben a pedra de presente, motivado pelo seu bom trabalho._

Isso diz apenas que o trabalho árduo de Ben motivou o professor a lhe dar a pedra, enquanto com **ki'u**, podemos implicar que é o hábito dos professores dar pedras como recompensa pelo bom trabalho.

Nota: Não se confunda **ki'u** com **ku'i**, que significa _mas, entretanto_.

**ki'u** apela a considerações mais gerais do que **mu'i**, mas ainda lida com padrões humanos, não com leis lógicas. Apenas um aluno muito ingênuo acreditaria que se um aluno é dado uma jóia, isso deve logicamente implicar que o aluno trabalhou bem.
...
Construções com **da'i** são geralmente traduzidas para o inglês com verbos auxiliares como _poderia, vou/vou, posso/poderia_, _deveria_ e _devo_. Relações marcadas com **da'i** em inglês são ditas estar no _modo subjuntivo_.

Omitir **da'i** ou **da'i nai** torna a frase clara apenas pelo contexto, que geralmente é bastante transparente. É por isso que **da'i** ou **da'i nai** não é obrigatório. Usamos para clareza quando necessário.

Relações com **da'i** podem incluir o termo com **fau**:

> **da'i mi gleki fau le nu mi ponse le rupnusudu be li pa ki'o ki'o**
> _Eu ficaria/ficaria feliz se eu tivesse um milhão de dólares._
...
> (Você tem vários animais em casa. Então pode ser que seja o seu gato arranhando, mas você não tem certeza.)

<!-- -->

> **fau ro da tu mlatu**
> _Isso deve ser/certamente é o gato._
> (Você tem um gato, e esse barulho pode ser produzido apenas por um objeto, esse gato.)

<!-- -->

> **fau so'e da tu mlatu**
> _Isso deve ser/provavelmente é o gato._
> (Se você tem um cachorro, ele também pode produzir esses sons, mas seu cachorro normalmente não faz isso, então é mais provável que seja o gato.)
...
1. **fau da'i da** denota que o evento nessa relação _é possível, pode acontecer._
2. **fau da'i ro da** — o evento _necessariamente aconteceria._
3. **fau da'i so'e da** — o evento _é provável, provavelmente acontecerá._
...
> _Provavelmente, você ganhará._
> `Eu espero com uma alta probabilidade que você ganhe.`
...
Ao contrário de **pacna**, o verbo **kanpe** não necessariamente implica esperança ou desejo. Ele pode descrever a expectativa imparcial, avaliação subjetiva da probabilidade de uma situação.
...
lakne
: $x_1$ (evento possível) é provável, possível
...
As conjunções lógicas em Lojban são baseadas em 4 primitivas: **.a**, **.e**, **.o**, **.u**. Nesta lição, vamos cobri-las em detalhe.

### Conjunções lógicas para substantivos

Aqui estão as conjunções combinando duas palavras: _this_ (isto) e _that_ (aquilo).

- **ti .a ta** = _isso e/ou aquilo_

  > **mi ba vitke le mamta .a le tamne**
  >_Eu vou visitar a mãe ou o primo._

  Note que **.a** também pode ser traduzido como _pelo menos um dos dois valores_, deixando aberta a possibilidade de que eu visite ambos em algum momento.

- **ti .e ta** = _isso e aquilo_

  > **mi ralte le pa gerku .e le re mlatu**
  >_Eu tenho um cachorro e dois gatos._
  >`Eu tenho um cachorro e dois gatos.`

- **ti .o ta** = _ou isso e aquilo ou nenhum deles_

  > **mi ba vitke le mamta .o le tamne**
  >_Eu vou visitar ou a mãe e o primo ou nenhum deles._

- **ti .u ta** = _isso, e talvez aquilo_, _isso com ou sem aquilo_

  > **mi ba vitke le mamta .u le tamne**
  >_Eu vou visitar a mãe com ou sem visitar o primo._

  **.u** apenas enfatiza que o segundo valor não afeta a verdade da frase.

Colocar **nai** depois da conjunção nega o que está à direita dela. Colocar **na** antes de uma conjunção nega o que está à esquerda dela:

- **ti .e nai ta** = _isso e não aquilo_

  > **mi nelci la .bob. e nai la .alis.**
  >_Eu gosto de Bob mas não de Alice._
  >`Eu gosto de Bob e não de Alice`

  Também podemos dizer **ti .e nai ku'i ta** (_isso mas não aquilo_) adicionando um sabor de contraste para o segundo substantivo.

- **ti na .e ta** = _não isso, mas aquilo_

  > **mi nelci la .alis. na .e la .bob.**
  >_Eu não gosto de Alice, mas gosto de Bob._
  >`Eu gosto de Alice não e de Bob`

  Isso pode parecer um pouco estranho para falantes de inglês (`I like Alice not…`), então você pode preferir trocar os substantivos e usar **.e nai** em vez disso: **mi nelci la .bob. e nai la .alis.** ou até mesmo **mi nelci la .bob. i mi na ku nelci la .alis.** vai significar o mesmo.
...
Negar com outras conjunções primitivas pode não parecer intuitivo, você pode apenas aprendê-las a partir de exemplos:
- **ti .a nai ta** = _isto se aquilo_, _para que isso aconteça, é necessária a exclusiva condição de aquilo_

  > **mi ba vitke le mamta .a nai le tamne**
  > _Eu vou visitar a mãe, mas para que isso aconteça, eu preciso visitar o primo._
...
- **ti .o nai ta** = _ou isso ou aquilo_
  ...
  Se eu quiser dizer que vou visitar ou a mãe ou o primo, mas não ambos, eu preciso de **.o nai** (_ou isso ou aquilo_). É diferente de **.a** (_isto e/ou aquilo_) em que eu posso visitar ambos.
...
<!-- **se** é usado apenas para **.u** porque em outros casos não leva a efeito no significado. -->
...
<!-- É comum usar **ja**, **je**, **jo**, **ju** também para conectar substantivos. -->
...
> _Eu tenho um cachorro e tenho dois gatos._

**.i je** conecta duas frases com um _e_ lógico, mostrando que ambas as frases fazem parte de um pensamento e são verdadeiras.
...
Isso significa que um deles ama o outro e talvez ambos.
...
> _Para que Romeu ame Julieta, é necessário que Julieta ame Romeu._

Isso significa que se Julieta ama Romeu, ele definitivamente a ama, mas ele ainda pode amá-la de qualquer maneira (o único resultado impossível é que Julieta ama Romeu, mas ele não a ama).

> **la .rome'os. cu prami la .djuliet. i jo la .djuliet. cu prami la .rome'os.**
> _Romeu ama Julieta e Julieta ama Romeu, ou nenhum dos dois eventos acontece._
...
Observe como Lojbaniza o nome "Romeu": a combinação "eo" é impossível em Lojban, então usamos "e'o" e adicionamos uma consoante no final de seu nome.
...
Isso pode ser explicado se, por exemplo, eu considerar as qualidades de humor e boa aparência incompatíveis, ou seja, uma mistura dos dois seria simplesmente demais.

> **mi nelci ro tu voi xajmi ju melbi nanmu**
> _Eu gosto de todas as pessoas que são engraçadas (quer sejam bonitas ou não)._
...
> _Eu visitarei um amigo e um esposo._

<!-- -->

> **mi ba vitke le pa pendo je speni**
> _Eu visitarei um amigo-e-esposo._

A última frase em Lojban significa que o amigo é também o esposo.
...
**gi'e** conecta várias relações em uma com alguns substantivos compartilhados. Veja isso: Ele se expande para **pu ku mi kelci la .soker. i je pu ku mi klama le zdani** ... o que seria mais longo.

Com **gi'e**, mantemos a cabeça da relação constante e especificamos os substantivos após cada um dos verbos (**kelci la .soker.**, **klama le zdani** ...).

Assim, ao usar **gi'e**, temos várias relações na cauda unidas, mas com uma cabeça comum.
...
- **gi'u** para _se sim ou não_ etc.

Essas conjunções têm o mesmo final que aquelas da série **.a**, **.o**, **.u**.

### Termos em frases com várias caudas

Observe que tempos verbais como termos e tempos verbais anexados à relação principal da relação fazem diferença quando aplicados a frases que contêm várias relações anexadas:
...
- Uma palavra de tempo verbal que é parte do verbo é aplicada apenas a essa relação:
...
> **— pinxe**
> _— Você irá beber chá ou café?_
> _— Sim._

Esta é uma resposta peculiar, mas perfeitamente razoável: _Sim, eu irei beber chá ou café._

Isso ocorre porque "ou" tem vários significados em inglês:
...
3. _A ou B?_ pode ser uma pergunta que significa _selecione entre A e B, qual deles você escolhe?_ Usamos **ji** aqui.
...
> **.e nai** — <span>_O primeiro (chá)_ (o primeiro, mas não o segundo item é escolhido)</span>

<!-- -->

> **na .e** — <span>_O segundo (café)_ (não o primeiro, mas o segundo item é escolhido)</span>

<!-- -->

> **na .e nai** — _Nenhum_ (nem o primeiro e nem o segundo item são escolhidos)

Você pode fazer perguntas da mesma maneira sobre os outros tipos de conjunções que vimos. A conjunção interrogativa para tipos de relação é **gi'i**, para verbos compostos — **je'i**, para sentenças — **.i je'i**.
...
Depois que o visitante responde, o garçom sabe se o visitante quer comer carne de cordeiro ou bovina:
...
A conjunção antecipada **ge** significa _e_, mas é colocada antes do primeiro substantivo, com **gi** separando os dois substantivos. Esta série é paralela a outras conjunções: **ga**, **ge**, **go**, **gu**, bem como **ga nai**, **ge nai**, **go nai**, etc. O separador **gi** é o mesmo para todos eles.

O uso dessas conjunções é uma questão de conveniência:

> **mi citka ge nai le badna gi le plise**
> _Eu como a maçã, não a banana._

Aqui, como em inglês, o _not_ é declarado antes do primeiro substantivo.

**ge** e palavras nesta série também podem ser usados para conectar relações:
...
O inglês frequentemente falha em traduzir esse poderoso **ju'a** de forma concisa, então a tradução em inglês não segue a ordem das palavras do original em Lojban.
...
**tarci** denota estrelas reais, objetos no céu. A interjeição **pe'a** transforma isso em um significado metafórico.

> **Então, eu vi um lugar estranho com um fogo dentro. Eu me aproximei, digamos, do "lugar do fogo".**

za'e
: interjeição à esquerda: marca o construto seguinte como usado não em seu significado usual

As interjeições à esquerda, como o nome sugere, são colocadas antes de um construto modificado (enquanto outras interjeições são colocadas depois).

A interjeição à esquerda **za'e** mostra que o construto seguinte, **le fagrystu** neste caso, é inventado ou usado não em seu significado padrão. Assim, não há necessidade de procurá-lo no dicionário ou perguntar especificamente ao falante sobre o significado dessa palavra, pois a palavra é usada para descrever melhor a história.
...
Para enfatizar uma palavra, usaríamos ênfase no inglês falado e sublinhado, itálico ou letras maiúsculas no inglês escrito. Em Lojban, usamos a interjeição à esquerda **ba'e**.
...
É normal usar **.i** no discurso para separar sentenças, mas você pode querer usar **ni'o** especialmente em textos escritos para estruturá-los.
...
<table>
 ...
 <tr>
  ...
  <td>Um novato visitou o mestre que estava longe nas montanhas.</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td>O mestre lhe ofereceu uma xícara de água da fonte e então disse:</td>
 </tr>
 <tr>
...
dirgo
: $x_1$ é uma gota do material $x_2$ ...
### «**to**» … «**toi**» para observações entre parênteses

Comentários colocados entre parênteses no texto em inglês são formados usando a palavra **to** no lugar do parêntese esquerdo e **toi** no lugar do parêntese direito:

> **ti poi to vi'o nai do mi na ku djica tu'a su'o lo drata toi plise cu fusra**
> _Esta (não, eu não quero outro!) maçã está podre._
...
Observações entre parênteses podem ser colocadas em qualquer lugar onde interjeições possam ser colocadas, o que significa que elas podem ser colocadas praticamente em qualquer lugar de uma frase em Lojban. Com parênteses, assim como com citações, você precisa saber onde começa e onde termina o parêntese.

### Corrigindo erros em fala

Ao se corrigir, é importante saber como consertar seus erros. Você pode usar duas palavras para apagar as palavras anteriores:

si
: remoção: apaga somente a última palavra

sa
: remoção: apaga até o próximo cmavo falado

Elas apagam palavras como se essas nunca tivessem sido faladas. No entanto, não funcionam dentro de certas citações (todas as citações exceto **lu…li'u**), já que isso tornaria impossível citar essas palavras. Usando múltiplos **si** seguidos apaga várias palavras.

Em inglês, quando se comete um erro ao falar (factual ou gramaticalmente), normalmente não se incomoda em corrigi-lo, mesmo que se perceba o erro. Isso porque o inglês é bastante redundante (por essa mesma razão!). Se nos pegamos cometendo um erro em inglês, rapidamente fornecemos uma correção sem entrar em detalhes como quantas palavras devem ser canceladas: o contexto geralmente nos ajuda. Por exemplo:

> _I'm learning the English word, … er, Lojban word._

Contexto e bom senso ditam que _Lojban word_ é para substituir _English word_. Mas o que aconteceria se fosse para substituir _I'm learning the English word_? Normalmente, não nos importaríamos em linguagens naturais.

No entanto, o Lojban permite que você seja mais preciso sobre quais palavras você está corrigindo.
...
> _Estou aprendendo a palavra em inglês, ... quer dizer, a palavra em Lojban._

valsi
: $x_1$ é uma palavra com o significado $x_2$ na linguagem $x_3$

O problema com **si** é que você tem que contar as palavras. Isso pode se tornar tedioso, e você não deve ter que manter uma transcrição de suas palavras quando quiser se corrigir.

A outra palavra de correção **sa** é mais útil: **sa** pega como argumento a palavra seguinte. Então, este **sa** apaga palavras até encontrar a mesma palavra ou uma palavra da mesma classe. Por exemplo:

> **.i mi tadni le sa .i mi tadni le lojbo valsi**
> _Estou aprendendo ... quer dizer, estou aprendendo a palavra em Lojban._
> **.i mi tadni le lojbo valsi**

O argumento de **sa** é a palavra **.i**. Portanto, a sentença após **sa** substitui a sentença atual até e incluindo **sa**. Ou considere:

> **.i mi mrilu fi do de'i li jefydei bu pa sa de'i li jefydei bu re**
> _Enviei para você na segunda-feira, ... quer dizer, na terça-feira._
> _Na segunda-feira eu enviei para você, ... quer dizer, na terça-feira._
> **.i mi mrilu fi do de'i li jefydei bu re**

A correção é **de'i li jefydei bu re** - _na terça-feira_. Então o que isso substitui é tudo a partir da última relação iniciada com **de'i**: **de'i li jefydei bu pa** - _na segunda-feira_.

### Lidando com mal-entendidos

> **— .i mi pu zi te vecnu le flokati**
> **— .i le flokati ki'a**
> _— Acabei de comprar um tapete de lã._
> _— Tapete de lã, huh?_

ki'a
: interjeição de questionamento: confusão sobre algo dito. _Huh? Whaat ??(confusão), perdão?_

Quando você não entende o que alguém acabou de dizer - seja porque não compreende a referência, não conhece a palavra ou a gramática o confundiu - você pode repetir a palavra ou relação que não entendeu e adicionar **ki'a** como uma solicitação de esclarecimento. Isso é ainda melhor do que _Huh?_, porque você pode apontar exatamente o que o fez dizer _Huh?_
...
**Nota:** Como **zo** cita qualquer palavra que o segue - qualquer palavra - acontece que **zo ki'a** não significa _zo? Hã?_ de forma alguma, mas _A palavra **ki'a**._ Para perguntar _zo? Huh?_, você terá que recorrer a **zo zo ki'a**.

### Revertendo «**mi**» e «**do**» usando «**ra'o**»
...
ra'o
: interjeição: atualiza o significado da perspectiva do falante atual

Se alguém diz **mi prami do** e você responde **go'i ra'o**, os pronomes **mi** e **do** são revertidos para que se apliquem do seu ponto de vista. Assim, cada pronome é reavaliado.
...
Já vimos dois pronomes pessoais, **mi** (_eu_ ou _mim_) e **do** (_você_). No entanto, _you_ em inglês pode ter vários significados, que são traduzidos em Lojban de maneiras específicas:
...
- _you_ como _todas as pessoas com quem estou falando_:
  ...
  > **ro do**
  > _cada um de vocês_, _todos vocês_ (ou Sul dos EUA _y'all_)

  Também é possível usar números com **ko**:

  > **ro ko klama ti**
  > _Venham todos aqui._
...
- _you_ como _um número específico de pessoas com quem estou falando_:
  ...
  Por exemplo, é possível começar e-mails para seus pais com **coi le re do**.
...
- _you_ como _a pessoa ou pessoas com quem estou falando mais outras pessoas_:
  ...
  > **do'o**
  > _você e alguém mais_

- _you_ como _qualquer um_ (por exemplo, _O dinheiro não pode comprar o amor._):
...
No entanto, você pode muitas vezes omiti-lo completamente ou colocar **zo'e** nessa posição.
<!-- O método recomendado é transformar os pronomes em verbos primeiro:

> **lo re me do ko klama ti**
> _Vocês dois, venham aqui._

É possível omitir **me** nesta posição e dizer **lo re do ko klama ti**, mas isso pode levar a confusão em iniciantes. -->

### Mais sobre cláusulas curtas relativas

Cláusulas curtas relativas com um pronome após elas podem ser colocadas imediatamente após **le**:

> **le pe mi gerku**
> **le gerku pe mi**
> _Meu cachorro_

Em tais casos, **pe** até pode ser omitido:
...
- se você quiser usar um substantivo convertido de um verbo (por exemplo, com **le**) ou um nome, é aconselhável usar **pe** e colocá-lo depois do substantivo: **le gerku pe la .alis.** (_Cachorro da Alice_).
- omitir **pe** é aceitável apenas ao usar pronomes sem números na frente deles: **le do gerku** (_O seu cachorro_) mas não **le pa do gerku** (= **le pa do cu gerku** = _Um de vocês é um cachorro_).

É muito mais seguro usar **pe** explicitamente e colocá-lo após o substantivo ao qual ele está relacionado: **le gerku pe la .alis.** e **le gerku pe mi** são as construções mais intuitivas. 

<Notes>
Intuition is an important concept in Lojban, as the language is meant to be clear and unambiguous, avoiding any potential misunderstandings.
</Notes>

### Citação de texto em diferentes idiomas

**zoi** é uma marca de citação para citar texto não-lojban. Sua sintaxe é **zoi X. texto .X**, onde X é uma palavra lojban (chamada de palavra delimitadora) que é separada do texto citado por pausas, e que não é encontrada no texto escrito ou na sequência fonêmica falada dentro dessa citação. É comum, mas não obrigatório, usar o nome de alguma letra, que corresponde ao nome lojban do idioma citado:

> **zoi gy. John is a man .gy. cu glico jufra**
> _"John is a man" é uma frase em inglês._

onde **gy.** representa **glico**. Outras escolhas populares de palavras delimitadoras são a palavra _zoi_ em si e uma palavra lojban que sugere o tópico da citação.
...
Nomes conhecidos internacionalmente que podem ser mais facilmente reconhecidos pela grafia do que pela pronúncia, como _Goethe_, também podem aparecer em texto lojban com **la'o**:
...
Tudo expresso em texto também deve ser expresso em fala e vice-versa. Portanto, não pode haver pontuação que não seja pronunciada. Isso significa que o lojban tem uma ampla variedade de palavras para citar outras palavras. Todo lojban converte um texto em um substantivo.

**lu** ... **li'u** citam apenas texto que é gramaticalmente correto. Para citar qualquer texto lojban, usamos as citações **lo'u** ... **le'u** em vez disso.
...
Sem o **be**, o termo **de'i li vo** se aplicaria a toda a relação, não ao **xatra**. O que queremos dizer é que a data anterior se aplica apenas à carta, e a data posterior se aplica ao envio da carta. Isso significa que o dia 4, como uma data, se aplica apenas ao verbo **le xatra**, e não a toda a relação.

### Verbos compostos em detalhes

A agrupação de termos na gramática Lojban é particularmente importante quando se trata de tanru (verbos compostos). A forma como os verbos se agrupam em um tanru determina o significado desse tanru. Por exemplo,
...
tem apenas a interpretação _uma revista de música ruim_, porque os dois primeiros verbos (_xlali zgike_ — _música ruim_) se agrupam primeiro. É importante modificar a agrupação dos verbos para garantir que o tanru transmita o significado pretendido. Por esse motivo, Lojban possui alguns mecanismos para fazer com que os tanru se agrupem corretamente.
...
Como você pode ver, separamos **xlali** do restante do tanru e fizemos com que se aplicasse a todo o tanru. Não há necessidade de **ke'e** no final do tanru, pois já sabemos que ele termina aqui.
...
Essa é uma maneira de agrupar verbos em tanru. A outra maneira é usar **bo** em um novo papel. Quando **bo** aparece entre dois verbos, significa que esses verbos se agrupam mais firmemente do que qualquer outra coisa. Portanto, uma maneira alternativa de dizer _música {revista}_ é

le xlali zgike bo karni
: a revista de música ruim

**bo** aqui é semelhante ao hífen na tradução em inglês. Isso significa que **zgike bo karni** deve ser considerado como uma unidade, à qual **xlali** (_ruim_) se aplica.
...
Lembre-se de que o colchete direito **ke'e** pode muitas vezes ser omitido sem alterar o significado (como neste caso).
...
> _Eu sou um tradutor profissional para o alemão do inglês._
...
**co** — inverte o verbo composto, fazendo com que o verbo mais à direita modifique o mais à esquerda em vez do contrário. Qualquer substantivo anterior preenche o modificado, qualquer substantivo seguinte preenche o modificador.
...
A força com que dois verbos são unidos com **co** é muito fraca — ainda mais fraca do que a agrupação normal de verbos compostos sem palavras de agrupamento. Isso garante que, em uma construção com **co**, o componente mais à esquerda seja sempre o verbo sendo modificado, e o componente mais à direita sempre modifica, mesmo que alguma dessas partes seja um verbo composto. Isso torna uma construção com **co** fácil de entender:

> **ti pelxu plise co kukte**

é lido como **ti (pelxu plise) co kukte**, o que é o mesmo que **ti kukte pelxu bo plise**. Isso também significa que um **ke … ke'e** não pode abranger um **co**.
...
Aqui está a lista de diferentes tipos de agrupadores em verbos compostos classificados do mais restrito ao mais solto:
...
A pequena palavra **ku** pode ser usada no final de um substantivo para mostrar explicitamente sua borda direita. **ku** é análogo ao colchete direito na matemática.

> **tu du le badna ku ui**
> **tu du le ui badna**
> _Aquilo é a banana (yay!)_

Ao contrário de:

> **tu du le badna ui**
> _Aquilo é a banana (yay que é uma banana e não outra coisa na natureza!)_
...
A palavra qualificadora **lu'o** colocada antes de um substantivo o converte em uma massa composta por membros desse substantivo. Neste caso, **ke'a** se refere ao conjunto dos meus amigos **le'i pendo be mi** e então **lu'o** converte os membros do conjunto em uma massa, a multidão dos meus amigos.
...
O verbo **simxu** seleciona todos os pares possíveis do conjunto especificado em lugar de $x_1$ e afirma a relação especificada dentro de $x_2$.

Se tivermos três pessoas, então isso significaria que todos se amam.

> **do ce la .alis. ce mi simxu le ka prami**
> **do ce la .alis. ce mi simxu le ka ce'u prami ce'u**
> _Você, Alice e eu, todos nos amamos uns aos outros._

ce
: conjunção: transforma vários substantivos/pronomes em um conjunto

A conjunção **ce** conecta substantivos e pronomes em um conjunto. Assim, **do ce la .alis. ce mi** pode ser uma forma mais verbosa de **le'i prenu** do exemplo anterior quando queremos nomear os membros do conjunto.
...
> _Algumas das pessoas amam umas às outras._

cmima
: $x_1$ é um membro do conjunto $x_2$

Neste exemplo, mostramos que um subconjunto das pessoas em questão (um subconjunto de **le'i prenu**) possui amor mútuo.

Isso nos permite transmitir ideias ainda mais complicadas:

> **le'i su'o citno cmima be le'i stati prenu cu simxu le ka prami**
> _Algumas pessoas jovens daqueles inteligentes amam umas às outras._
> `Alguns membros jovens do conjunto de pessoas inteligentes amor mútuo.`

<!-- ## Lógica de segunda ordem

Vimos **da** (e **de**, **di**) sendo uma "variável" em forma de substantivo com significados declarados dependendo das proposições dadas. 
Geralmente é traduzido como _existe X, existem X tais que…_

No entanto, por curiosidade, eu devo mencionar a série de verbos que também servem como "variáveis", mas em forma de verbo, ou seja, forma de relação:

>**su'o bu'a zo'u mi bu'a do**
>_Existe alguma relação ou propriedade: Eu tenho essa relação com você._
>_Você e eu estamos relacionados em pelo menos uma maneira._

> **ro bu'a zo'u ga nai le'e mlatu cu bu'a gi la .dinas. bu'a**
>> _Para cada relação ou propriedade possível: se os gatos a têm, então Dinah também a tem._ (Assim, assumimos que Dinah é um gato.)

A justificativa por trás desses verbos variáveis está escondida na lógica formal. Desnecessário dizer que eles raramente são usados no discurso, mas aqui está um possível exemplo:
...
- consertar a sentença -->

<!-- ## Coisas ainda não formalizadas em Lojban

Embora o Lojban possa ser o idioma falado n.° 1 do mundo seja pela sua gramática detalhada. Ainda existem alguns desafios:
Não se sabe o que **ta'e na** significa em oposição a **na ta'e**.

Não se sabe como lidar com **na go'i**.

Não se sabe como o xorlo funciona quando precisamos de conversão explícita entre conjuntos e massas, como operar conjuntos em geral, como usar o xorlo em conjunto com a lógica de segunda ordem como bu'a.

postoxorlo trabalhando com anáfora e quantificadores externos. -->

<!-- ## Sistema de conectivos não padronizado -->
...
Essa é uma abordagem não padrão. As pessoas usam esse estilo porque nele há menos conjunções para lembrar.

Mas é preciso ter cuidado para não esquecer **le** ou números para formar substantivos: **mi nelci le plise je jisra** iria significar _Eu gosto de algo que é uma maçã (ou maçãs) e é suco_ (?!)
...
Na abordagem padrão, o orador usa uma conjunção separada **e** ao conectar substantivos, e é mais fácil ver a diferença e o significado correto:
...
Junte-se ao [💬 chat ao vivo](https://lojban.pw/articles/live_chat/) para mais informações.
