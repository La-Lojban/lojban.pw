...
melbi
: x<sub>1</sub> é bonito / lindo / belo para alguém x<sub>2</sub>
...
sledi'u
: x<sub>1</sub> é um quarto para o propósito x<sub>2</sub> (proposição)
...
Aqui, **le se go'i** se refere ao segundo lugar (x<sub>2</sub>) da relação anterior, que é **le nanmu**.
...
tcika
: x<sub>1</sub> (horas, minutos, segundos) é a hora do evento x<sub>2</sub>
...
detri
: x<sub>1</sub> (ano, mês, dia) é a data/hora do evento x<sub>2</sub>
...
nanca
: x<sub>1</sub> tem duração de x<sub>2</sub> (número) anos
...
masti
: x<sub>1</sub> tem x<sub>2</sub> meses de duração

> **le nu carvi cu djedi li ci**
> _Está chovendo por três dias._

djedi
: x<sub>1</sub> (evento) tem x<sub>2</sub> (número) dias completos de duração
...
glare = x<sub>1</sub> é quente/morno
...
nabmi
: x<sub>1</sub> é um problema para x<sub>2</sub>

se nabmi
: x<sub>1</sub> tem um problema x<sub>2</sub>

laldo
: x<sub>1</sub> é velho …

certu
: x<sub>1</sub> é um especialista, profissional em propriedade x<sub>2</sub>
