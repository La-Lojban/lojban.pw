...
> _Daqui a pouco, terei acabado de comer queijo._
...
<pixra url="/assets/pixra/books/learn-lojban/le_vehi_ja_vehu_cmana.webp" caption="le ve'i cmana cu jibni le ve'u cmana" definition="A colina está perto da montanha."></pixra>
...
> **ti ve'u gerku**
> _Esse é um cachorro grande. Este é um cachorro que ocupa um espaço grande._
...
ba'o
: termo modal: consequências — o período depois que o evento terminou
...
<pixra url="/assets/pixra/books/learn-lojban/puho_nenri.webp" caption="le prenu pu'o zvati le nenri" definition="A pessoa está prestes a entrar."></pixra>
...
> (Estamos nas consequências da fala — **pu** coloca isso no passado.)

<pixra url="/assets/pixra/books/learn-lojban/baho_carvi.webp" caption="ba'o carvi" definition="Depois da chuva. A chuva parou."></pixra>

<!-- -->

> **le verba ba'o cadzu le bisli**
> _A criança já não anda no gelo._
> (Estamos nas consequências da caminhada.)
...
Com **pu**, **ca** ou **ba**, **ba'o** muitas vezes traduz o pretérito perfeito, presente ou futuro perfeito quando o sentido é «nas consequências naquele momento»; **ba'o** significa «nas consequências», não «tempo perfeito».
...
vasxu
: x<sub>1</sub> respira x<sub>2</sub>

> **mi pu mo'u citka le plise**
> _Eu terminei de comer a maçã._
> (Conclusão natural: o comer atingiu seu fim natural.)

<!-- -->

> **la .maks. pu mo'u zbasu ti voi dinju**
> _Max construiu esta casa._
> (Conclusão natural: a construção atingiu seu fim natural; ele não está construindo agora.)

Contraste **co'u** (cessou, parou — talvez antes do fim natural) e **mo'u** (terminou — atingiu o fim natural): _Parei de comer_ (**mi pu co'u citka**) pode significar que você deixou comida; _Terminei de comer a maçã_ (**mi pu mo'u citka le plise**) significa que atingiu o fim natural.
...
<pixra url="/assets/pixra/books/learn-lojban/deha_vasxu.webp" caption="mi de'a vasxu" definition="Eu pauso a respiração. Eu prendo a respiração."></pixra>

<!-- -->

> **mi pu di'a citka le plise**
> _Eu retomei comer maçãs._

<pixra url="/assets/pixra/books/learn-lojban/diha_vasxu.webp" caption="mi di'a vasxu" definition="Eu retomo a respiração."></pixra>
...
co'u
: termo modal: o evento para (cessação; pode ser antes do fim natural)

mo'u
: termo modal: conclusão natural — o evento atingiu seu ponto final natural
...
> **mi de'a ze'i jundi**
> _Já volto (Eu voltarei em breve)._

<!-- -->

> **mi di'a jundi**
> _Voltei (estou prestando atenção)._

jundi
: x<sub>1</sub> presta atenção a x<sub>2</sub>
...
gitGraph
    ...
    checkout stop
    branch aftermathStop
    commit id: "ba'o - consequências "
...
No diagrama **ba'o** (consequências) aparece duas vezes: após **mo'u** (conclusão natural) e após **co'u** (cessação) — as consequências podem seguir a qualquer um. **co'i** é aspecto perfectivo (evento como todo); **mo'u** é conclusão natural; **ba'o** é o período após o fim do evento.
...
> _As pedras estão em todo lugar._

### '_à esquerda_', '_à direita_'

<pixra url="/assets/pixra/books/learn-lojban/pritu_le_tricu.webp" caption="le prenu cu pritu le tricu le zgana" definition="A pessoa está à direita da árvore do ponto de vista do observador."></pixra>

> **le prenu cu sanli le dertu bu'u le pritu be mi**
> _A pessoa está no chão à minha direita._
...
> _O cachorro está deitado na cama à esquerda da criança._
...
zunle
: x<sub>1</sub> está à esquerda de x<sub>2</sub> visto de x<sub>3</sub>

pritu
: x<sub>1</sub> está à direita de x<sub>2</sub> visto de x<sub>3</sub>

crane
: x<sub>1</sub> está na frente de x<sub>2</sub> (x<sub>1</sub> está entre x<sub>2</sub> e quem observa) visto de x<sub>3</sub>

trixe
: x<sub>1</sub> está atrás de x<sub>2</sub> visto de x<sub>3</sub>

sanli
: x<sub>1</sub> está em pé sobre x<sub>2</sub>

zutse
: x<sub>1</sub> está sentado sobre x<sub>2</sub>

vreta
: x<sub>1</sub> está deitado sobre x<sub>2</sub>
...
marce
: x<sub>1</sub> é um veículo que transporta x<sub>2</sub>

se marce
: x<sub>1</sub> é um passageiro de x<sub>2</sub>

<!-- jai zu'e se marce
: x<sub>1</sub> pega um veículo x<sub>2</sub> como passageiro -->

karce
: x<sub>1</sub> é um carro que transporta x<sub>2</sub>

bloti
: x<sub>1</sub> é um barco que transporta x<sub>2</sub>

vinji
: x<sub>1</sub> é uma aeronave que transporta x<sub>2</sub>

trene
: x<sub>1</sub> é um trem de vagões x<sub>2</sub>
...
pixra
: x<sub>1</sub> é uma imagem de x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/viha_pixra.webp" caption="vi'a pixra" definition="Imagem 2D, desenho 2D."></pixra>

<pixra url="/assets/pixra/books/learn-lojban/vihu_pixra.webp" caption="vi'u pixra" definition="Imagem 3D, escultura."></pixra>
