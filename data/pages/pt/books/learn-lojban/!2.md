...
flowchart TB
    ...
    subgraph sumti["<i>a lista de termos-argumentos (sumti)</i>#nbsp;"]
        s1-.->x1
        s2-.->x2
    end
    ...
    %% input your sumti:
    s1("<i>termo-argumento</i> <b>mi</b>")
    s2("<i>termo-argumento</i> <b>do</b>")
    %% input your selbri
    selbri[(prami)]
...
O português usa um conjunto limitado de preposições que são reutilizadas em vários verbos e, portanto, não têm um significado fixo. Por exemplo, considere a preposição em português _para_:

> _Vou para a escola._

<!-- -->
> _Estudo para aprender._
<!-- -->

> _Para mim, isso é lindo._

Em cada um desses exemplos, _para_ tem um novo papel que, na melhor das hipóteses, é remotamente semelhante aos papéis em outras frases.
...
klama
: $x_1$ vai até/para $x_2$ …

zukte
: $x_1$ faz $x_2$ para $x_3$
...
No entanto, pode haver papéis opcionais que tornam as relações mais precisas, e.g. _enquanto_, _porque_:
...
Infinitivos são verbos que geralmente são suffixados com _-ir_/_-ar_ etc. em português. Exemplos incluem _Eu gosto de correr_, com _correr_ sendo o infinitivo.
...
Isso significa que o infinitivo no segundo slot ($x_2$) é aplicado a algum outro slot (provavelmente, o primeiro slot, $x_1$). Casos em que o infinitivo é aplicado a slots diferentes de $x_2$ são raros e são explicados por relações correspondentes ou no caso de palavras de relação inventadas não oficialmente, podem ser deduzidos do bom senso.

Outro exemplo:

<pixra url="/assets/pixra/cilre/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Ele/ela ajuda o amigo a carregar as malas."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Ele/ela ajuda o amigo a carregar as malas._

sidju
: $x_1$ ajuda $x_2$ a fazer $x_3$ (ka)
...
> _O chocolate me agrada (provavelmente pelo sabor)._
...
> _Gosto de Doris, que costumo ver no parque._
> _Eu gosto da Dóris. O que mais posso dizer sobre ela? Costumo vê-la no parque._
...
No português falado, a distinção muitas vezes é feita usando entonação ou por adivinhação. Além disso, orações relativas com **noi** tradicionalmente usam _quem_ ou _que_ etc.
...
Note a palavra **ke'a**. Movemos a segunda frase sobre a mesma árvore para uma oração relativa e substituímos o argumento **le tricu** por **ke'a** na oração relativa. Portanto, o pronome **ke'a** é como _que_ e _o qual_ em português. Ele se refere de volta ao argumento ao qual a oração relativa está ligada.

Literalmente, nossa frase em Lojban soa como

> _A árvore, tal que eu vou até ela, é grande._
...
> _A árvore onde fui hoje é grande._
...
> _Converso com Doris, que agora está sentada ali e em cima de Alice (que agora sorri)._
...
> _A caneta, que é minha, é vermelha._ <span>(informações adicionais)</span>
...
Na verdade, **le bangu pe mi** é uma tradução melhor para _minha língua_, pois, como em português, os dois argumentos estão relacionados de forma vaga.
...
Em português, o verbo _ser/estar_ faz com que um substantivo funcione como um verbo. Em Lojban, até mesmo conceitos como _gato_ (**mlatu**), _pessoa_ (**prenu**), _casa_ (**dinju**), _lar_ (**zdani**) funcionam como verbos (relações) por padrão. Apenas os pronomes funcionam como argumentos.
...
Assim, **me** e **du** às vezes podem corresponder ao que em português expressamos usando o verbo _ser/estar/era_.
...
**noi du** e **poi du** são usados para introduzir nomes alternativos para algo. Eles correspondem ao português _isto é, i.e._:
...
O verbo inglês _to have_ tem vários significados. Vamos listar alguns deles.
...
> `Há alguém que é meu irmão`

<!-- -->

> **re lo bruna be mi cu clani**
> _Tenho dois irmãos e eles são altos._
...
> **da panzi mi**
> **mi se panzi da**
> _Tenho um filho (ou filhos)._

panzi
: $x_1$ é filho, filho de $x_2$
...
> _Eu estou com o cachorro._
> `Eu fico com o cachorro`

<!-- -->

> **mi ralte le pa karce**
> _Eu estou com o carro._
...
> _São três amigos, cada um conversando com duas crianças._
...
> _Para três **da** que estão entre os amigos, para dois **de** que estão entre as crianças: **da** conversa com **de**._
...
> _Para dois **de** que estão entre os filhos, para três **da** que estão entre os amigos, **da** conversa com **de**_
...
> _Três amigos [e] dois filhos, conversem._
...
> **mi speni**
> _Sou casado, tenho esposa ou marido._
...
> **mi mo'u co'a speni**
> _Sou recém-casado._
> `Acabei de me tornar uma pessoa casada.`

> **mi co'a mo'u speni**
> _Fiquei viúvo._
> `Eu estou terminando de me casar.`

Se houver várias partículas modais em uma frase, a regra é que as leiamos da esquerda para a direita juntas, pensando nisso como uma chamada _jornada imaginária_. Começamos em um ponto implícito no tempo e no espaço (o “agora e aqui” do falante se nenhum argumento estiver anexado à direita) e depois seguimos os modais um após o outro, da esquerda para a direita.

Vamos dar **mi mo'u co'a speni**.

**mo'u** significa que um evento foi concluído. Qual evento? O evento **co'a speni** — casar. Portanto, **mi mo'u co'a speni** significa _Eu termino o processo de me casar_, ou seja, _Sou recém-casado._
