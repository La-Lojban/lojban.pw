...
dirgo
: x<sub>1</sub> é uma gota de material x<sub>2</sub> …
...
plise
: x<sub>1</sub> é uma maçã

fusra
: x<sub>1</sub> apodrece ou se decompõe com o agente x<sub>2</sub>
...
valsi
: x<sub>1</sub> é uma palavra com o significado x<sub>2</sub> na língua x<sub>3</sub>
