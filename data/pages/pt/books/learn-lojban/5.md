...
Aqui, x<sub>1</sub> da relação corresponde ao mais alto em comparação especificado após **se rai**.
...
x<sub>1</sub> da relação descreve o mais alto nesta comparação, a própria relação descreve a comparação.
...
dunli
: x<sub>1</sub> (qualquer tipo) é igual a x<sub>2</sub> (qualquer tipo) em x<sub>3</sub> (propriedade de x<sub>1</sub> e x<sub>2</sub> com **kau**)

mitre
: x<sub>1</sub> tem x<sub>2</sub> metros de comprimento

du
: x<sub>1</sub> (qualquer tipo) é idêntico(a) a x<sub>2</sub> (qualquer tipo)
...
frica
: x<sub>1</sub> (qualquer tipo) difere de x<sub>2</sub> (qualquer tipo) em x<sub>3</sub> (propriedade de x<sub>1</sub> e x<sub>2</sub> com **kau**)

drata
: x<sub>1</sub> (qualquer tipo) não é o mesmo que x<sub>2</sub> (qualquer tipo)
...
se steci
: x<sub>1</sub> é o único em x<sub>2</sub> (propriedade de x<sub>1</sub>) entre x<sub>3</sub> (conjunto) -->
...
troci
: x<sub>1</sub> tenta fazer x<sub>2</sub> (propriedade de x<sub>1</sub>)

snada
: x<sub>1</sub> tem sucesso em fazer x<sub>2</sub> (propriedade de x<sub>1</sub>)
.
fliba
: x<sub>1</sub> falha em fazer x<sub>2</sub> (propriedade de x<sub>1</sub>)
