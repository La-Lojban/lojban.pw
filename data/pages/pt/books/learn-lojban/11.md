...
vitke
: x<sub>1</sub> (convidado) visita x<sub>2</sub> (alguém) em x<sub>3</sub>
...
> _Acabei de comprar uma (revista de música) ruim. Ela criticou os Eurythmics._
...
> **mi fanva se jibri**
> _Sou um tradutor profissional_

fanva
: … traduz … (texto) para … (língua)

jibri
: x<sub>1</sub> é um trabalho de x<sub>2</sub>
...
> _Sou um tradutor profissional para o alemão do inglês._

dotco
: x<sub>1</sub> é alemão
...
> _Sou um nadador americano muito experiente._
...
merko
: x<sub>1</sub> é americano (no sentido dos EUA)
...
> **tu du le ui badna**
> _Aquela é a banana (viva!)_

Em oposição a:

> **tu du le badna ui**
> _Aquela é a banana (viva que é uma banana e não outra coisa na natureza!)_
...
> _A pessoa que estou observando está agora falando com meu amigo._
...
> _A pessoa que é bonita está agora falando com meu amigo._
...
> _Sinto-me triste em relação à situação._
...
> _Ele é o primeiro entre meus amigos que mantêm silêncio juntos._
> _A pessoa é a primeira entre o conjunto de meus amigos que estão agora, como uma multidão, em silêncio._
...
> _As pessoas se amam mutuamente._

simxu
: membros do conjunto x<sub>1</sub> reciprocamente fazem x<sub>2</sub>

A relação **simxu** pega cada par possível do conjunto especificado no lugar x<sub>1</sub> e afirma a relação especificada dentro de x<sub>2</sub>.
...
> _Você, Alice e eu todos nos amamos mutuamente._
...
> _Algumas das pessoas se amam mutuamente._

cmima
: x<sub>1</sub> é um membro do conjunto x<sub>2</sub>
...
> _Alguns jovens daquelas pessoas inteligentes se amam mutuamente._
