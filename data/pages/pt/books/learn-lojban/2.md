...
Dicionários podem apresentar definições de palavras de relação com símbolos como x<sub>1</sub>, x<sub>2</sub> etc.:

prami
: x<sub>1</sub> ama x<sub>2</sub>

karce
: x<sub>1</sub> é um carro …

citka
: x<sub>1</sub> come x<sub>2</sub> …

klama
: x<sub>1</sub> vem para x<sub>2</sub> …

Estes x<sub>1</sub>, x<sub>2</sub>, e assim por diante é a notação explícita para os chamados _espaços_ (outros nomes são: _lugares_, _papéis de relação_, **terbricmi** em Lojban). Os espaços são preenchidos por termos argumentos (**sumti**) na frase.
...
- x<sub>1</sub> denota _aquele que ama_, e
- x<sub>2</sub> denota _aquele que é amado por_.

Em outras palavras, cada relação tem um ou mais espaços, e esses espaços são especificados e rotulados como x<sub>1</sub>, x<sub>2</sub>, e assim por diante. Colocamos argumentos como **mi**, **do**, **le tavla** etc. em ordem, assim preenchendo esses espaços e dando um significado concreto à relação, assim formando uma frase.
...
<pixra url="/assets/pixra/books/learn-lojban/cmana.webp" caption="cmana" definition="… é uma montanha"></pixra>
...
<tbody><tr>
<td><b>klama</b></td>
<td>x<sub>1</sub> vem para x<sub>2</sub> de x<sub>3</sub></td>
</tr>
<tr>
<td><b>prami</b></td>
<td>x<sub>1</sub> ama x<sub>2</sub></td>
</tr>
<tr>
<td><b>karce</b></td>
<td>x<sub>1</sub> é um carro</td>
</tr>
<tr>
<td><b>citka</b></td>
...
plicru
: x<sub>1</sub> dá, doa para x<sub>2</sub> algum objeto x<sub>3</sub>; x<sub>1</sub> permite que alguém x<sub>2</sub> use x<sub>3</sub>
...
<tr>
<td><i>Eu dou a maçã para a criança.</i></td>
...
- **mi** como x<sub>1</sub>, o primeiro lugar da relação,
...
- **mi** como x<sub>1</sub>, o primeiro lugar da relação dentro do termo
...
tavla
: x<sub>1</sub> fala com x<sub>2</sub> …

melbi
: x<sub>1</sub> é bonito, lindo para x<sub>2</sub> …
...
nandu
: x<sub>1</sub> é difícil para x<sub>2</sub>

tilju
: x<sub>1</sub> é pesado
...
klama
: x<sub>1</sub> vem para x<sub>2</sub> de x<sub>3</sub>
...
<td>Usa argumentos centrais (x<sub>2</sub> e x<sub>3</sub> de klama)</td>
</tr>
<tr>
<td><b>mi klama le zarci ca le nu do pinxe</b></td>
<td>Usa argumento central (x<sub>2</sub> = le zarci) e termo modal (ca le nu do pinxe)</td>
</tr>
<tr>
...
1. O primeiro lugar é frequentemente a pessoa ou coisa que faz algo ou é algo:
   ...
   **klama** = _x<sub>1</sub> vai …_

2. O objeto de alguma ação geralmente está logo após o primeiro lugar:

   **punji** = _x<sub>1</sub> coloca x<sub>2</sub> em x<sub>3</sub>_,
...
4. Lugares de destino (_para_) quase sempre vêm antes de lugares de origem (_de_):
   ...
   **klama** = _x<sub>1</sub> vai para x<sub>2</sub> de x<sub>3</sub>_

   <pixra url="/assets/pixra/books/learn-lojban/klama_fi.webp" caption="le prenu cu klama fi le zarci" definition="A pessoa sai da loja."></pixra>
...
dunda
: x<sub>1</sub> dá x<sub>2</sub> para x<sub>3</sub>

benji
: x<sub>1</sub> transfere x<sub>2</sub> para x<sub>3</sub> de x<sub>4</sub>

lebna
: x<sub>1</sub> pega x<sub>2</sub> de x<sub>3</sub>
...
troci
: x<sub>1</sub> tenta fazer ou ser x<sub>2</sub> (ka)

cadzu
: x<sub>1</sub> anda

<pixra url="/assets/pixra/books/learn-lojban/troci_cadzu.webp" caption="le verba cu troci le ka cadzu" definition="A criança tenta andar."></pixra>
...
cinmo
: x<sub>1</sub> sente x<sub>2</sub> (ka)

Isso significa que o infinitivo no segundo espaço (x<sub>2</sub>) é aplicado a algum outro espaço (mais provavelmente, o primeiro espaço, x<sub>1</sub>). Casos onde o infinitivo é aplicado a espaços diferentes de x<sub>2</sub> são raros e são explicados em dicionários para relações correspondentes ou no caso de palavras de relação inventadas não oficialmente, podem ser deduzidos do senso comum por analogia com outras palavras de relação similares.

Outro exemplo:

<pixra url="/assets/pixra/books/learn-lojban/sidju.webp" caption="ra sidju le pendo le ka bevri le dakli" definition="Ele/ela ajuda o amigo a carregar as bolsas."></pixra>

> **ra sidju le pendo le ka bevri le dakli**
> _Ele/ela ajuda o amigo a carregar as bolsas._

sidju
: x<sub>1</sub> ajuda x<sub>2</sub> a fazer x<sub>3</sub> (ka)

A palavra de relação **sidju** requer que seu terceiro espaço seja preenchido com um infinitivo.

bevri
: x<sub>1</sub> carrega x<sub>2</sub>
...
kakne
: x<sub>1</sub> é capaz de fazer x<sub>2</sub> (propriedade)

nelci
: x<sub>1</sub> gosta de x<sub>2</sub>
...
djica
: x<sub>1</sub> quer x<sub>2</sub> (evento)
...
zekri
: x<sub>1</sub> é um evento criminal, x<sub>1</sub> (evento) um crime

cumki
: x<sub>1</sub> (evento) é possível
...
stidi
: x<sub>1</sub> sugere ação x<sub>2</sub> (propriedade) para x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/djica_tuha_le_titla.webp" caption="le prenu cu djica tu'a le titla" definition="A pessoa quer a comida doce."></pixra>
...
No entanto, a palavra de relação Lojban **stidi** requer uma propriedade em seu espaço x<sub>2</sub>. Similarmente, **djica** requer um evento em seu espaço x<sub>2</sub>.
...
stidi
: x<sub>1</sub> sugere x<sub>2</sub> (propriedade) para x<sub>3</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/pendo.webp" caption="le pendo" definition="o amigo / os amigos"></pixra>
...
Por padrão, ele anexa o segundo lugar (x<sub>2</sub>). Podemos anexar mais lugares separando-os com **bei**:

> **mi plicru do le plise**
> _Eu te dou a maçã._

<pixra url="/assets/pixra/books/learn-lojban/plicru.webp" caption="le prenu cu plicru le pendo le tutci" definition="A pessoa dá ao amigo o utensílio."></pixra>
...
ctuca
: x<sub>1</sub> ensina a alguém x<sub>2</sub> o assunto x<sub>3</sub>

cmene
: x<sub>1</sub> é um nome de x<sub>2</sub> usado por x<sub>3</sub>
...
speni
: x<sub>1</sub> é casado com x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/se_penmi_fi_le_panka.webp" caption="le gerku noi mi ta'e zgana bu'u le panka" definition="O cão que habitualmente vejo no parque."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/le_tricu_cu_barda.webp" caption="le tricu cu barda" definition="A árvore é grande."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/voi.webp" caption="mi nelci ti voi le nu ke'a cisma cu pluka mi" definition="Eu gosto destes cujos sorrisos me agradam."></pixra>
...
pluka
: x<sub>1</sub> é agradável para x<sub>2</sub>

zutse
: x<sub>1</sub> senta, está sentado em x<sub>2</sub>
...
birka
: x<sub>1</sub> é um braço de x<sub>2</sub>
...
tuple
: x<sub>1</sub> é uma perna de x<sub>2</sub>

clani
: x<sub>1</sub> é longo, comprido

cinri
: x<sub>1</sub> (evento) é interessante para alguém x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/ctuca.webp" caption="mi ctuca" definition="Eu ensino / Eu sou um professor."></pixra>
...
tunba
: x<sub>1</sub> é um irmão de x<sub>2</sub>

<pixra url="/assets/pixra/books/learn-lojban/tunba.webp" caption="do tunba mi" definition="Você é meu irmão."></pixra>

#### Tarefa

gerku
: x<sub>1</sub> é um cachorro

badna
: x<sub>1</sub> é uma banana

pendo
: x<sub>1</sub> é um amigo de x<sub>2</sub>
...
<pixra url="/assets/pixra/books/learn-lojban/coha_purdi.webp" caption="le pu kunti tumla ca purdi" definition="O que era um deserto é agora um jardim."></pixra>

> **le pu kunti tumla ca purdi**
> _O que era um deserto é agora um jardim._

kunti
: x<sub>1</sub> está vazio

tumla
: x<sub>1</sub> é uma parcela de terra
...
<pixra url="/assets/pixra/books/learn-lojban/cohu_purdi.webp" caption="le kunti tumla pu purdi" definition="O deserto era um jardim."></pixra>
...
melbi
: x<sub>1</sub> é bonito

sutra
: x<sub>1</sub> é rápido
...
<td>O "ca" se aplica a "mi melbi" - meu ser bonito agora é rápido</td>
</tr>
<tr>
...
plicru
: x<sub>1</sub> dá x<sub>2</sub> algo x<sub>3</sub> para uso
...
vecnu
: x<sub>1</sub> vende x<sub>2</sub> para x<sub>3</sub> pelo preço x<sub>4</sub>

ciska
: x<sub>1</sub> escreve x<sub>2</sub> na superfície x<sub>3</sub> com ferramenta x<sub>4</sub>
...
zbasu
: x<sub>1</sub> constrói, faz x<sub>2</sub> de x<sub>3</sub>
...
klama
: x<sub>1</sub> vai para x<sub>2</sub> de x<sub>3</sub> via x<sub>4</sub> por meio x<sub>5</sub>
...
mrilu
: x<sub>1</sub> envia por correio objeto x<sub>2</sub> para endereço de destinatário x<sub>3</sub> de caixa de correio x<sub>4</sub> pela rede de transportador x<sub>5</sub>

pagbu
: x<sub>1</sub> é uma parte de x<sub>2</sub>
...
- **fa** marca o argumento que preenche o primeiro espaço de uma relação (x<sub>1</sub>)
- **fe** marca o argumento que preenche o segundo espaço (x<sub>2</sub>)
- **fi** marca o argumento que preenche o terceiro espaço (x<sub>3</sub>)
- **fo** marca o argumento que preenche o quarto espaço (x<sub>4</sub>)
- **fu** marca o argumento que preenche o quinto espaço (x<sub>5</sub>)
...
<pixra url="/assets/pixra/books/learn-lojban/pinxe_fi_le_kabri.webp" caption="le prenu cu pinxe fi le kabri" definition="A pessoa bebe do copo."></pixra>
...
tugni
: x<sub>1</sub> concorda com alguém x<sub>2</sub> sobre x<sub>3</sub> (proposição)
...
xamgu
: x<sub>1</sub> é bom para x<sub>2</sub> em termos de x<sub>3</sub>

cuxna
: x<sub>1</sub> escolhe x<sub>2</sub> dentre x<sub>3</sub>

zgike
: x<sub>1</sub> é música
...
<td>x<sub>1</sub> = mi, x<sub>2</sub> = le plise, x<sub>3</sub> = do (Eu dou a maçã para você)</td>
</tr>
<tr>
<td><b>fe mi fi le zgike cu xamgu</b></td>
<td>x<sub>1</sub> não especificado, x<sub>2</sub> = mi, x<sub>3</sub> = le zgike (algo é bom para mim em termos de música)</td>
</tr></tbody></table>
...
tavla
: x<sub>1</sub> fala com alguém x<sub>2</sub> sobre tópico x<sub>3</sub>
...
djuno
: x<sub>1</sub> sabe x<sub>2</sub> (fato) sobre x<sub>3</sub>

Feche a parte direita da tabela. Diga a que cada variável se refere nessas frases.

<table>
<tbody><tr>
<td><b>da poi prenu zo'u da nelci mi</b></td>
<td>Existe alguém que é uma pessoa e que gosta de mim (da refere-se à mesma entidade nas duas vezes)</td>
</tr>
<tr>
<td><b>da citka da</b></td>
<td>Algo come a si mesmo (da refere-se à mesma entidade nos dois lugares)</td>
</tr>
<tr>
<td><b>su'o da poi djuno zo'u mi djica le nu da sidju mi</b></td>
<td>Há alguém conhecedor (<b>da</b>) tal que desejo o evento de que me ajude; <b>da</b> é a mesma pessoa no prenex e dentro de <b>le nu</b></td>
</tr></tbody></table>
...
Quando uma oração precisa de uma segunda ou terceira variável distinta, o lojban usa **de** e **di** após **da** (veja também ["Agrupamento de quantificadores" no CLL](/en/books/cll/16/#section-quantifier-grouping)):

da
: pronome: primeira variável (como o _X_ lógico).

de
: pronome: segunda variável (como o _Y_ lógico).

di
: pronome: terceira variável (como o _Z_ lógico).

> **da de zo'u mi djica le nu da tavla de**
> _Há alguém e outra pessoa tal que desejo que o primeiro falasse com o segundo (**da** e **de** se referem a essas duas pessoas no prenex e dentro de **le nu**)._
...
zmadu
: x<sub>1</sub> excede x<sub>2</sub> na propriedade x<sub>3</sub>

mlatu
: x<sub>1</sub> é um gato
...
<td>Primeira significa "Existe um gato específico que gosta de mim", segunda significa "Eu gosto de algum gato (qualquer gato)"</td>
</tr>
<tr>
<td><b>re da poi prenu cu zmadu pa de poi prenu</b> vs <b>re le prenu cu zmadu pa le prenu</b></td>
<td>Primeira: duas pessoas (a quem nos referimos com variáveis) cada uma excede uma pessoa; a pessoa excedida pode diferir para cada uma das duas, ou ser a mesma. Segunda: cada uma das duas <b>le prenu</b> excede uma <b>le prenu</b>; cada <b>le prenu</b> pode escolher um novo referente, então os pares não precisam corresponder (compare <a href="#scope">Escopo</a>)</td>
</tr>
<tr>
<td><b>da tavla da</b> vs <b>pa le prenu cu tavla pa le prenu</b></td>
<td>Primeira significa "Alguém fala consigo mesmo", segunda poderia significar auto-fala ou uma pessoa falando com outra</td>
</tr></tbody></table>
...
panzi
: x<sub>1</sub> é um filho, descendente de x<sub>2</sub>
...
ralte
: x<sub>1</sub> mantém x<sub>2</sub> em sua posse
...
ponse
: x<sub>1</sub> possui x<sub>2</sub>

#### Tarefa

mamta
: x<sub>1</sub> é uma mãe de x<sub>2</sub>

patfu
: x<sub>1</sub> é um pai de x<sub>2</sub>

ralte
: x<sub>1</sub> mantém x<sub>2</sub> em sua posse

ponse
: x<sub>1</sub> legalmente possui x<sub>2</sub>

Cubra a parte direita da tabela. Converta estas frases em português sobre posse para Lojban.

<table>
<tbody><tr>
<td><i>Eu tenho uma irmã</i></td>
<td><b>mi se mensi da</b> ou <b>da mensi mi</b></td>
</tr>
<tr>
<td><i>Meu amigo tem dois filhos</i></td>
<td><b>le pendo be mi cu se panzi re da</b></td>
</tr>
<tr>
<td><i>Eu tenho (possuo) o livro</i></td>
<td><b>mi ponse le cukta</b></td>
</tr>
<tr>
<td><i>Eu tenho (mantenho) um animal de estimação</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/xa_verba.webp" caption="ci le prenu cu tavla re le verba" definition="Três pessoas falam cada uma com duas crianças."></pixra>
...
Para tornar o escopo igual, usamos uma conjunção especial **ce'e** conectando dois termos. Termos unidos por **ce'e** são entendidos como tendo *escopo igual*: agem como *pares* para o que se segue.
...
mo'u
: termo: conclusão natural — o evento atingiu seu fim natural
...
**mo'u** significa que um evento atingiu seu fim natural (conclusão natural). Qual evento? O evento **co'a speni** — tornar-se casado. Portanto, **mi mo'u co'a speni** significa _Eu termino o processo de me casar_, ou seja, _Eu sou recém-casado._
...
tavla
: x<sub>1</sub> fala com x<sub>2</sub> sobre x<sub>3</sub>
...
<td>Primeira: Três pessoas cada uma fala com duas crianças (até 6 crianças no total). Segunda: Duas crianças específicas são faladas por três pessoas</td>
</tr>
<tr>
<td><b>mi ca'o zgana re le mlatu</b> vs <b>re le mlatu ca'o se zgana mi</b></td>
<td>Primeira: Estou observando dois gatos (quaisquer dois). Segunda: Dois gatos específicos estão sendo observados por mim</td>
</tr>
<tr>
<td><b>mi pu co'a citka</b> vs <b>co'a mi pu citka</b></td>
<td>Primeira: No passado comecei a comer. Segunda: Começou que no passado eu comi</td>
</tr></tbody></table>
...
<pixra url="/assets/pixra/books/learn-lojban/viku_cizra.webp" caption="vi ku ro da cizra" definition="Aqui, tudo é estranho."></pixra>
...
stati
: x<sub>1</sub> é esperto/inteligente

jundi
: x<sub>1</sub> é atento a x<sub>2</sub>

zvati
: x<sub>1</sub> está presente em x<sub>2</sub>
...
danlu
: x<sub>1</sub> é um mamífero

morsi
: x<sub>1</sub> está morto
...
mupli
: x<sub>1</sub> é um exemplo de x<sub>2</sub> (propriedade) entre x<sub>3</sub> (conjunto)
...
mupli
: x<sub>1</sub> é um exemplo de x<sub>2</sub> entre x<sub>3</sub>
...
<table>
<tbody><tr>
<td><i>Eu gosto de cães (em geral)</i></td>
<td><b>mi nelci le'e gerku</b></td>
</tr>
<tr>
<td><i>Este gato representa todos os gatos</i></td>
<td><b>ti mupli le ka gerku kei le'i gerku</b></td>
</tr>
<tr>
<td><i>Eu gosto da fruta típica</i></td>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri.webp" caption="lei prenu cu sruri le jubme" definition="As pessoas cercaram a mesa."></pixra>
...
<pixra url="/assets/pixra/books/learn-lojban/sruri_since.webp" caption="le pa since cu sruri le prenu" definition="A cobra cercou a pessoa."></pixra>
...
gunma
: x<sub>1</sub> é uma massa formada de componentes x<sub>2</sub>
...
<td>Primeira: Cada pessoa é grande. Segunda: A massa de pessoas é grande (enquanto indivíduos podem ser pequenos)</td>
</tr>
<tr>
<td><b>le pa ci mlatu cu zvati le zdani</b> vs <b>lei pa ci mlatu cu zvati le zdani</b></td>
<td>Primeira: Cada um dos 13 gatos está em casa. Segunda: O grupo de 13 gatos está em casa (juntos)</td>
</tr>
<tr>
<td><b>le ratcu cu citka le cirla</b> vs <b>lei ratcu cu citka lei cirla</b></td>
<td>Primeira: Cada rato come cada pedaço de queijo. Segunda: A massa de ratos come a massa de queijo</td>
</tr></tbody></table>
...
grake
: x<sub>1</sub> pesa x<sub>2</sub> (número) gramas
